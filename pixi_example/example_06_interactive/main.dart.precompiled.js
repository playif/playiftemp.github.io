...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, stage, renderer, texture, background, textureButton, textureButtonDown, textureButtonOver, buttons, buttonPositions, i, button, pixiLogo;
    ...
    texture = M.Texture_fromImage("button_test_BG.jpg", null, null);
    ...
    textureButton = M.Texture_fromImage("button.png", null, null);
    textureButtonDown = M.Texture_fromImage("buttonDown.png", null, null);
    textureButtonOver = M.Texture_fromImage("buttonOver.png", null, null);
    buttons = [];
    buttonPositions = [175, 75, 455, 75, 280, 210, 175, 325, 485, 305];
    for (i = 0; i < 5; ++i) {
      t1 = new M.Point(null, null);
      t1.x = 0;
      t1.y = 0;
      ...
      t6 = new Float32Array(9);
      t7 = H.assertSubtype([], "$isList", [M.AbstractFilter], "$asList");
      button = new F.Button(false, false, t1, null, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), false, 0, 0, t2, t3, t4, 0, 1, true, null, false, false, null, false, false, false, false, false, t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), H.assertSubtype(t5, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t6), 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, null, false, new M.FilterBlock(true, true, null, null, null, t7, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
      button.texture = textureButton;
      if (textureButton.baseTexture._hasLoaded)
        button._onTextureUpdate$1(null);
      else
        textureButton.addEventListener$2(0, "update", button.get$_onTextureUpdate());
      button.buttonMode = true;
      t1.x = 0.5;
      t1.y = 0.5;
      t1 = i * 2;
      if (t1 >= 10)
        return H.ioore(buttonPositions, t1);
      t2.x = buttonPositions[t1];
      ++t1;
      if (t1 >= 10)
        return H.ioore(buttonPositions, t1);
      t2.y = buttonPositions[t1];
      button._interactive = true;
      t1 = button._stage;
      if (t1 != null)
        t1.PIXI$Stage$_dirty = true;
      t1 = new F.main_closure(textureButtonDown, button);
      button.touchstart = t1;
      button.mousedown = t1;
      t1 = new F.main_closure0(textureButton, textureButtonOver, button);
      button.touchendoutside = t1;
      button.touchend = t1;
      button.mouseupoutside = t1;
      button.mouseup = t1;
      t1 = new F.main_closure1(textureButtonOver, button);
      button.touchmove = t1;
      button.mouseover = t1;
      button.mouseout = new F.main_closure2(textureButton, button);
      button.click = new F.main_closure3();
      button.tap = new F.main_closure4();
      stage.addChildAt$2(button, t9.length);
      C.JSArray_methods.add$1(buttons, button);
    }
    t1 = buttons.length;
    if (0 >= t1)
    ...
    if (1 >= t1)
      return H.ioore(buttons, 1);
    buttons[1].scale.y = 1.2;
    if (2 >= t1)
      return H.ioore(buttons, 2);
    buttons[2].rotation = 0.3141592653589793;
    if (3 >= t1)
      return H.ioore(buttons, 3);
    t2 = buttons[3].scale;
    t2.x = 0.8;
    if (3 >= t1)
      return H.ioore(buttons, 3);
    ...
    if (4 >= t1)
      return H.ioore(buttons, 4);
    t2.rotation = 3.141592653589793;
    texture = M.Texture_fromImage("pixi.png", null, null);
    t2 = new M.Point(null, null);
    t2.x = 0;
    t2.y = 0;
    t1 = new M.Point(null, null);
    ...
    t6 = new Float32Array(9);
    t7 = H.assertSubtype([], "$isList", [M.AbstractFilter], "$asList");
    pixiLogo = new M.Sprite(t2, null, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), false, 0, 0, t1, t3, t4, 0, 1, true, null, false, false, null, false, false, false, false, false, t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), H.assertSubtype(t5, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t6), 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, null, false, new M.FilterBlock(true, true, null, null, null, t7, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    pixiLogo.texture = texture;
    pixiLogo._setupTexture$0();
    stage.addChildAt$2(pixiLogo, t9.length);
    pixiLogo.buttonMode = true;
    t1.x = 564;
    t1.y = 368;
    pixiLogo.click = new F.main_closure5();
    $.get$requestAnimFrame().call$1(new F.main_animate(stage, renderer));
  }, "call$0", "main$closure", 0, 0, 35],
  Button: {
    "^": "Sprite;isOver,isDown,anchor,texture,updateFrame,PIXI$Sprite$_width,PIXI$Sprite$_height,_uvs,tintedTexture,buffer,tint,cachedTint,blendMode,children,interactiveChildren,_width,_height,position,scale,pivot,rotation,alpha,visible,hitArea,buttonMode,renderable,_parent,__hit,__isOver,__mouseIsDown,__isDown,_dirty,click,mousemove,mousedown,mouseout,mouseover,mouseup,mouseupoutside,touchmove,touchstart,touchend,tap,touchendoutside,__touchData,_stage,_worldAlpha,_interactive,defaultCursor,_worldTransform,_sr,_cr,filterArea,_bounds,_currentBounds,_mask,_cacheAsBitmap,_cachedSprite,_cacheIsDirty,_filterBlock,_filters,_rotationCache",
    $isButton: true
  },
  main_closure: {
    "^": "Closure:32;textureButtonDown_0,button_1",
    call$1: function(data) {
      var t1;
      P.print("mousedown");
      t1 = this.button_1;
      t1.isDown = true;
      t1.texture = this.textureButtonDown_0;
      t1.cachedTint = 16777215;
      t1.alpha = 1;
    },
    $isFunction: true
  },
  main_closure0: {
    "^": "Closure:32;textureButton_2,textureButtonOver_3,button_4",
    call$1: function(data) {
      var t1;
      P.print("mouseup");
      t1 = this.button_4;
      t1.isDown = false;
      if (t1.isOver) {
        t1.texture = this.textureButtonOver_3;
        t1.cachedTint = 16777215;
      } else {
        t1.texture = this.textureButton_2;
        t1.cachedTint = 16777215;
      }
    },
    $isFunction: true
  ...
  main_closure1: {
    "^": "Closure:32;textureButtonOver_5,button_6",
    call$1: function(data) {
      var t1;
      P.print("over");
      t1 = this.button_6;
      ...
      if (t1.isDown)
        return;
      t1.texture = this.textureButtonOver_5;
      t1.cachedTint = 16777215;
    },
    $isFunction: true
  },
  main_closure2: {
    "^": "Closure:32;textureButton_7,button_8",
    call$1: function(data) {
      var t1;
      P.print("mouseout");
      t1 = this.button_8;
      ...
      if (t1.isDown)
        return;
      t1.texture = this.textureButton_7;
      t1.cachedTint = 16777215;
    },
    $isFunction: true
  },
  ...
  main_animate: {
    "^": "Closure:32;stage_9,renderer_10",
    call$1: [function(dt) {
      this.renderer_10.render$1(this.stage_9);
  ...
  main_closure5: {
    "^": "Closure:32;",
    call$1: function(e) {
      C.Window_methods.open$2(window, "http://www.pixijs.com", "_blank");
    },
    $isFunction: true
  }
},
...
function dart_precompiled($collectedClasses) {
  ...
  function Button(isOver, isDown, anchor, texture, updateFrame, PIXI$Sprite$_width, PIXI$Sprite$_height, _uvs, tintedTexture, buffer, tint, cachedTint, blendMode, children, interactiveChildren, _width, _height, position, scale, pivot, rotation, alpha, visible, hitArea, buttonMode, renderable, _parent, __hit, __isOver, __mouseIsDown, __isDown, _dirty, click, mousemove, mousedown, mouseout, mouseover, mouseup, mouseupoutside, touchmove, touchstart, touchend, tap, touchendoutside, __touchData, _stage, _worldAlpha, _interactive, defaultCursor, _worldTransform, _sr, _cr, filterArea, _bounds, _currentBounds, _mask, _cacheAsBitmap, _cachedSprite, _cacheIsDirty, _filterBlock, _filters, _rotationCache) {
    this.isOver = isOver;
    this.isDown = isDown;
    this.anchor = anchor;
    this.texture = texture;
  ...
  function main_closure(textureButtonDown_0, button_1) {
    this.textureButtonDown_0 = textureButtonDown_0;
  ...
  function main_closure0(textureButton_2, textureButtonOver_3, button_4) {
    this.textureButton_2 = textureButton_2;
    this.textureButtonOver_3 = textureButtonOver_3;
  ...
  function main_closure1(textureButtonOver_5, button_6) {
    this.textureButtonOver_5 = textureButtonOver_5;
  ...
  function main_closure2(textureButton_7, button_8) {
    this.textureButton_7 = textureButton_7;
  ...
  function main_animate(stage_9, renderer_10) {
    this.stage_9 = stage_9;
    this.renderer_10 = renderer_10;
  }
