...
["PIXI", "../../lib/pixi.dart", , M, {
  ...
  DisplayObject: {
    "^": "Object;scale>,rotation<,hitArea<,parent,interactiveChildren,mousemove<,worldTransform<",
...
["", "main.dart", , F, {
  ...
  main: [function() {
    ...
    loader.onComplete = new F.main_onAssetsLoaded(aliens, ["eggHead.png", "flowerTop.png", "helmlok.png", "skully.png"], 100, alienContainer, C.C__JSRandom, new F.main_animate(t1, aliens, 100, stage, renderer, alienContainer));
    loader.load$0(0);
  }, "call$0", "main$closure", 0, 0, 36],
  main_animate: {
    "^": "Closure:78;box_0,aliens_1,aliensCount_2,stage_3,renderer_4,alienContainer_5",
    call$1: [function(delta) {
      var t1, t2, i, t3, t4, t5;
      H.numTypeCheck(delta);
      for (t1 = this.aliensCount_2, t2 = this.aliens_1, i = 0; i < t1; ++i) {
        if (i >= t2.length)
          return H.ioore(t2, i);
        t2[i].rotation += 0.1;
      }
  ...
  main_onAssetsLoaded: {
    "^": "Closure:36;aliens_6,alienFrames_7,aliensCount_8,alienContainer_9,random_10,animate_11",
    call$0: function() {
      var t1, t2, t3, t4, t5, i, frameName, texture, t6, t7, t8, t9, t10, t11, t12, alien;
      for (t1 = this.aliensCount_8, t2 = this.random_10, t3 = this.aliens_6, t4 = this.alienContainer_9, t5 = this.alienFrames_7, i = 0; i < t1; ++i) {
        ...
        alien = new M.Sprite(t6, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t7, t8, t9, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t10, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t11), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t12, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
        ...
        alien.tint = t2.nextInt$1(16777215);
        t7.x = t2.nextInt$1(800) - 400;
        t7.y = t2.nextInt$1(600) - 300;
        t6.x = 0.5;
        t6.y = 0.5;
        C.JSArray_methods.add$1(t3, alien);
        t4.addChild$1(alien);
      }
      $.get$requestAnimFrame().call$1(this.animate_11);
    },
    $isFunction: true
  }
},
...
function dart_precompiled($collectedClasses) {
  ...
  function DisplayObject(scale, rotation, hitArea, parent, interactiveChildren, mousemove, worldTransform) {
    this.scale = scale;
  ...
  function main_animate(box_0, aliens_1, aliensCount_2, stage_3, renderer_4, alienContainer_5) {
    this.box_0 = box_0;
    this.aliens_1 = aliens_1;
    this.aliensCount_2 = aliensCount_2;
    this.stage_3 = stage_3;
    this.renderer_4 = renderer_4;
    this.alienContainer_5 = alienContainer_5;
  }
  ...
  function main_onAssetsLoaded(aliens_6, alienFrames_7, aliensCount_8, alienContainer_9, random_10, animate_11) {
    this.aliens_6 = aliens_6;
    this.alienFrames_7 = alienFrames_7;
    this.aliensCount_8 = aliensCount_8;
    this.alienContainer_9 = alienContainer_9;
    this.random_10 = random_10;
    this.animate_11 = animate_11;
  }
