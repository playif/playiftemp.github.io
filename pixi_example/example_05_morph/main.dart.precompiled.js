...
["dart.math", "dart:math", , P, {
  ...
  Point0: {
    ...
    $add: function(_, other) {
      ...
      if (typeof t1 !== "number")
        return t1.$add();
      t1 = C.JSNumber_methods.$add(t1, other.x);
      t2 = this.y;
      if (typeof t2 !== "number")
        return t2.$add();
      t2 = C.JSNumber_methods.$add(t2, other.y);
      t3 = H.getTypeArgumentByIndex(this, 0);
      t3 = new P.Point0(H.assertSubtypeOfRuntimeType(t1, t3), H.assertSubtypeOfRuntimeType(t2, t3));
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, t2, points1, points2, points3, tpoint1, tpoint2, tpoint3, balls, texture, baseTexture, crossorigin, image, t3, t4, t5, t6, t7, t8, stage;
    t1 = {};
    t1.w_0 = window.innerWidth;
    t1.h_1 = window.innerHeight;
    t1.d_2 = 1;
    t1.current_3 = 1;
    t1.vx_4 = 0;
    t1.vy_5 = 0;
    ...
    t2 = Array(2000);
    t2.fixed$length = init;
    points1 = H.setRuntimeTypeInfo(t2, [P.num]);
    t2 = Array(2000);
    t2.fixed$length = init;
    points2 = H.setRuntimeTypeInfo(t2, [P.num]);
    t2 = Array(2000);
    t2.fixed$length = init;
    points3 = H.setRuntimeTypeInfo(t2, [P.num]);
    t2 = Array(2000);
    t2.fixed$length = init;
    tpoint1 = H.setRuntimeTypeInfo(t2, [P.num]);
    t2 = Array(2000);
    t2.fixed$length = init;
    tpoint2 = H.setRuntimeTypeInfo(t2, [P.num]);
    t2 = Array(2000);
    t2.fixed$length = init;
    tpoint3 = H.setRuntimeTypeInfo(t2, [P.num]);
    t2 = Array(2000);
    t2.fixed$length = init;
    ...
    if (texture == null) {
      ...
      if (baseTexture == null) {
        ...
        baseTexture.imageUrl = "assets/pixel.png";
        $.get$BaseTextureCache().$indexSet(0, "assets/pixel.png", baseTexture);
      }
      texture = M.Texture$(baseTexture, null);
      $.get$TextureCache().$indexSet(0, "assets/pixel.png", texture);
    }
    t1.renderer_7 = M.autoDetectRenderer(window.innerWidth, window.innerHeight, null, false, false);
    ...
    t7 = new F.main_resize(t1);
    t6 = H.assertSubtype(H.assertSubtype(H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_resize._eventType, false), [null]), "$isStream", [H.getTypeArgumentByIndex(C.EventStreamProvider_resize, 0)], "$asStream"), "$isStream", [W.Event], "$asStream");
    t5 = H.getVoidRuntimeType();
    H.buildFunctionType(t5, [t6.$tv_T()])._assertCheck$1(t7);
    H.buildFunctionType(t5)._assertCheck$1(null);
    t5 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t6._target, t6._eventType, W._wrapZone(t7), t6._useCapture), [H.getTypeArgumentByIndex(t6, 0)]);
    t5._tryResume$0();
    H.assertSubtype(t5, "$isStreamSubscription", [H.getTypeArgumentByIndex(t6, 0)], "$asStreamSubscription");
    new F.main_start(t1, 2000, points1, points2, points3, tpoint1, tpoint2, tpoint3, balls, texture, t8, new F.main_nextObject(t1, 17, t8), t7, new F.main_update(t1, 2000, points1, points2, points3, tpoint1, tpoint2, tpoint3, balls)).call$0();
  }, "call$0", "main$closure", 0, 0, 35],
  main_makeObject: {
    "^": "Closure:32;n_1,points1_2,points2_3,points3_4,random_5",
    call$1: [function(t) {
      var t1, t2, t3, t4, t5, t6, t7, t8, i, t9, xd;
      switch (t) {
        case 0:
          for (t1 = this.n_1, t2 = this.points1_2, t3 = this.random_5, t4 = t2.length, t5 = this.points2_3, t6 = t5.length, t7 = this.points3_4, t8 = t7.length, i = 0; i < t1; ++i) {
            t9 = t3.nextInt$1(100);
            if (i >= t4)
              return H.ioore(t2, i);
            t2[i] = -50 + t9;
          ...
          break;
        case 1:
          for (t1 = this.n_1, t2 = this.points3_4, t3 = J.getInterceptor$ns(t), t4 = this.points2_3, t5 = this.random_5, t6 = this.points1_2, i = 0; i < t1; ++i) {
            xd = -90 + t5.nextInt$1(180);
            t7 = Math.cos(xd);
            t8 = J.$div$n(t3.$mul(t, 360), t1);
            t8 = Math.cos(t8);
            if (i >= t6.length)
              return H.ioore(t6, i);
            t6[i] = t7 * 10 * (t8 * 10);
        ...
        case 2:
          ...
          break;
        case 3:
          for (t1 = this.n_1, t2 = this.points3_4, t3 = this.points2_3, t4 = this.random_5, t5 = this.points1_2, i = 0; i < t1; ++i) {
            xd = -90 + t4.nextInt$1(180);
            t6 = Math.cos(xd);
            t7 = Math.cos(xd);
            if (i >= t5.length)
              return H.ioore(t5, i);
  ...
  main_nextObject: {
    "^": "Closure:35;box_0,objs_6,makeObject_7",
    call$0: [function() {
      var t1, t2;
      t1 = this.box_0;
      t2 = ++t1.current_3;
      if (t2 > this.objs_6) {
        ...
        t1 = t2;
      this.makeObject_7.call$1(t1);
      P.Timer_Timer(C.Duration_8000000, this);
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  main_resize: {
    ...
    call$1: [function(e) {
      ...
      h = t2 - 16;
      t1.h_1 = h;
      t1.renderer_7.resize$2(0, w, h);
    }, "call$1", null, 2, 0, null, 3, "call"],
    $isFunction: true
  },
  main_update: {
    "^": "Closure:32;box_0,n_8,points1_9,points2_10,points3_11,tpoint1_12,tpoint2_13,tpoint3_14,balls_15",
    call$1: [function(dt) {
      var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, i, t17, x3d, y3d, z3d, t18, t19, t20, ty, tz, tx, tx0;
      t1 = this.box_0;
      t2 = t1.d_2;
      if (t2 < 250)
        t1.d_2 = t2 + 1;
      ...
      t1.vy_5 += 0.0075;
      t1.vz_6 += 0.0075;
      for (t2 = this.n_8, t3 = this.balls_15, t4 = t3.length, t5 = this.tpoint1_12, t6 = t5.length, t7 = this.tpoint2_13, t8 = t7.length, t9 = this.tpoint3_14, t10 = t9.length, t11 = this.points3_11, t12 = t11.length, t13 = this.points2_10, t14 = t13.length, t15 = this.points1_9, t16 = t15.length, i = 0; i < t2; ++i) {
        if (i >= t16)
        ...
        if (i >= t6)
          return H.ioore(t5, i);
        if (J.$gt$n(t17, t5[i]))
          t5[i] = J.$add$ns(t5[i], 1);
        if (J.$lt$n(t15[i], t5[i]))
          t5[i] = J.$sub$n(t5[i], 1);
        if (i >= t14)
          return H.ioore(t13, i);
        t17 = t13[i];
        if (i >= t8)
          return H.ioore(t7, i);
        if (J.$gt$n(t17, t7[i]))
          t7[i] = J.$add$ns(t7[i], 1);
        if (J.$lt$n(t13[i], t7[i]))
          t7[i] = J.$sub$n(t7[i], 1);
        if (i >= t12)
          return H.ioore(t11, i);
        t17 = t11[i];
        if (i >= t10)
          return H.ioore(t9, i);
        if (J.$gt$n(t17, t9[i]))
          t9[i] = J.$add$ns(t9[i], 1);
        if (J.$lt$n(t11[i], t9[i]))
          t9[i] = J.$sub$n(t9[i], 1);
        x3d = t5[i];
        y3d = t7[i];
        z3d = t9[i];
        t17 = t1.vx_4;
        t18 = J.getInterceptor$ns(y3d);
        t17 = t18.$mul(y3d, Math.cos(t17));
        t19 = t1.vx_4;
        t20 = J.getInterceptor$ns(z3d);
        ty = J.$sub$n(t17, t20.$mul(z3d, Math.sin(t19)));
        t19 = t1.vx_4;
        t17 = t18.$mul(y3d, Math.sin(t19));
        t18 = t1.vx_4;
        tz = J.$add$ns(t17, t20.$mul(z3d, Math.cos(t18)));
        t17 = t1.vy_5;
        t18 = J.getInterceptor$ns(x3d);
        t17 = t18.$mul(x3d, Math.cos(t17));
        t19 = t1.vy_5;
        t20 = J.getInterceptor$ns(tz);
        tx = J.$sub$n(t17, t20.$mul(tz, Math.sin(t19)));
        t19 = t1.vy_5;
        t17 = t18.$mul(x3d, Math.sin(t19));
        t18 = t1.vy_5;
        tz = J.$add$ns(t17, t20.$mul(tz, Math.cos(t18)));
        t17 = t1.vz_6;
        t18 = J.getInterceptor$ns(tx);
        t17 = t18.$mul(tx, Math.cos(t17));
        t19 = t1.vz_6;
        t20 = J.getInterceptor$ns(ty);
        tx0 = J.$sub$n(t17, t20.$mul(ty, Math.sin(t19)));
        t19 = t1.vz_6;
        t17 = t18.$mul(tx, Math.sin(t19));
        t18 = t1.vz_6;
        ty = J.$add$ns(t17, t20.$mul(ty, Math.cos(t18)));
        if (i >= t4)
          return H.ioore(t3, i);
        t17 = J.get$position$x(t3[i]);
        t18 = C.JSInt_methods.$mul(512, tx0);
        t19 = C.JSInt_methods.$sub(t1.d_2, tz);
        t20 = t1.w_0;
        if (typeof t20 !== "number")
          return t20.$div();
        J.set$x$x(t17, t18 / t19 + t20 / 2);
        t20 = J.get$position$x(t3[i]);
        t19 = t1.h_1;
        if (typeof t19 !== "number")
          return t19.$div();
        J.set$y$x(t20, t19 / 2 - C.JSInt_methods.$mul(512, ty) / C.JSInt_methods.$sub(t1.d_2, tz));
      }
      t1.renderer_7.render$1(t1.stage_8);
      $.get$requestAnimFrame().call$1(this);
    }, "call$1", null, 2, 0, null, 76, "call"],
    $isFunction: true
  },
  main_start: {
    "^": "Closure:35;box_0,n_16,points1_17,points2_18,points3_19,tpoint1_20,tpoint2_21,tpoint3_22,balls_23,ballTexture_24,makeObject_25,nextObject_26,resize_27,update_28",
    call$0: function() {
      var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, i, t18, t19, t20, t21, t22, t23, t24, tempBall;
      t1 = this.box_0;
      J.append$1$x(document.body, t1.renderer_7.view);
      J.set$display$x(t1.renderer_7.view.style, "block");
      this.makeObject_25.call$1(0);
      for (t2 = this.n_16, t3 = this.balls_23, t4 = t3.length, t5 = this.tpoint1_20, t6 = this.points1_17, t7 = t6.length, t8 = t5.length, t9 = this.tpoint2_21, t10 = this.points2_18, t11 = t10.length, t12 = t9.length, t13 = this.tpoint3_22, t14 = this.points3_19, t15 = t14.length, t16 = t13.length, t17 = this.ballTexture_24, i = 0; i < t2; ++i) {
        if (i >= t7)
          return H.ioore(t6, i);
        t18 = t6[i];
        if (i >= t8)
        ...
        t9[i] = t18;
        if (i >= t15)
          return H.ioore(t14, i);
        t18 = t14[i];
        if (i >= t16)
          return H.ioore(t13, i);
        t13[i] = t18;
        t18 = new M.Point(null, null);
        t18.x = 0;
        t18.y = 0;
        t19 = new M.Point(null, null);
        t19.x = 0;
        t19.y = 0;
        t20 = new M.Point(null, null);
        t20.x = 1;
        t20.y = 1;
        t21 = new M.Point(null, null);
        t21.x = 0;
        t21.y = 0;
        t22 = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
        t23 = new Float32Array(9);
        t24 = H.assertSubtype([], "$isList", [M.AbstractFilter], "$asList");
        tempBall = new M.Sprite(t18, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t19, t20, t21, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t22, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t23), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t24, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
        tempBall.texture = t17;
        if (t17.baseTexture._hasLoaded)
          tempBall.onTextureUpdate$1(null);
        else
          t17.addEventListener$2(0, "update", tempBall.get$onTextureUpdate());
        t18.x = 0.5;
        t18.y = 0.5;
        tempBall.alpha = 0.5;
        if (i >= t4)
        ...
        t3[i] = tempBall;
        t18 = t1.stage_8;
        t18.addChildAt$2(tempBall, t18.children.length);
      }
      this.resize_27.call$1(null);
      P.Timer_Timer(C.Duration_8000000, this.nextObject_26);
      $.get$requestAnimFrame().call$1(this.update_28);
    },
    $isFunction: true
  }
},
...
M.Sprite.$isDisplayObjectContainer = true;
M.Sprite.$isDisplayInterface = true;
...
function dart_precompiled($collectedClasses) {
  ...
  function main_makeObject(n_1, points1_2, points2_3, points3_4, random_5) {
    this.n_1 = n_1;
    this.points1_2 = points1_2;
    this.points2_3 = points2_3;
    this.points3_4 = points3_4;
    this.random_5 = random_5;
  }
  main_makeObject.builtin$cls = "main_makeObject";
  if (!"name" in main_makeObject)
    main_makeObject.name = "main_makeObject";
  $desc = $collectedClasses.main_makeObject;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_makeObject.prototype = $desc;
  function main_nextObject(box_0, objs_6, makeObject_7) {
    this.box_0 = box_0;
    this.objs_6 = objs_6;
    this.makeObject_7 = makeObject_7;
  }
  main_nextObject.builtin$cls = "main_nextObject";
  if (!"name" in main_nextObject)
    main_nextObject.name = "main_nextObject";
  $desc = $collectedClasses.main_nextObject;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_nextObject.prototype = $desc;
  function main_resize(box_0) {
    this.box_0 = box_0;
  }
  ...
  function main_update(box_0, n_8, points1_9, points2_10, points3_11, tpoint1_12, tpoint2_13, tpoint3_14, balls_15) {
    this.box_0 = box_0;
    this.n_8 = n_8;
    this.points1_9 = points1_9;
    this.points2_10 = points2_10;
    this.points3_11 = points3_11;
    this.tpoint1_12 = tpoint1_12;
    this.tpoint2_13 = tpoint2_13;
    this.tpoint3_14 = tpoint3_14;
    this.balls_15 = balls_15;
  }
  ...
  function main_start(box_0, n_16, points1_17, points2_18, points3_19, tpoint1_20, tpoint2_21, tpoint3_22, balls_23, ballTexture_24, makeObject_25, nextObject_26, resize_27, update_28) {
    this.box_0 = box_0;
    this.n_16 = n_16;
    this.points1_17 = points1_17;
    this.points2_18 = points2_18;
    this.points3_19 = points3_19;
    this.tpoint1_20 = tpoint1_20;
    this.tpoint2_21 = tpoint2_21;
    this.tpoint3_22 = tpoint3_22;
    this.balls_23 = balls_23;
    this.ballTexture_24 = ballTexture_24;
    this.makeObject_25 = makeObject_25;
    this.nextObject_26 = nextObject_26;
    this.resize_27 = resize_27;
    this.update_28 = update_28;
  }
  main_start.builtin$cls = "main_start";
  if (!"name" in main_start)
    main_start.name = "main_start";
  $desc = $collectedClasses.main_start;
  if ($desc instanceof Array)
    $desc = $desc[1];
