...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, renderer, t2, t3, t4, t5, t6, t7, t8, t9, t10, stage, dudeArray, i, texture, dude;
    t1 = {};
    ...
    M.Texture_fromImage("BGrotate.jpg", null, null);
    dudeArray = [];
    for (i = 0; i < 20; ++i) {
      texture = M.Texture_fromImage("eggHead.png", null, null);
      ...
      t4.y = t2;
      t4.x = t2;
      t3.x = C.C__JSRandom.nextInt$1(630);
      t3.y = C.C__JSRandom.nextInt$1(410);
      stage.addChildAt$2(dude, t10.length);
      dude.tint = C.C__JSRandom.nextInt$1(16777215);
