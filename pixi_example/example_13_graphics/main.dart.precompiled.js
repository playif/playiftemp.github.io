...
["PIXI", "../../lib/pixi.dart", , M, {
  ...
  WebGLGraphics_buildLine: function(graphicsData, webGLData) {
    ...
    color = H.assertSubtype(H.assertSubtype([(C.JSInt_methods._shrOtherPositive$1(t1, 16) & 255) / 255, (C.JSInt_methods._shrOtherPositive$1(t1, 8) & 255) / 255, (t1 & 255) / 255], "$isList", [P.num], "$asList"), "$isList", [P.num], "$asList");
  ...
  Graphics: {
    ...
    lineStyle$1: function(lineWidth) {
    ...
    clear$0: function(_) {
      ...
      this.set$graphicsData([]);
      this.bounds = null;
      return this;
    },
    _renderWebGL$1: function(renderSession) {
      var bounds, t1, canvasBuffer, t2, t3, baseTexture, texture, t4, t5, t6, t7, blendModeWebGL, i;
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|CanvasGradient|CanvasPattern|DOMError|FileError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGRect|WebGLRenderbuffer"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, stage, renderer, graphics, thing, texture, baseTexture, crossorigin, image, bunny;
    t1 = {};
    ...
    graphics = M.Graphics$();
    graphics.beginFill$1(3407616);
    graphics.lineStyle$3(10, 16767232, 1);
    graphics.moveTo$2(0, 50, 50);
    graphics.lineTo$2(0, 250, 50);
    graphics.lineTo$2(0, 100, 100);
    graphics.lineTo$2(0, 250, 220);
    graphics.lineTo$2(0, 50, 220);
    graphics.lineTo$2(0, 50, 50);
    graphics.endFill$0();
    graphics.lineStyle$3(10, 16711680, 0.8);
    graphics.beginFill$2(16740363, 1);
    graphics.moveTo$2(0, 210, 300);
    graphics.lineTo$2(0, 450, 320);
    graphics.lineTo$2(0, 570, 350);
    graphics.lineTo$2(0, 580, 20);
    graphics.lineTo$2(0, 330, 120);
    graphics.lineTo$2(0, 410, 200);
    graphics.lineTo$2(0, 210, 300);
    graphics.lineStyle$3(2, 255, 1);
    if (graphics.currentPath.points.length === 0) {
      t2 = graphics.graphicsData;
      if (t2.length > 0)
        t2.pop();
    }
    t2 = $.Graphics_POLY;
    t2 = new M.GraphicsData(H.assertSubtype([], "$isList", [P.num], "$asList"), 1, 0, null, 1, 1, 0, t2);
    t2.lineWidth = graphics.lineWidth;
    t2.lineColor = graphics.lineColor;
    t2.lineAlpha = graphics.lineAlpha;
    t2.fillColor = graphics.fillColor;
    t2.fillAlpha = graphics.fillAlpha;
    t2.fill = graphics.filling;
    t2.set$points(0, [50, 250, 100, 100, 40]);
    t2.type = $.Graphics_RREC;
    graphics.currentPath = t2;
    C.JSArray_methods.add$1(graphics.graphicsData, t2);
    graphics.dirty = true;
    graphics.beginFill$2(16740363, 1);
    graphics.lineStyle$3(10, 65280, 0.5);
    if (graphics.currentPath.points.length === 0) {
      t2 = graphics.graphicsData;
      if (t2.length > 0)
        t2.pop();
    ...
    t2.fillAlpha = graphics.fillAlpha;
    t2.fill = graphics.filling;
    t2.set$points(0, [150, 250, 100, 100]);
    t2.type = $.Graphics_RECT;
    graphics.currentPath = t2;
    C.JSArray_methods.add$1(graphics.graphicsData, t2);
    graphics.dirty = true;
    if (graphics.currentPath.points.length === 0) {
    ...
    t2.fillAlpha = graphics.fillAlpha;
    t2.fill = graphics.filling;
    t2.set$points(0, [40, 40, 100, 30]);
    t2.type = $.Graphics_ELIP;
    graphics.currentPath = t2;
    C.JSArray_methods.add$1(graphics.graphicsData, t2);
    graphics.dirty = true;
    graphics.endFill$0();
    graphics.lineStyle$1(0);
    graphics.beginFill$2(16776971, 0.5);
    if (graphics.currentPath.points.length === 0) {
      t2 = graphics.graphicsData;
      if (t2.length > 0)
        t2.pop();
    ...
    t2.fillAlpha = graphics.fillAlpha;
    t2.fill = graphics.filling;
    t2.set$points(0, [470, 200, 100, 100]);
    t2.type = $.Graphics_CIRC;
    graphics.currentPath = t2;
    C.JSArray_methods.add$1(graphics.graphicsData, t2);
    graphics.dirty = true;
    ...
    t2.y = 190;
    t1.count_0 = 0;
    t2 = new F.main_closure(graphics, C.C__JSRandom);
    stage.tap = t2;
    stage.click = t2;
    texture = H.interceptedTypeCheck($.get$TextureCache().$index(0, "bunny.png"), "$isTexture");
    if (texture == null) {
    ...
    t7 = new Float32Array(9);
    t8 = H.assertSubtype([], "$isList", [M.AbstractFilter], "$asList");
    bunny = new M.Sprite(t2, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t3, t4, t5, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t6, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t7), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t8, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    bunny.texture = texture;
    bunny._setupTexture$0();
    t2.x = 0.5;
    t2.y = 0.5;
    t3.x = 100;
    t3.y = 100;
    stage.addChildAt$2(bunny, t10.length);
    $.get$requestAnimFrame().call$1(new F.main_animate(t1, stage, renderer, thing));
  }, "call$0", "main$closure", 0, 0, 35],
  main_closure: {
    "^": "Closure:32;graphics_1,random_2",
    call$1: function(e) {
      var t1, t2;
      P.print("here");
      t1 = this.graphics_1;
      t2 = this.random_2;
      t1.lineStyle$3(t2.nextInt$1(30), t2.nextInt$1(16777215), 1);
      t1.moveTo$2(0, t2.nextInt$1(620), t2.nextInt$1(380));
      t1.lineTo$2(0, t2.nextInt$1(620), t2.nextInt$1(380));
    },
    $isFunction: true
  },
  main_animate: {
    "^": "Closure:32;box_0,stage_3,renderer_4,thing_5",
    call$1: [function(dt) {
      var t1, t2, t3, t4;
      t1 = this.thing_5;
      t1.clear$0(0);
      ...
      t2.count_0 += 0.1;
      t1.clear$0(0);
      t1.lineStyle$3(30, 16711680, 1);
      t1.beginFill$2(16776960, 0.5);
      t3 = t2.count_0;
      t3 = Math.sin(t3);
      t4 = t2.count_0;
      ...
      this.renderer_4.render$1(this.stage_3);
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure(graphics_1, random_2) {
    this.graphics_1 = graphics_1;
  ...
  function main_animate(box_0, stage_3, renderer_4, thing_5) {
    this.box_0 = box_0;
    this.stage_3 = stage_3;
    this.renderer_4 = renderer_4;
    this.thing_5 = thing_5;
  }
