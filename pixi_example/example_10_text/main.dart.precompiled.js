...
["PIXI", "../../lib/pixi.dart", , M, {
  ...
  Sprite: {
    ...
    _onTextureUpdate$1: [function(e) {
      ...
      if (t1 !== 0) {
        t2 = this.scale;
        t3 = this.texture.frame.width;
        if (typeof t1 !== "number")
          return t1.$div();
        t2.x = C.JSInt_methods.$div(t1, t3);
      }
      t1 = this.PIXI$Sprite$_height;
      if (t1 !== 0) {
        t2 = this.scale;
        t3 = this.texture.frame.height;
        if (typeof t1 !== "number")
          return t1.$div();
  ...
  BitmapText: {
    ...
    updateText$0: function() {
      ...
      pos.x = 0;
      pos.y = 0;
      chars = H.assertSubtype([], "$isList", [M.Char], "$asList");
      lineWidths = [];
      t1 = this.fontSize;
      t2 = data.size;
      if (typeof t1 !== "number")
        return t1.$div();
      t2 = C.JSInt_methods.$div(t1, t2);
      for (prevCharCode = null, maxLineWidth = 0, line = 0, i = 0; t1 = this.text, t3 = t1.length, i < t3; ++i) {
        if (i >= t3)
          H.throwExpression(P.RangeError$value(i));
        charCode = t1.charCodeAt(i);
        t1 = this.text;
        if (i >= t1.length)
          return H.ioore(t1, i);
        t1 = t1[i];
        if (t1 === "\n" || t1 === "\r" || t1 === "\r\n") {
          C.JSArray_methods.add$1(lineWidths, pos.x);
          ...
          if (typeof t1 !== "number")
            return t1.$add();
          pos.y = C.JSNumber_methods.$add(t1, t3);
          prevCharCode = null;
          continue;
        }
        charData = data.chars.$index(0, charCode);
        if (charData == null)
          continue;
        if (prevCharCode != null && charData.kernings.containsKey$1(prevCharCode)) {
          t1 = pos.x;
          t3 = charData.kernings.$index(0, prevCharCode);
          if (typeof t1 !== "number")
            return t1.$add();
          pos.x = C.JSNumber_methods.$add(t1, t3);
        }
        t1 = new M.Char(null, null, null, null, null, null, null, P.LinkedHashMap_LinkedHashMap$_empty(null, null));
        t1.texture = charData.texture;
        t1.line = line;
        t1.charCode = charCode;
        t3 = pos.x;
        t4 = charData.xOffset;
        if (typeof t3 !== "number")
          return t3.$add();
        t4 = C.JSNumber_methods.$add(t3, t4);
        t3 = pos.y;
        t5 = charData.yOffset;
        if (typeof t3 !== "number")
          return t3.$add();
        t5 = C.JSNumber_methods.$add(t3, t5);
        t3 = new M.Point(null, null);
        t3.x = t4;
        t3.y = t5;
        t1.position = t3;
        C.JSArray_methods.add$1(chars, t1);
        t1 = pos.x;
        t3 = charData.xAdvance;
        if (typeof t1 !== "number")
          return t1.$add();
        pos.x = C.JSNumber_methods.$add(t1, t3);
      ...
      for (i = 0; i <= line; ++i) {
        ...
        if (t1 === "right") {
          ...
          alignOffset = C.JSInt_methods.$sub(maxLineWidth, lineWidths[i]);
        } else if (t1 === "center") {
          if (i >= lineWidths.length)
            return H.ioore(lineWidths, i);
          alignOffset = C.JSInt_methods.$sub(maxLineWidth, lineWidths[i]) / 2;
        } else
          alignOffset = 0;
        C.JSArray_methods.add$1(lineAlignOffsets, alignOffset);
      }
      t1 = this.children;
      ...
      for (t3 = H.buildFunctionType(H.getVoidRuntimeType(), [H.buildInterfaceType(M.InteractionData)]), i = 0; i < lenChars; ++i) {
        ...
        if (c != null) {
          ...
          c = new M.Sprite(t4, null, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), false, 0, 0, t6, t7, t8, 0, 1, true, null, false, false, null, false, false, false, false, false, t3._assertCheck$1(null), t3._assertCheck$1(null), t3._assertCheck$1(null), t3._assertCheck$1(null), t3._assertCheck$1(null), t3._assertCheck$1(null), t3._assertCheck$1(null), t3._assertCheck$1(null), t3._assertCheck$1(null), t3._assertCheck$1(null), t3._assertCheck$1(null), t3._assertCheck$1(null), H.assertSubtype(t9, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t10), 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, null, false, new M.FilterBlock(true, true, null, null, null, t11, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
          c.texture = t5;
  ...
  BaseTexture: {
    ...
    BaseTexture$2: function(source, scaleMode) {
      ...
      if ((!!t2.$isImageElement && t2.get$complete(t1) === true || !!t2.$isCanvasElement) && t2.get$width(t1) !== 0 && t2.get$height(t1) !== 0) {
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|CanvasGradient|CanvasPattern|DOMError|FileError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGPointList|SVGRect|TextMetrics|WebGLRenderbuffer"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["", "main.dart", , F, {
  ...
  main_runList: {
    ...
    call$1: function(item) {
      var tmp, safe;
      window;
      H.voidTypeCheck(typeof console != "undefined" ? console.log("_") : null);
      for (tmp = item, safe = 0; tmp.get$_iNext();) {
        ++safe;
        tmp = tmp.get$_iNext();
        window;
        H.voidTypeCheck(typeof console != "undefined" ? console.log(tmp) : null);
        if (safe > 100) {
          window;
          H.voidTypeCheck(typeof console != "undefined" ? console.log("BREAK") : null);
          break;
        }
      }
    },
  ...
  main_init: {
    ...
    call$0: function() {
      ...
      stage = new M.Stage(null, false, new M.Rectangle(0, 0, 100000, 100000), 0, t8, null, new M.Matrix(1, 0, 0, 1, 0, 0, t1), null, t9, false, 0, 0, t2, t3, t4, 0, 1, true, null, false, false, null, false, false, false, false, false, t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), H.assertSubtype(t5, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t6), 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, null, false, new M.FilterBlock(true, true, null, null, null, t7, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
      ...
      loader.onComplete = new F.main_init_onAssetsLoaded(stage);
      loader.load$0(0);
      texture = M.Texture_fromImage("textDemoBG.jpg", null, null);
      t7 = new M.Point(null, null);
      t7.x = 0;
      t7.y = 0;
      t6 = new M.Point(null, null);
      ...
      background = new M.Sprite(t7, null, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), false, 0, 0, t6, t5, t4, 0, 1, true, null, false, false, null, false, false, false, false, false, t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), t10._assertCheck$1(null), H.assertSubtype(t3, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t1), 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, null, false, new M.FilterBlock(true, true, null, null, null, t2, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
      ...
      t2.fill = "white";
      t2.align = "left";
      textSample = M.Text$("Pixi.js can has\nmultiline text!", t2);
      ...
      t2.align = "center";
      t2.stroke = "#FFFFFF";
      t2.strokeThickness = 6;
      spinningText = M.Text$("I'm fun!", t2);
      t2 = spinningText.anchor;
      t2.y = 0.5;
      t2.x = 0.5;
      ...
      t2.align = "center";
      t2.stroke = "#a4410e";
      t2.strokeThickness = 7;
      countingText = M.Text$("COUNT 4EVAR: 0", t2);
      t2 = countingText.position;
      t2.x = 310;
      t2.y = 320;
      countingText.anchor.x = 0.5;
      stage.addChildAt$2(textSample, t9.length);
      stage.addChildAt$2(spinningText, t9.length);
      stage.addChildAt$2(countingText, t9.length);
      $.get$requestAnimFrame().call$1(new F.main_init_animate(stage, renderer));
    },
    $isFunction: true
  },
  main_init_onAssetsLoaded: {
    ...
    call$0: function() {
      ...
      t7 = H.assertSubtype([], "$isList", [M.AbstractFilter], "$asList");
      t8 = H.buildFunctionType(H.getVoidRuntimeType(), [H.buildInterfaceType(M.InteractionData)]);
      bitmapFontText = new M.BitmapText(null, null, null, null, 16777215, null, null, null, null, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), false, 0, 0, t2, t3, t4, 0, 1, true, null, false, false, null, false, false, false, false, false, t8._assertCheck$1(null), t8._assertCheck$1(null), t8._assertCheck$1(null), t8._assertCheck$1(null), t8._assertCheck$1(null), t8._assertCheck$1(null), t8._assertCheck$1(null), t8._assertCheck$1(null), t8._assertCheck$1(null), t8._assertCheck$1(null), t8._assertCheck$1(null), t8._assertCheck$1(null), H.assertSubtype(t5, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t6), 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, null, false, new M.FilterBlock(true, true, null, null, null, t7, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
...
function dart_precompiled($collectedClasses) {
  ...
  $desc = $collectedClasses.BitmapText;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  function main_runList() {
  }
  main_runList.builtin$cls = "main_runList";
  if (!"name" in main_runList)
    main_runList.name = "main_runList";
  $desc = $collectedClasses.main_runList;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_runList.prototype = $desc;
  function main_init() {
  }
  main_init.builtin$cls = "main_init";
  if (!"name" in main_init)
    main_init.name = "main_init";
  $desc = $collectedClasses.main_init;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_init.prototype = $desc;
  function main_init_onAssetsLoaded(stage_0) {
    this.stage_0 = stage_0;
  }
  main_init_onAssetsLoaded.builtin$cls = "main_init_onAssetsLoaded";
  if (!"name" in main_init_onAssetsLoaded)
    main_init_onAssetsLoaded.name = "main_init_onAssetsLoaded";
  $desc = $collectedClasses.main_init_onAssetsLoaded;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_init_onAssetsLoaded.prototype = $desc;
  function main_init_animate(stage_1, renderer_2) {
    this.stage_1 = stage_1;
    this.renderer_2 = renderer_2;
  }
  main_init_animate.builtin$cls = "main_init_animate";
  if (!"name" in main_init_animate)
    main_init_animate.name = "main_init_animate";
  $desc = $collectedClasses.main_init_animate;
  if ($desc instanceof Array)
    $desc = $desc[1];
