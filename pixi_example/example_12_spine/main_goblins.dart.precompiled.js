...
["PIXI", "../../lib/pixi.dart", , M, {
  ...
  Skin: {
    ...
    _attachAll$2: function(skeleton, oldSkin) {
      var t1, t2, t3, key, colon, slotIndex;
      for (t1 = oldSkin.attachments.get$keys(), t2 = t1._map, t3 = H.getTypeArgumentByIndex(t1, 0), t3 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t2, t2._modifications, null, H.assertSubtypeOfRuntimeType(null, t3)), [t3]), t3._cell = t3._map._first, H.assertSubtype(t3, "$isIterator", [H.getTypeArgumentByIndex(t1, 0)], "$asIterator"), t1 = H.buildFunctionType(H.buildInterfaceType(P.$int), [H.buildInterfaceType(P.String)]); t3.moveNext$0();) {
        key = H.stringTypeCheck(H.assertSubtypeOfRuntimeType(t3._collection$_current, H.getTypeArgumentByIndex(t3, 0)));
        colon = J.getInterceptor$asx(key).indexOf$1(key, ":");
        t2 = C.JSString_methods.substring$2(key, 0, colon);
        t1._assertCheck$1(null);
        slotIndex = H.Primitives_parseInt(t2, null, null);
        C.JSString_methods.substring$1(key, colon + 1);
        t2 = C.JSArray_methods.$index(skeleton.slots, slotIndex).attachment;
        if (t2 != null)
          t2.name;
      }
    },
  ...
  SkeletonData: {
    ...
    findSkin$1: function(skinName) {
      var t1, n, i, t2;
      for (t1 = this.skins, n = t1.length, i = 0; i < n; ++i) {
        t2 = t1[i];
        if (t2.name === skinName)
          return t2;
      }
  ...
  Skeleton: {
    ...
    setSlotsToSetupPose$0: function() {
      var n, i, t1;
      for (n = this.slots.length, i = 0; i < n; ++i) {
        t1 = this.slots;
        if (i >= t1.length)
          return H.ioore(t1, i);
        t1[i].setToSetupPose$0();
      }
    },
    setSkinByName$1: function(skinName) {
      ...
      if (skin == null)
        throw H.wrapException(P.Exception_Exception("Skin not found: " + skinName));
      t1 = this.skin;
      if (t1 != null && true)
    ...
    getAttachmentBySlotIndex$2: function(slotIndex, attachmentName) {
      ...
      t1 = this.skin;
      if (t1 != null) {
        attachment = t1.attachments.$index(0, "" + slotIndex + ":" + H.S(attachmentName));
        if (attachment != null)
          return attachment;
      }
      t1 = this.data.defaultSkin;
      if (t1 != null)
  ...
  AnimationState: {
    ...
    _setAnimation$2: function(animation, loop) {
      ...
      if (animation != null && this.current != null) {
        t1 = this.stateData;
        t1.animationToMixTime.$index(0, H.S(this.current.name) + ":" + H.S(animation.name));
        t1 = t1.defaultMix;
        this.mixDuration = t1;
        if (t1 > 0) {
          this.mixTime = 0;
  ...
  Spine: {
    ...
    _updateTransform$0: function() {
      ...
      if (t3.length > 0) {
        entry = t3[0];
        if (C.JSNumber_methods.$ge(t2, entry.get$delay())) {
          t1._setAnimation$2(entry.get$animation(entry), entry.get$loop(entry));
  ...
  BaseTexture: {
    ...
    BaseTexture$2: function(source, scaleMode) {
      ...
      if ((!!t2.$isImageElement && t2.get$complete(t1) === true || false) && t2.get$width(t1) !== 0 && t2.get$height(t1) !== 0) {
        ...
        t4 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._html$_target, t3._eventType, W._wrapZone(t4), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)]);
        t4._tryResume$0();
...
["", "main_goblins.dart", , R, {
  ...
  main: [function() {
    ...
    assetsToLoader = ["data/goblins.json", "data/goblinsSpineData.json"];
    ...
    loader.onComplete = new R.main_onAssetsLoaded(stage);
    loader.load$0(0);
    $.get$requestAnimFrame().call$1(new R.main_animate(stage, renderer));
  }, "call$0", "main$closure", 0, 0, 36],
  main_onAssetsLoaded: {
    "^": "Closure:36;stage_0",
    call$0: function() {
      var goblin, t1, t2, animation;
      goblin = M.Spine$("data/goblinsSpineData.json");
      goblin.skeleton.setSkinByName$1("goblin");
      goblin.skeleton.setSlotsToSetupPose$0();
      t1 = goblin.position;
      ...
      t1.x = t2;
      t2 = goblin.state;
      animation = t2.stateData.skeletonData.findAnimation$1("walk");
      if (animation == null)
        H.throwExpression(P.Exception_Exception("Animation not found: walk"));
      C.JSArray_methods.set$length(t2.queue, 0);
      t2._setAnimation$2(animation, true);
      t1 = this.stage_0;
      t1.addChildAt$2(goblin, t1.children.length);
      t1.click = new R.main_onAssetsLoaded_closure(goblin);
    },
    $isFunction: true
  },
  main_onAssetsLoaded_closure: {
    ...
    call$1: function(e) {
      ...
      t1 = this.goblin_1;
      t2 = t1.skeleton;
      t2.setSkinByName$1(t2.skin.name === "goblin" ? "goblingirl" : "goblin");
      t1.skeleton.setSlotsToSetupPose$0();
    },
    $isFunction: true
  },
  main_animate: {
    "^": "Closure:33;stage_2,renderer_3",
    call$1: [function(dt) {
...
function dart_precompiled($collectedClasses) {
  ...
  function main_onAssetsLoaded(stage_0) {
  ...
  function main_onAssetsLoaded_closure(goblin_1) {
    this.goblin_1 = goblin_1;
  }
  ...
  function main_animate(stage_2, renderer_3) {
