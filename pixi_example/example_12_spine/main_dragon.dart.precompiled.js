...
["PIXI", "../../lib/pixi.dart", , M, {
  ...
  CanvasTinter_getTintedTexture: function(sprite, color) {
    var texture, step, rgbValues, stringColor, t1, canvas, tintImage;
    texture = sprite.texture;
    step = $.CanvasTinter_cacheStepsPerColorChannel;
    rgbValues = M.hex2rgb(color);
    rgbValues[0] = P.min(255, rgbValues[0] / step * step);
    rgbValues[1] = P.min(255, rgbValues[1] / step * step);
    rgbValues[2] = P.min(255, rgbValues[2] / step * step);
  ...
  CanvasTinter_tintWithPerPixel: [function(texture, color, canvas) {
    ...
    for (t2 = pixels.length, i = 0; i < t2; i += 4) {
      ...
      pixels[t3] = pixels[t3] * g;
      t3 = i + 2;
      if (t3 >= t2)
        return H.ioore(pixels, t3);
      pixels[t3] = pixels[t3] * b;
    }
  ...
  rgb2hex: function(rgb) {
    ...
    if (typeof t1 !== "number")
      return t1.$mul();
    t1 = C.JSDouble_methods.toInt$0(H.doubleTypeCheck(Math.floor(t1 * 255)));
    t2 = rgb[1];
    if (typeof t2 !== "number")
      return t2.$mul();
    t2 = C.JSDouble_methods.toInt$0(H.doubleTypeCheck(Math.floor(t2 * 255)));
    t3 = rgb[2];
    if (typeof t3 !== "number")
      return t3.$mul();
    return H.intTypeCheck((t1 << 16 >>> 0) + (t2 << 8 >>> 0) + t3 * 255);
  },
  ...
  Sprite: {
    ...
    }, "call$1", "get$_onTextureUpdate", 2, 0, 39, 3],
    _renderCanvas$1: function(renderSession) {
  ...
  SkeletonJson: {
    ...
    readSkeletonData$1: function(root) {
      ...
      for (t1 = skins.get$keys(), t1 = t1.get$iterator(t1), t2 = skeletonData.skins; t1.moveNext$0();) {
        ...
        for (t4 = skinMap.get$keys(), t4 = t4.get$iterator(t4); t4.moveNext$0();) {
          ...
          for (t5 = slotEntry.get$keys(), t5 = t5.get$iterator(t5); t5.moveNext$0();) {
      ...
      for (t1 = animations.get$keys(), t1 = t1.get$iterator(t1); t1.moveNext$0();) {
    ...
    readAnimation$3: function($name, map, skeletonData) {
      ...
      for (t1 = bones.get$keys(), t1 = t1.get$iterator(t1), duration = 0, frameIndex = null, valueMap = null; t1.moveNext$0();) {
        ...
        for (t2 = boneMap.get$keys(), t2 = t2.get$iterator(t2); t2.moveNext$0();) {
      ...
      if (slots != null)
        for (t1 = slots.get$keys(), t1 = t1.get$iterator(t1), t2 = H.buildFunctionType(H.buildInterfaceType(P.$int), [H.buildInterfaceType(P.String)]), values = null; t1.moveNext$0();) {
          slotName = H.stringTypeCheck(t1.get$current());
          if (!slots.containsKey$1(slotName))
            continue;
          slotMap = H.interceptedTypeCheck(slots.$index(0, slotName), "$isMap");
          slotIndex = skeletonData.findSlotIndex$1(slotName);
          for (t3 = slotMap.get$keys(), t3 = t3.get$iterator(t3); t3.moveNext$0();) {
            timelineName = H.stringTypeCheck(t3.get$current());
            if (!slotMap.containsKey$1(timelineName))
              continue;
  ...
  InteractionManager: {
    ...
    }, "call$1", "get$onMouseMove", 2, 0, 40, 4],
    ...
    }, "call$1", "get$onMouseDown", 2, 0, 41, 4],
    onMouseOut$1: [function(_, $event) {
      ...
      t1.x = -10000;
      t1.y = -10000;
    }, "call$1", "get$onMouseOut", 2, 0, 41, 4],
  ...
  JsonLoader: {
    ...
    onJSONLoaded$0: function() {
      ...
      if (t1.$index(0, "frames") != null) {
        ...
        for (t1 = frameData.get$keys(), t1 = t1.get$iterator(t1), t2 = J.getInterceptor$asx(frameData); t1.moveNext$0();) {
          i = t1.get$current();
  ...
  BaseTexture_closure: {
    ...
    call$1: [function(e) {
      ...
      for (t2 = t1._glTextures, i = 0; i < t2._collection$_length; ++i)
...
["dart.async", "dart:async", , P, {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 56, 21, 22],
...
["dart.core", "dart:core", , P, {
  ...
  Duration: {
    ...
    $sub: function(_, other) {
      return P.Duration$(0, 0, C.JSInt_methods.$sub(this._duration, H.interceptedTypeCheck(other, "$isDuration")._duration), 0, 0, 0);
    },
...
["", "main_dragon.dart", , G, {
  ...
  main: [function() {
    ...
    assetsToLoader = ["data/dragonBones.json", "data/dragonBonesData.json"];
    ...
    loader.onComplete = new G.main_onAssetsLoaded(stage);
    loader.load$0(0);
    $.get$requestAnimFrame().call$1(new G.main_animate(stage, renderer));
  }, "call$0", "main$closure", 0, 0, 36],
  main_onAssetsLoaded: {
    "^": "Closure:36;stage_0",
    call$0: function() {
      var dragon, t1, t2, animation;
      dragon = M.Spine$("data/dragonBonesData.json");
      t1 = dragon.position;
      ...
      t2.x = 1;
      t2 = dragon.state;
      animation = t2.stateData.skeletonData.findAnimation$1("flying");
      if (animation == null)
        H.throwExpression(P.Exception_Exception("Animation not found: flying"));
      C.JSArray_methods.set$length(t2.queue, 0);
      t2._setAnimation$2(animation, true);
      t1 = this.stage_0;
      t1.addChildAt$2(dragon, t1.children.length);
    },
    $isFunction: true
  },
  main_animate: {
    ...
    call$1: [function(dt) {
      ...
      t3.globalAlpha = 1;
      t4 = t1.transparent;
      if (!t4 && t1.clearBeforeRender) {
        t3.fillStyle = t2.backgroundColorString;
        J.fillRect$4$x(t3, 0, 0, t1.width, t1.height);
      } else if (t4 && t1.clearBeforeRender)
        J.clearRect$4$x(t3, 0, 0, t1.width, t1.height);
      t3 = t1.renderSession;
      t3.context = t1.context;
      t2._renderCanvas$1(t3);
      if (t2._interactive)
        if (!t2._interactiveEventsAdded) {
          t2._interactiveEventsAdded = true;
          t2 = t2.interactionManager;
          t2.target = t1;
          if (t2.interactionDOMElement == null) {
            t1 = t1.view;
            t2.removeEvents$0();
            t2.interactionDOMElement = t1;
            t3 = J.getInterceptor$x(t1);
            t3.addEventListener$3(t1, "mousemove", t2.get$onMouseMove(t2), true);
            t3.addEventListener$3(t1, "mousedown", t2.get$onMouseDown(t2), true);
            t3.addEventListener$3(t1, "mouseout", t2.get$onMouseOut(t2), true);
            t3.addEventListener$3(t1, "touchstart", t2.get$onTouchStart(t2), true);
            t3.addEventListener$3(t1, "touchend", t2.get$onTouchEnd(t2), true);
            t3.addEventListener$3(t1, "touchmove", t2.get$onTouchMove(t2), true);
            C.Window_methods.addEventListener$3(window, "mouseup", t2.get$onMouseUp(t2), true);
          }
        }
...
function dart_precompiled($collectedClasses) {
  ...
  function main_animate(stage_1, renderer_2) {
