...
["PIXI", "../../lib/pixi.dart", , M, {
  ...
  AnimationStateData: {
    ...
    setMixByName$3: function(fromName, toName, duration) {
      ...
      if (from == null)
        throw H.wrapException(P.Exception_Exception("Animation not found: " + fromName));
      to = this.skeletonData.findAnimation$1(toName);
      if (to == null)
        throw H.wrapException(P.Exception_Exception("Animation not found: " + toName));
      this.animationToMixTime.$indexSet(0, H.S(from.name) + ":" + H.S(to.name), duration);
    },
    getMix$2: function(from, to) {
      var time = this.animationToMixTime.$index(0, H.S(from.name) + ":" + H.S(to.name));
  ...
  AnimationState: {
    ...
    setAnimationByName$2: function(animationName, loop) {
      var animation = this.stateData.skeletonData.findAnimation$1(animationName);
      if (animation == null)
        throw H.wrapException(P.Exception_Exception("Animation not found: " + animationName));
      C.JSArray_methods.set$length(this.queue, 0);
  ...
  AssetLoader: {
    ...
    load$0: function(_) {
      ...
      this.loadCount = 2;
      for (t2 = this.assetURLs, i = 0; i < 2; ++i) {
        fileName = t2[i];
...
["", "main.dart", , F, {
  ...
  main: [function() {
    ...
    loader = new M.AssetLoader(H.assertSubtype(assetsToLoader, "$isList", [P.String], "$asList"), false, 0, null, null, H.assertSubtype(t7, "$isMap", [P.String, [P.List, {func: "void__PixiEvent", void: true, args: [M.PixiEvent]}]], "$asMap"));
    loader.onComplete = new F.main_onAssetsLoaded(stage, new F.main_animate(renderer, stage));
    loader.load$0(0);
  }, "call$0", "main$closure", 0, 0, 36],
  main_animate: {
    "^": "Closure:33;renderer_0,stage_1",
    call$1: [function(dt) {
      var t1, t2, t3, t4, spine, t5, t6;
      for (t1 = this.stage_1, t2 = t1.children, t3 = H.getTypeArgumentByIndex(t2, 0), H.listSuperNativeTypeCheck(t2, "$isIterable"), t4 = t2.length, t2 = H.assertSubtype(H.setRuntimeTypeInfo(new H.ListIterator(H.listSuperNativeTypeCheck(t2, "$isIterable"), t4, 0, H.assertSubtypeOfRuntimeType(null, t3)), [t3]), "$isIterator", [H.getTypeArgumentByIndex(t2, 0)], "$asIterator"); t2.moveNext$0();) {
        spine = H.assertSubtypeOfRuntimeType(t2._current, H.getTypeArgumentByIndex(t2, 0));
        t3 = J.getInterceptor$x(spine);
        t4 = t3.get$position(spine);
        t5 = J.getInterceptor$x(t4);
        t6 = t5.get$x(t4);
        if (typeof t6 !== "number")
          return t6.$add();
        t5.set$x(t4, t6 + 3);
        t4 = J.get$x$x(t3.get$position(spine));
        ...
        if (typeof t4 !== "number")
          return t4.$ge();
        if (t4 >= t5 + 110)
          J.set$x$x(t3.get$position(spine), -110);
      }
      this.renderer_0.render$1(t1);
      $.get$requestAnimFrame().call$1(this);
    }, "call$1", null, 2, 0, null, 77, "call"],
    $isFunction: true
  },
  main_onAssetsLoaded: {
    "^": "Closure:36;stage_2,animate_3",
    call$0: function() {
      var spineBoy, t1, t2;
      spineBoy = M.Spine$("data/spineboySpineData.json");
      t1 = spineBoy.position;
      t1.x = 45;
      t1.y = window.innerHeight;
      t1 = spineBoy.scale;
      ...
      t1.y = t2;
      t1.x = t2;
      spineBoy.stateData.setMixByName$3("walk", "jump", 0.2);
      spineBoy.stateData.setMixByName$3("jump", "walk", 0.4);
      spineBoy.state.setAnimationByName$2("walk", true);
      t2 = this.stage_2;
      t2.addChildAt$2(spineBoy, t2.children.length);
      t1 = new F.main_onAssetsLoaded_closure(spineBoy);
      t2.tap = t1;
      t2.click = t1;
      $.get$requestAnimFrame().call$1(this.animate_3);
    },
    $isFunction: true
  },
  main_onAssetsLoaded_closure: {
    "^": "Closure:33;spineBoy_4",
    call$1: function(e) {
      var t1, animation, entry, t2, t3, t4, previousAnimation, delay;
      t1 = this.spineBoy_4;
      t1.state.setAnimationByName$2("jump", false);
      t1 = t1.state;
      animation = t1.stateData.skeletonData.findAnimation$1("walk");
      if (animation == null)
        H.throwExpression(P.Exception_Exception("Animation not found: walk"));
      ...
      if (t3 !== 0) {
        ...
        if (t4 < 0)
          return H.ioore(t2, t4);
        previousAnimation = t2[t4].animation;
      } else
        previousAnimation = t1.current;
      delay = previousAnimation != null ? C.JSNumber_methods.$sub(previousAnimation.duration, t1.stateData.getMix$2(previousAnimation, animation)) + 0 : 0;
      entry.delay = delay;
      C.JSArray_methods.add$1(t1.queue, entry);
    },
    $isFunction: true
  }
},
...
function dart_precompiled($collectedClasses) {
  ...
  function DisplayObject(position, hitArea, parent, interactiveChildren, mousemove, worldTransform) {
  ...
  DisplayObject.prototype.get$position = function(receiver) {
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Char.prototype = $desc;
  Char.prototype.get$position = function(receiver) {
    return this.position;
  };
  ...
  function main_animate(renderer_0, stage_1) {
  ...
  function main_onAssetsLoaded(stage_2, animate_3) {
    this.stage_2 = stage_2;
    this.animate_3 = animate_3;
  }
  ...
  function main_onAssetsLoaded_closure(spineBoy_4) {
    this.spineBoy_4 = spineBoy_4;
  }
