...
["PIXI", "../../lib/pixi.dart", , M, {
  ...
  DisplayObject: {
    "^": "Object;scale>,rotation<,hitArea<,_worldTransform<,_filters",
    ...
    set$cacheAsBitmap: function(value) {
      var bounds, t1, t2, t3, t4, t5, t6, t7, renderTexture, t8, tempFilters, texture;
      ...
      if (value) {
        ...
        if (t1 == null) {
          ...
          t7 = H.buildFunctionType(t7, [H.buildInterfaceType(M.InteractionData)]);
          t8 = new M.Sprite(t2, null, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), false, null, null, t1, t6, t5, 0, 1, true, null, false, false, null, false, false, false, false, false, t7._assertCheck$1(null), t7._assertCheck$1(null), t7._assertCheck$1(null), t7._assertCheck$1(null), t7._assertCheck$1(null), t7._assertCheck$1(null), t7._assertCheck$1(null), t7._assertCheck$1(null), t7._assertCheck$1(null), t7._assertCheck$1(null), t7._assertCheck$1(null), t7._assertCheck$1(null), H.assertSubtype(t4, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t3), 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, null, false, new M.FilterBlock(true, true, null, null, null, t8, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
          t8.texture = renderTexture;
          t8._setupTexture$0();
          this._cachedSprite = t8;
          t8._worldTransform = this.get$_worldTransform();
        } else
  ...
  DisplayObjectContainer: {
    ...
    getBounds$1: function(matrix) {
      var t1, matrixCache, j, minX, minY, maxX, maxY, childBounds, childMaxX, childMaxY, childVisible, i, child, t2, t3, bounds;
      t1 = this.children;
      if (t1.length === 0)
        return $.get$EmptyRectangle();
      if (matrix != null) {
  ...
  BaseTexture: {
    ...
    BaseTexture$2: function(source, scaleMode) {
      ...
      if ((!!t2.$isImageElement && t2.get$complete(t1) === true || false) && J.get$width$x(this.source) !== 0 && J.get$height$x(this.source) !== 0) {
  ...
  RenderTexture: {
    ...
    renderWebGL$3: [function(displayObject, position, clear) {
      ...
      children = H.assertSubtype(displayObject.children, "$isList", [M.DisplayInterface], "$asList");
      originalWorldTransform = displayObject.get$_worldTransform();
      displayObject.set$_worldTransform($.get$RenderTexture_tempMatrix());
      displayObject.get$_worldTransform().d = -1;
      t1 = displayObject.get$_worldTransform();
      t2 = this.projection.y;
      if (typeof t2 !== "number")
        return t2.$mul();
      t1.ty = H.doubleTypeCheck(t2 * -2);
      displayObject.get$_worldTransform().tx = H.doubleTypeCheck(position.x);
      t1 = displayObject.get$_worldTransform();
      t2 = t1.ty;
      t3 = position.y;
      if (typeof t2 !== "number")
    ...
    renderCanvas$3: [function(displayObject, position, clear) {
      ...
      displayObject.set$_worldTransform($.get$RenderTexture_tempMatrix());
      displayObject.get$_worldTransform().tx = H.doubleTypeCheck(position.x);
      displayObject.get$_worldTransform().ty = H.doubleTypeCheck(position.y);
      for (j = children.length, i = 0; i < j; ++i) {
        if (i >= children.length)
          return H.ioore(children, i);
        children[i]._updateTransform$0();
      ...
      context.setTransform$6(0, 1, 0, 0, 1, 0, 0);
      displayObject.set$_worldTransform(originalWorldTransform);
    }, function(displayObject, position) {
    ...
    RenderTexture$4: function(width, height, renderer, scaleMode) {
      ...
      if (t1.type === 0) {
        ...
        this.PIXI$RenderTexture$baseTexture.source = t3.get$_canvas();
      }
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, assetsToLoader, aliens, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, stage, renderer, alienContainer, loader;
    t1 = {};
    ...
    alienContainer = new M.DisplayObjectContainer(H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), false, null, null, t8, t7, t6, 0, 1, true, null, false, false, null, false, false, false, false, false, t11._assertCheck$1(null), t11._assertCheck$1(null), t11._assertCheck$1(null), t11._assertCheck$1(null), t11._assertCheck$1(null), t11._assertCheck$1(null), t11._assertCheck$1(null), t11._assertCheck$1(null), t11._assertCheck$1(null), t11._assertCheck$1(null), t11._assertCheck$1(null), t11._assertCheck$1(null), H.assertSubtype(t5, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t2), 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, null, false, new M.FilterBlock(true, true, null, null, null, t3, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    t8.x = 400;
    t8.y = 300;
  ...
  main_onAssetsLoaded: {
    ...
    call$0: function() {
      var t1, t2, t3, t4, t5, i, frameName, texture, t6, t7, t8, t9, t10, t11, t12, alien;
      for (t1 = this.random_8, t2 = this.aliens_5, t3 = this.alienContainer_7, t4 = H.buildFunctionType(H.getVoidRuntimeType(), [H.buildInterfaceType(M.InteractionData)]), t5 = this.alienFrames_6, i = 0; i < 100; ++i) {
        frameName = t5[C.JSInt_methods.$mod(i, 4)];
        ...
        t12 = H.assertSubtype([], "$isList", [M.AbstractFilter], "$asList");
        alien = new M.Sprite(t6, null, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), false, null, null, t7, t8, t9, 0, 1, true, null, false, false, null, false, false, false, false, false, t4._assertCheck$1(null), t4._assertCheck$1(null), t4._assertCheck$1(null), t4._assertCheck$1(null), t4._assertCheck$1(null), t4._assertCheck$1(null), t4._assertCheck$1(null), t4._assertCheck$1(null), t4._assertCheck$1(null), t4._assertCheck$1(null), t4._assertCheck$1(null), t4._assertCheck$1(null), H.assertSubtype(t10, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t11), 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, null, false, new M.FilterBlock(true, true, null, null, null, t12, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
        alien.texture = texture;
        if (texture.get$baseTexture()._hasLoaded)
          alien._onTextureUpdate$1(null);
        else
          texture.addEventListener$2(0, "update", alien.get$_onTextureUpdate());
        alien.tint = t1.nextInt$1(16777215);
        t7.x = t1.nextInt$1(800) - 400;
        t7.y = t1.nextInt$1(600) - 300;
        t6.x = 0.5;
        t6.y = 0.5;
...
M.DisplayInterface.$isDisplayInterface = true;
M.DisplayInterface.$isObject = true;
...
function dart_precompiled($collectedClasses) {
  ...
  function DisplayObject(scale, rotation, hitArea, _worldTransform, _filters) {
    this.scale = scale;
