...
["PIXI", "../../lib/pixi.dart", , M, {
  ...
  DisplayObject: {
    "^": "Object;scale>,rotation<,visible<,hitArea<,parent,interactiveChildren,mousemove<,worldTransform<,_filters",
    ...
    set$_filters: function(_filters) {
      this._filters = H.assertSubtype(_filters, "$isList", [M.AbstractFilter], "$asList");
    },
    ...
    set$cacheAsBitmap: function(value) {
      var bounds, t1, t2, t3, t4, t5, t6, t7, renderTexture, tempFilters, texture;
      ...
      if (value) {
        ...
        if (t1 == null) {
          t1 = J.floor$0$n(bounds.width);
          t2 = J.floor$0$n(bounds.height);
          t3 = M.BaseTexture$(null, C.scaleModes_0);
          t4 = $.BaseTextureCacheIdGenerator;
          $.BaseTextureCacheIdGenerator = t4 + 1;
          t5 = H.assertSubtype(P.LinkedHashMap_LinkedHashMap(null, null, null, P.RenderingContext, null), "$isMap", [P.RenderingContext, null], "$asMap");
          t6 = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
          t7 = H.getVoidRuntimeType();
          renderTexture = new M.RenderTexture(null, t1, t2, null, C.scaleModes_0, t3, null, null, H.buildFunctionType(t7, [H.buildInterfaceType(M.DisplayObject), H.buildInterfaceType(M.Point)], [H.buildInterfaceType(P.bool)])._assertCheck$1(null), null, false, false, null, null, null, null, false, null, 0, 0, 0, 0, null, true, null, null, null, t4, 100, 100, C.scaleModes_0, false, null, H.assertSubtype(t5, "$isMap", [P.RenderingContext, null], "$asMap"), null, false, H.buildFunctionType(t7, [H.buildInterfaceType(M.PixiEvent)])._assertCheck$1(null), null, null, H.assertSubtype(t6, "$isMap", [P.String, [P.List, {func: "void__PixiEvent", void: true, args: [M.PixiEvent]}]], "$asMap"));
          renderTexture.BaseTexture$2(null, C.scaleModes_0);
          renderTexture.scope = renderTexture;
          renderTexture.RenderTexture$4(t1, t2, null, C.scaleModes_0);
          ...
          t4 = H.assertSubtype([], "$isList", [M.AbstractFilter], "$asList");
          t4 = new M.Sprite(t2, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t1, t6, t7, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t5, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t3), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t4, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
          t4.texture = renderTexture;
          t4._setupTexture$0();
          this._cachedSprite = t4;
          t4.worldTransform = this.get$worldTransform();
        } else
          H.interceptedTypeCast(t1.texture, "$isRenderTexture").resize$2(0, J.floor$0$n(bounds.width), J.floor$0$n(bounds.height));
        tempFilters = this._filters;
        this.set$_filters(null);
        this._cachedSprite.set$filters(tempFilters);
        texture = H.interceptedTypeCast(this._cachedSprite.texture, "$isRenderTexture");
        t1 = bounds.x;
        if (typeof t1 !== "number")
          return t1.$negate();
        t2 = bounds.y;
        ...
        t3.x = -t1;
        t3.y = -t2;
        texture.render$3(this, t3, false);
        t3 = this._cachedSprite.anchor;
        t2 = bounds.x;
        t1 = bounds.width;
        if (typeof t2 !== "number")
          return t2.$div();
        t3.x = -C.JSNumber_methods.$div(t2, t1);
        t1 = this._cachedSprite.anchor;
        t2 = bounds.y;
        t3 = bounds.height;
        if (typeof t2 !== "number")
          return t2.$div();
        t1.y = -C.JSNumber_methods.$div(t2, t3);
        this.set$_filters(tempFilters);
    ...
    set$filters: function(value) {
      H.assertSubtype(value, "$isList", [M.AbstractFilter], "$asList");
      this.set$_filters(value);
    },
  ...
  DisplayObjectContainer: {
    ...
    addChild$1: function(child) {
      return this.addChildAt$2(child, this.children.length);
    },
    ...
    getBounds$1: function(matrix) {
      var t1, matrixCache, j, minX, minY, maxX, maxY, childBounds, childMaxX, childMaxY, childVisible, i, t2, t3, bounds;
      t1 = this.children;
      if (t1.length === 0)
        return $.get$EmptyRectangle();
      if (matrix != null) {
      ...
      for (j = t1.length, minX = 1 / 0, minY = 1 / 0, maxX = -1 / 0, maxY = -1 / 0, childBounds = null, childMaxX = null, childMaxY = null, childVisible = false, i = 0; i < j; ++i) {
        ...
        if (typeof minX !== "number")
          return minX.$lt();
        if (C.JSNumber_methods.$lt(minX, t2))
          ;
        else
          minX = childBounds.x;
        t2 = childBounds.y;
        if (typeof minY !== "number")
          return minY.$lt();
        if (C.JSNumber_methods.$lt(minY, t2))
          ;
        else
          minY = childBounds.y;
        ...
        if (typeof t2 !== "number")
          return t2.$add();
        childMaxX = C.JSNumber_methods.$add(t2, t3);
        t3 = childBounds.height;
        t2 = childBounds.y;
        if (typeof t3 !== "number")
          return t3.$add();
        childMaxY = C.JSNumber_methods.$add(t3, t2);
      ...
      bounds.x = minX;
      bounds.y = minY;
      bounds.width = C.JSNumber_methods.$sub(maxX, minX);
      bounds.height = C.JSNumber_methods.$sub(maxY, minY);
      return bounds;
    },
  ...
  Sprite: {
    ...
    onTextureUpdate$1: [function(e) {
      ...
      if (t1 !== 0)
        this.scale.x = C.JSInt_methods.$div(t1, this.texture.get$frame().width);
      t1 = this.PIXI$Sprite$_height;
      if (t1 !== 0)
        this.scale.y = C.JSInt_methods.$div(t1, this.texture.get$frame().height);
  ...
  SkeletonJson: {
    ...
    readSkeletonData$1: function(root) {
      var t1, skeletonData, bones, t2, n, i, boneMap, $parent, boneData, t3, slots, slotMap, slotData, color, t4, t5, skins, skinName, skinMap, skin, slotName, slotIndex, slotEntry, attachmentName, attachment, animations, animationName;
      ...
      for (t1 = J.getInterceptor$asx(slots), n = t1.get$length(slots), t2 = skeletonData.slots, t3 = H.buildFunctionType(H.buildInterfaceType(P.$int), [H.buildInterfaceType(P.String)]), i = 0; i < n; ++i) {
        ...
        if (color != null) {
          ...
          t5 = C.JSString_methods.substring$2(color, 0, 2);
          ...
          if (t4)
            H.throwExpression("Color hexidecimal length must be 8, recieved: " + color);
          t5 = C.JSString_methods.substring$2(color, 2, 2);
          t3._assertCheck$1(null);
          t5 = J.toRadixString$1$n(H.Primitives_parseInt(t5, null, null), 16);
          t3._assertCheck$1(null);
          t5 = H.Primitives_parseInt(t5, null, null);
          ...
          if (t4)
            H.throwExpression("Color hexidecimal length must be 8, recieved: " + color);
          t5 = C.JSString_methods.substring$2(color, 4, 2);
          t3._assertCheck$1(null);
          t5 = J.toRadixString$1$n(H.Primitives_parseInt(t5, null, null), 16);
          t3._assertCheck$1(null);
          t5 = H.Primitives_parseInt(t5, null, null);
          ...
          if (t4)
            H.throwExpression("Color hexidecimal length must be 8, recieved: " + color);
          t4 = C.JSString_methods.substring$2(color, 6, 2);
          t3._assertCheck$1(null);
        ...
        C.JSArray_methods.add$1(t2, slotData);
      }
            ...
            for (t1 = this.crossorigin, j = 0; C.JSInt_methods.$lt(j, J.get$length$asx(J.$index$asx(this.atlas.$index(0, "meta"), "image"))); ++j) {
              ...
              for (t2 = J.getInterceptor$ax(frameData), t3 = t2.get$iterator(frameData); t3.moveNext$0();) {
                ...
                if (H.boolConversionCheck(rect)) {
                  ...
                  if (j >= t5.length)
                    return H.ioore(t5, j);
                  t5 = t5[j].PIXI$ImageLoader$texture.get$baseTexture();
  ...
  ImageLoader: {
    ...
    load$0: function(_) {
      if (!this.PIXI$ImageLoader$texture.get$baseTexture()._hasLoaded)
        this.PIXI$ImageLoader$texture.get$baseTexture().addEventListener$2(0, "loaded", new M.ImageLoader_load_closure(this));
      else
        this.onLoaded$0();
    },
    onLoaded$0: function() {
  ...
  CanvasRenderer: {
    ...
    renderDisplayObject$2: function(displayObject, context) {
  ...
  FilterTexture: {
    ...
    clear$0: function(_) {
      var gl = this.gl;
      J.getInterceptor$x(gl).clearColor$4(gl, 0, 0, 0, 0);
    ...
    resize$2: function(_, width, height) {
      ...
      C.RenderingContext_methods.texImage2DTyped$9(gl, 3553, 0, 6408, width, height, 0, 6408, 5121, null);
      C.RenderingContext_methods.bindRenderbuffer$2(gl, 36161, this.renderBuffer);
      C.RenderingContext_methods.renderbufferStorage$4(gl, 36161, 34041, width, height);
    },
    ...
    static: {FilterTexture$: function(gl, width, height, scaleMode) {
        ...
        t1.FilterTexture$4(gl, H.intTypeCheck(width), H.intTypeCheck(height), scaleMode);
        return t1;
      }}
  },
  ...
  WebGLSpriteBatch: {
    ...
    render$1: function(sprite) {
      var texture, uvs, alpha, tint, verticies, t1, aX, aY, t2, t3, w1, w0, h1, h0, index, worldTransform, a, b, c, d, tx, ty, index0, t4, t5, t6;
      texture = sprite.texture;
    ...
    renderBatch$3: function(texture, size, startIndex) {
      ...
      if (texture._dirty.$index(0, this.gl) === true) {
        ...
        if (t1._glTextures.$index(0, t2) != null) {
          ...
          C.RenderingContext_methods.texParameteri$3(t2, 3553, 10240, t1.scaleMode === C.scaleModes_1 ? 9729 : 9728);
          C.RenderingContext_methods.texParameteri$3(t2, 3553, 10241, t1.scaleMode === C.scaleModes_1 ? 9729 : 9728);
          if (!t1._powerOf2) {
  ...
  RenderTexture: {
    "^": "Texture;renderer,PIXI$RenderTexture$width,PIXI$RenderTexture$height,frame:PIXI$RenderTexture$frame<,PIXI$RenderTexture$scaleMode,baseTexture:PIXI$RenderTexture$baseTexture<,textureBuffer,projection,render,valid:PIXI$RenderTexture$valid<,noFrame,updateFrame,frame,trim,scope,_uvs,valid,baseTexture,PIXI$Texture$width,PIXI$Texture$height,sourceWidth,sourceHeight,tintCache,needsUpdate,isTiling,canvasBuffer,crop,id,width,height,scaleMode,_hasLoaded,source,_glTextures,imageUrl,_powerOf2,onLoaded,premultipliedAlpha,_dirty,listeners",
    set$width: function(_, width) {
      this.PIXI$RenderTexture$width = H.numTypeCheck(width);
    },
    set$height: function(_, height) {
      this.PIXI$RenderTexture$height = H.numTypeCheck(height);
    },
    set$frame: function(frame) {
      this.PIXI$RenderTexture$frame = H.interceptedTypeCheck(frame, "$isRectangle");
    },
    set$baseTexture: function(baseTexture) {
      this.PIXI$RenderTexture$baseTexture = H.interceptedTypeCheck(baseTexture, "$isBaseTexture");
    },
    set$valid: function(valid) {
      this.PIXI$RenderTexture$valid = H.boolTypeCheck(valid);
    },
    ...
    resize$3: function(_, width, height, updateBase) {
      var t1;
      if (width === this.PIXI$RenderTexture$width && height === this.PIXI$RenderTexture$height)
        return;
      t1 = this.PIXI$RenderTexture$frame;
      t1.width = width;
      this.PIXI$RenderTexture$width = width;
      t1.height = height;
      this.PIXI$RenderTexture$height = height;
      if (updateBase) {
        t1 = this.PIXI$RenderTexture$baseTexture;
        t1.width = width;
        t1.height = height;
      }
      ...
      this.textureBuffer.resize$2(0, width, height);
    },
    resize$2: function($receiver, width, height) {
      return this.resize$3($receiver, width, height, false);
    },
    renderWebGL$3: [function(displayObject, position, clear) {
      var gl, children, originalWorldTransform, t1, t2, t3, j, i;
      H.interceptedTypeCheck(displayObject, "$isDisplayObjectContainer");
      gl = this.renderer.gl;
      J.getInterceptor$x(gl).colorMask$4(gl, true, true, true, true);
      C.RenderingContext_methods.viewport$4(gl, 0, 0, this.PIXI$RenderTexture$width, this.PIXI$RenderTexture$height);
      C.RenderingContext_methods.bindFramebuffer$2(gl, 36160, this.textureBuffer.get$frameBuffer());
      if (clear)
        this.textureBuffer.clear$0(0);
      children = H.assertSubtype(displayObject.children, "$isList", [M.DisplayObject], "$asList");
      originalWorldTransform = displayObject.get$worldTransform();
      displayObject.set$worldTransform($.get$RenderTexture_tempMatrix());
      displayObject.get$worldTransform().d = -1;
      t1 = displayObject.get$worldTransform();
      t2 = this.projection.y;
      if (typeof t2 !== "number")
        return t2.$mul();
      t1.ty = H.doubleTypeCheck(t2 * -2);
      displayObject.get$worldTransform().tx = H.doubleTypeCheck(position.x);
      t1 = displayObject.get$worldTransform();
      t2 = t1.ty;
      t3 = position.y;
      if (typeof t2 !== "number")
        return t2.$sub();
      t1.ty = C.JSDouble_methods.$sub(t2, t3);
      ...
      t1 = this.renderer;
      t1.spriteBatch.dirty = true;
      t1.renderDisplayObject$3(displayObject, this.projection, this.textureBuffer.get$frameBuffer());
      displayObject.set$worldTransform(originalWorldTransform);
      this.renderer.spriteBatch.dirty = true;
    }, function(displayObject, position) {
      return this.renderWebGL$3(displayObject, position, false);
    }, "renderWebGL$2", "call$3", "call$2", "get$renderWebGL", 4, 2, 58, 59],
    renderCanvas$3: [function(displayObject, position, clear) {
      ...
      displayObject.set$worldTransform($.get$RenderTexture_tempMatrix());
      displayObject.get$worldTransform().tx = H.doubleTypeCheck(position.x);
      displayObject.get$worldTransform().ty = H.doubleTypeCheck(position.y);
      for (j = children.length, i = 0; i < j; ++i) {
        if (i >= children.length)
          return H.ioore(children, i);
        children[i].updateTransform$0();
    ...
    }, "renderCanvas$2", "call$3", "call$2", "get$renderCanvas", 4, 2, 60, 59],
    RenderTexture$4: function(width, height, renderer, scaleMode) {
      ...
      this.PIXI$RenderTexture$frame = new M.Rectangle(0, 0, t2, t3);
      this.crop = new M.Rectangle(0, 0, t2, t3);
      ...
      if (t1.type === 0) {
        ...
        this.PIXI$RenderTexture$baseTexture._glTextures.$indexSet(0, gl, t1.texture);
      ...
      this.PIXI$RenderTexture$valid = true;
      C.JSArray_methods.add$1($.get$Texture_frameUpdates(), this);
    },
    $isRenderTexture: true,
    static: {"^": "RenderTexture_tempMatrix"}
  },
  Texture: {
    ...
    setFrame$1: function(frame) {
      ...
      if (this.trim == null) {
        ...
        if (typeof t1 !== "number")
          return t1.$add();
        if (!C.JSNumber_methods.$gt(C.JSNumber_methods.$add(t1, t2), this.get$baseTexture().width)) {
          t1 = frame.y;
          t2 = frame.height;
          if (typeof t1 !== "number")
            return t1.$add();
          t2 = C.JSNumber_methods.$gt(C.JSNumber_methods.$add(t1, t2), this.get$baseTexture().height);
          t1 = t2;
        } else
          t1 = true;
      } else
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|CanvasGradient|CanvasPattern|DOMError|FileError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGPointList|SVGRect"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["dart.async", "dart:async", , P, {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 75, 21, 22],
...
["dart.dom.html", "dart:html", , W, {
  ...
  _DataAttributeMap: {
    "^": "Object;_attributes",
    containsKey$1: function(key) {
      return J._hasAttribute$1$x(this._attributes._element, "data-" + this._toHyphenedName$1(key));
    },
    $index: function(_, key) {
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, assetsToLoader, aliens, t2, t3, t4, t5, t6, t7, t8, t9, t10, stage, renderer, alienContainer, loader;
    t1 = {};
    ...
    alienContainer = new M.DisplayObjectContainer(H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t8, t7, t6, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t5, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t2), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t3, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    t8.x = 400;
    t8.y = 300;
    stage.addChildAt$2(alienContainer, t10.length);
    t2 = new F.main_closure(alienContainer);
    stage.tap = t2;
    stage.mousedown = t2;
    H.assertSubtype(assetsToLoader, "$isList", [P.String], "$asList");
    t2 = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
    loader = new M.AssetLoader(H.assertSubtype(assetsToLoader, "$isList", [P.String], "$asList"), false, 0, null, null, H.assertSubtype(t2, "$isMap", [P.String, [P.List, {func: "void__PixiEvent", void: true, args: [M.PixiEvent]}]], "$asMap"));
    loader.onComplete = new F.main_onAssetsLoaded(aliens, ["eggHead.png", "flowerTop.png", "helmlok.png", "skully.png"], alienContainer, C.C__JSRandom, new F.main_animate(t1, aliens, stage, renderer, alienContainer));
    loader.load$0(0);
  }, "call$0", "main$closure", 0, 0, 36],
  main_animate: {
    "^": "Closure:33;box_0,aliens_1,stage_2,renderer_3,alienContainer_4",
    call$1: [function(dt) {
      var t1, i, t2, t3, t4, t5;
      for (t1 = this.aliens_1, i = 0; i < 100; ++i) {
        if (i >= t1.length)
          return H.ioore(t1, i);
        t1[i].rotation += 0.1;
      }
      ...
      t1 = t1.count_0;
      t3.y = Math.sin(t1);
      t2.set$rotation(t2.get$rotation() + 0.01);
      this.renderer_3.render$1(this.stage_2);
      $.get$requestAnimFrame().call$1(this);
    }, "call$1", null, 2, 0, null, 81, "call"],
    $isFunction: true
  },
  main_onAssetsLoaded: {
    "^": "Closure:36;aliens_5,alienFrames_6,alienContainer_7,random_8,animate_9",
    call$0: function() {
      var t1, t2, t3, t4, i, frameName, texture, t5, t6, t7, t8, t9, t10, t11, alien;
      for (t1 = this.random_8, t2 = this.aliens_5, t3 = this.alienContainer_7, t4 = this.alienFrames_6, i = 0; i < 100; ++i) {
        frameName = t4[C.JSInt_methods.$mod(i, 4)];
        texture = $.get$TextureCache().$index(0, frameName);
        if (texture == null)
          H.throwExpression(P.Exception_Exception("The frameId \"" + frameName + "\" does not exist in the texture cache."));
        ...
        alien = new M.Sprite(t5, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t6, t7, t8, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t9, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t10), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t11, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
        alien.texture = texture;
        if (texture.get$baseTexture()._hasLoaded)
          alien.onTextureUpdate$1(null);
        else
          texture.addEventListener$2(0, "update", alien.get$onTextureUpdate());
        alien.tint = t1.nextInt$1(16777215);
        t6.x = t1.nextInt$1(800) - 400;
        t6.y = t1.nextInt$1(600) - 300;
        t5.x = 0.5;
        t5.y = 0.5;
        C.JSArray_methods.add$1(t2, alien);
        t3.addChild$1(alien);
      }
      $.get$requestAnimFrame().call$1(this.animate_9);
    },
    $isFunction: true
  },
  main_closure: {
    "^": "Closure:33;alienContainer_10",
    call$1: function(e) {
      var t1 = this.alienContainer_10;
      t1.set$cacheAsBitmap(!t1.get$cacheAsBitmap());
    },
    $isFunction: true
  }
},
...
M.DisplayObjectContainer.$isDisplayObject = true;
...
M.DisplayObject.$isDisplayObject = true;
M.DisplayObject.$isDisplayInterface = true;
M.DisplayObject.$isObject = true;
...
"evt",
{func: "dynamic__DisplayObjectContainer_Point__bool", args: [M.DisplayObjectContainer, M.Point], opt: [P.bool]},
false,
{func: "void__DisplayObjectContainer_Point__bool", void: true, args: [M.DisplayObjectContainer, M.Point], opt: [P.bool]},
...
function dart_precompiled($collectedClasses) {
  ...
  function DisplayObject(scale, rotation, visible, hitArea, parent, interactiveChildren, mousemove, worldTransform, _filters) {
    this.scale = scale;
  ...
  DisplayObject.prototype.get$scale = function(receiver) {
    return this.scale;
  };
  ...
  function RenderTexture(renderer, PIXI$RenderTexture$width, PIXI$RenderTexture$height, PIXI$RenderTexture$frame, PIXI$RenderTexture$scaleMode, PIXI$RenderTexture$baseTexture, textureBuffer, projection, render, PIXI$RenderTexture$valid, noFrame, updateFrame, frame, trim, scope, _uvs, valid, baseTexture, PIXI$Texture$width, PIXI$Texture$height, sourceWidth, sourceHeight, tintCache, needsUpdate, isTiling, canvasBuffer, crop, id, width, height, scaleMode, _hasLoaded, source, _glTextures, imageUrl, _powerOf2, onLoaded, premultipliedAlpha, _dirty, listeners) {
    this.renderer = renderer;
    ...
    this.projection = projection;
    this.render = render;
    this.PIXI$RenderTexture$valid = PIXI$RenderTexture$valid;
  ...
  RenderTexture.prototype.get$valid = function() {
    return this.PIXI$RenderTexture$valid;
  };
  ...
  function main_animate(box_0, aliens_1, stage_2, renderer_3, alienContainer_4) {
    this.box_0 = box_0;
    this.aliens_1 = aliens_1;
    this.stage_2 = stage_2;
    this.renderer_3 = renderer_3;
    this.alienContainer_4 = alienContainer_4;
  }
  ...
  function main_onAssetsLoaded(aliens_5, alienFrames_6, alienContainer_7, random_8, animate_9) {
    this.aliens_5 = aliens_5;
    this.alienFrames_6 = alienFrames_6;
    this.alienContainer_7 = alienContainer_7;
    this.random_8 = random_8;
    this.animate_9 = animate_9;
  }
  ...
  function main_closure(alienContainer_10) {
    this.alienContainer_10 = alienContainer_10;
  }
