...
["PIXI", "../../lib/pixi.dart", , M, {
  "^": "",
  CanvasGraphics_renderGraphics: function(graphics, context) {
    var worldAlpha, i, t1, data, points, t2, j, t3, t4, ellipseData, w, h, x, y, ox, oy, xe, t5, ye, xm, ym, rx, ry, width, height, radius, maxRadius;
    worldAlpha = graphics.worldAlpha;
    for (i = 0; t1 = graphics.graphicsData, i < t1.length; ++i) {
      data = t1[i];
      t1 = J.getInterceptor$x(data);
      points = t1.get$points(data);
      t2 = C.JSDouble_methods.toInt$0(H.doubleTypeCheck(Math.floor(data.get$lineColor())));
      context.strokeStyle = "#" + C.JSString_methods.padLeft$2(t2.toString(16), 6, "0");
      context.lineWidth = H.numTypeCheck(t1.get$lineWidth(data));
      if (t1.get$type(data) === $.Graphics_POLY) {
        context.beginPath();
        t2 = J.getInterceptor$asx(points);
        C.CanvasRenderingContext2D_methods.moveTo$2(context, t2.$index(points, 0), t2.$index(points, 1));
        for (j = 1; j < t2.get$length(points) / 2; ++j) {
          t3 = j * 2;
          C.CanvasRenderingContext2D_methods.lineTo$2(context, t2.$index(points, t3), t2.$index(points, t3 + 1));
        }
        if (J.$eq(t2.$index(points, 0), t2.$index(points, t2.get$length(points) - 2)) && J.$eq(t2.$index(points, 1), t2.$index(points, t2.get$length(points) - 1)))
          context.closePath();
        if (H.boolConversionCheck(t1.get$fill(data))) {
          context.globalAlpha = data.get$fillAlpha() * worldAlpha;
          t2 = C.JSDouble_methods.toInt$0(H.doubleTypeCheck(Math.floor(data.get$fillColor())));
          context.fillStyle = "#" + C.JSString_methods.padLeft$2(t2.toString(16), 6, "0");
          context.fill("nonzero");
        }
        if (!J.$eq(t1.get$lineWidth(data), 0)) {
          context.globalAlpha = data.get$lineAlpha() * worldAlpha;
          context.stroke();
        }
      } else if (t1.get$type(data) === $.Graphics_RECT) {
        if (H.boolConversionCheck(t1.get$fill(data))) {
          context.globalAlpha = data.get$fillAlpha() * worldAlpha;
          t2 = C.JSDouble_methods.toInt$0(H.doubleTypeCheck(Math.floor(data.get$fillColor())));
          context.fillStyle = "#" + C.JSString_methods.padLeft$2(t2.toString(16), 6, "0");
          t2 = J.getInterceptor$asx(points);
          C.CanvasRenderingContext2D_methods.fillRect$4(context, t2.$index(points, 0), t2.$index(points, 1), t2.$index(points, 2), t2.$index(points, 3));
        }
        if (!J.$eq(t1.get$lineWidth(data), 0)) {
          context.globalAlpha = data.get$lineAlpha() * worldAlpha;
          t1 = J.getInterceptor$asx(points);
          C.CanvasRenderingContext2D_methods.strokeRect$4(context, t1.$index(points, 0), t1.$index(points, 1), t1.$index(points, 2), t1.$index(points, 3));
        }
      } else if (t1.get$type(data) === $.Graphics_CIRC) {
        context.beginPath();
        t2 = J.getInterceptor$asx(points);
        t3 = t2.$index(points, 0);
        t4 = t2.$index(points, 1);
        t2 = t2.$index(points, 2);
        H.numTypeCheck(t3);
        H.numTypeCheck(t4);
        H.numTypeCheck(t2);
        C.CanvasRenderingContext2D_methods._arc$6(context, t3, t4, t2, 0, 6.283185307179586, false);
        context.closePath();
        if (H.boolConversionCheck(t1.get$fill(data))) {
          context.globalAlpha = data.get$fillAlpha() * worldAlpha;
          t2 = C.JSDouble_methods.toInt$0(H.doubleTypeCheck(Math.floor(data.get$fillColor())));
      ...
      } else if (t1.get$type(data) === $.Graphics_ELIP) {
        ellipseData = t1.get$points(data);
        ...
        context.beginPath();
        ox = t3.$div(w, 2) * 0.5522848;
        oy = t4.$div(h, 2) * 0.5522848;
        ...
        C.CanvasRenderingContext2D_methods.moveTo$2(context, x, ym);
        t4 = J.getInterceptor$n(ym);
        t5 = J.getInterceptor$n(xm);
        C.CanvasRenderingContext2D_methods.bezierCurveTo$6(context, x, t4.$sub(ym, oy), t5.$sub(xm, ox), y, xm, y);
        C.CanvasRenderingContext2D_methods.bezierCurveTo$6(context, t5.$add(xm, ox), y, xe, t4.$sub(ym, oy), xe, ym);
        C.CanvasRenderingContext2D_methods.bezierCurveTo$6(context, xe, t4.$add(ym, oy), t5.$add(xm, ox), ye, xm, ye);
        C.CanvasRenderingContext2D_methods.bezierCurveTo$6(context, t5.$sub(xm, ox), ye, x, t4.$add(ym, oy), x, ym);
        context.closePath();
        if (H.boolConversionCheck(t1.get$fill(data))) {
          context.globalAlpha = data.get$fillAlpha() * worldAlpha;
          t2 = C.JSDouble_methods.toInt$0(H.doubleTypeCheck(Math.floor(data.get$fillColor())));
      ...
      } else if (t1.get$type(data) === $.Graphics_RREC) {
        t2 = J.getInterceptor$asx(points);
        rx = H.numTypeCheck(t2.$index(points, 0));
        ry = H.numTypeCheck(t2.$index(points, 1));
        width = H.numTypeCheck(t2.$index(points, 2));
        height = H.numTypeCheck(t2.$index(points, 3));
        radius = H.numTypeCheck(t2.$index(points, 4));
        maxRadius = C.JSDouble_methods.toInt$0(H.doubleTypeCheck(Math.floor(P.min(width, height) / 2)));
        ...
        if (typeof ry !== "number")
          return ry.$add();
        t2 = ry + radius;
        C.CanvasRenderingContext2D_methods.moveTo$2(context, rx, t2);
        C.CanvasRenderingContext2D_methods.lineTo$2(context, rx, C.JSNumber_methods.$add(ry, height) - radius);
        t3 = C.JSNumber_methods.$add(ry, height);
        if (typeof rx !== "number")
          return rx.$add();
        t4 = rx + radius;
        C.CanvasRenderingContext2D_methods.quadraticCurveTo$4(context, rx, t3, t4, C.JSNumber_methods.$add(ry, height));
        C.CanvasRenderingContext2D_methods.lineTo$2(context, C.JSNumber_methods.$add(rx, width) - radius, C.JSNumber_methods.$add(ry, height));
        C.CanvasRenderingContext2D_methods.quadraticCurveTo$4(context, C.JSNumber_methods.$add(rx, width), C.JSNumber_methods.$add(ry, height), C.JSNumber_methods.$add(rx, width), C.JSNumber_methods.$add(ry, height) - radius);
        C.CanvasRenderingContext2D_methods.lineTo$2(context, C.JSNumber_methods.$add(rx, width), t2);
        C.CanvasRenderingContext2D_methods.quadraticCurveTo$4(context, C.JSNumber_methods.$add(rx, width), ry, C.JSNumber_methods.$add(rx, width) - radius, ry);
        C.CanvasRenderingContext2D_methods.lineTo$2(context, t4, ry);
        C.CanvasRenderingContext2D_methods.quadraticCurveTo$4(context, rx, ry, rx, t2);
        context.closePath();
        if (H.boolConversionCheck(t1.get$fill(data))) {
          context.globalAlpha = data.get$fillAlpha() * worldAlpha;
          t2 = C.JSDouble_methods.toInt$0(H.doubleTypeCheck(Math.floor(data.get$fillColor())));
  ...
  CanvasGraphics_renderGraphicsMask: function(graphics, context) {
    var len, i, t1, data, points, j, t2, t3, ellipseData, w, h, x, y, ox, oy, xe, t4, ye, xm, ym, rx, ry, width, height, radius, maxRadius;
    ...
    if (len > 1) {
      window;
      H.voidTypeCheck(typeof console != "undefined" ? console.log("Pixi.js warning: masks in canvas can only mask using the first path in the graphics object") : null);
    }
    for (i = 0; i < 1; ++i) {
      t1 = graphics.graphicsData;
      if (i >= t1.length)
        return H.ioore(t1, i);
      data = t1[i];
      t1 = J.getInterceptor$x(data);
      ...
      if (t1.get$type(data) === $.Graphics_POLY) {
        context.beginPath();
        t1 = J.getInterceptor$asx(points);
        C.CanvasRenderingContext2D_methods.moveTo$2(context, t1.$index(points, 0), t1.$index(points, 1));
        for (j = 1; j < t1.get$length(points) / 2; ++j) {
          t2 = j * 2;
          C.CanvasRenderingContext2D_methods.lineTo$2(context, t1.$index(points, t2), t1.$index(points, t2 + 1));
        }
        if (J.$eq(t1.$index(points, 0), t1.$index(points, t1.get$length(points) - 2)) && J.$eq(t1.$index(points, 1), t1.$index(points, t1.get$length(points) - 1)))
          context.closePath();
      } else if (t1.get$type(data) === $.Graphics_RECT) {
        context.beginPath();
        t1 = J.getInterceptor$asx(points);
        C.CanvasRenderingContext2D_methods.rect$4(context, t1.$index(points, 0), t1.$index(points, 1), t1.$index(points, 2), t1.$index(points, 3));
        context.closePath();
      } else if (t1.get$type(data) === $.Graphics_CIRC) {
        context.beginPath();
        t1 = J.getInterceptor$asx(points);
        t2 = t1.$index(points, 0);
        t3 = t1.$index(points, 1);
        t1 = t1.$index(points, 2);
        H.numTypeCheck(t2);
        H.numTypeCheck(t3);
        H.numTypeCheck(t1);
        C.CanvasRenderingContext2D_methods._arc$6(context, t2, t3, t1, 0, 6.283185307179586, false);
        context.closePath();
      } else if (t1.get$type(data) === $.Graphics_ELIP) {
        ellipseData = t1.get$points(data);
        t1 = J.getInterceptor$asx(ellipseData);
        w = J.$mul$ns(t1.$index(ellipseData, 2), 2);
        h = J.$mul$ns(t1.$index(ellipseData, 3), 2);
        t2 = J.getInterceptor$n(w);
        x = J.$sub$n(t1.$index(ellipseData, 0), t2.$div(w, 2));
        t3 = J.getInterceptor$n(h);
        y = J.$sub$n(t1.$index(ellipseData, 1), t3.$div(h, 2));
        context.beginPath();
        ox = t2.$div(w, 2) * 0.5522848;
        oy = t3.$div(h, 2) * 0.5522848;
        t1 = J.getInterceptor$ns(x);
        xe = t1.$add(x, w);
        t4 = J.getInterceptor$ns(y);
        ye = t4.$add(y, h);
        xm = t1.$add(x, t2.$div(w, 2));
        ym = t4.$add(y, t3.$div(h, 2));
        C.CanvasRenderingContext2D_methods.moveTo$2(context, x, ym);
        t3 = J.getInterceptor$n(ym);
        t4 = J.getInterceptor$n(xm);
        C.CanvasRenderingContext2D_methods.bezierCurveTo$6(context, x, t3.$sub(ym, oy), t4.$sub(xm, ox), y, xm, y);
        C.CanvasRenderingContext2D_methods.bezierCurveTo$6(context, t4.$add(xm, ox), y, xe, t3.$sub(ym, oy), xe, ym);
        C.CanvasRenderingContext2D_methods.bezierCurveTo$6(context, xe, t3.$add(ym, oy), t4.$add(xm, ox), ye, xm, ye);
        C.CanvasRenderingContext2D_methods.bezierCurveTo$6(context, t4.$sub(xm, ox), ye, x, t3.$add(ym, oy), x, ym);
        context.closePath();
      } else if (t1.get$type(data) === $.Graphics_RREC) {
        t1 = J.getInterceptor$asx(points);
        rx = H.numTypeCheck(t1.$index(points, 0));
        ry = H.numTypeCheck(t1.$index(points, 1));
        width = H.numTypeCheck(t1.$index(points, 2));
        height = H.numTypeCheck(t1.$index(points, 3));
        radius = H.numTypeCheck(t1.$index(points, 4));
        maxRadius = C.JSDouble_methods.toInt$0(H.doubleTypeCheck(Math.floor(P.min(width, height) / 2)));
        if (typeof radius !== "number")
          return radius.$gt();
        if (radius > maxRadius)
        ...
        if (typeof ry !== "number")
          return ry.$add();
        t1 = ry + radius;
        C.CanvasRenderingContext2D_methods.moveTo$2(context, rx, t1);
        C.CanvasRenderingContext2D_methods.lineTo$2(context, rx, C.JSNumber_methods.$add(ry, height) - radius);
        t2 = C.JSNumber_methods.$add(ry, height);
        if (typeof rx !== "number")
          return rx.$add();
        t3 = rx + radius;
        C.CanvasRenderingContext2D_methods.quadraticCurveTo$4(context, rx, t2, t3, C.JSNumber_methods.$add(ry, height));
        C.CanvasRenderingContext2D_methods.lineTo$2(context, C.JSNumber_methods.$add(rx, width) - radius, C.JSNumber_methods.$add(ry, height));
        C.CanvasRenderingContext2D_methods.quadraticCurveTo$4(context, C.JSNumber_methods.$add(rx, width), C.JSNumber_methods.$add(ry, height), C.JSNumber_methods.$add(rx, width), C.JSNumber_methods.$add(ry, height) - radius);
        C.CanvasRenderingContext2D_methods.lineTo$2(context, C.JSNumber_methods.$add(rx, width), t1);
        C.CanvasRenderingContext2D_methods.quadraticCurveTo$4(context, C.JSNumber_methods.$add(rx, width), ry, C.JSNumber_methods.$add(rx, width) - radius, ry);
        C.CanvasRenderingContext2D_methods.lineTo$2(context, t3, ry);
        C.CanvasRenderingContext2D_methods.quadraticCurveTo$4(context, rx, ry, rx, t1);
        context.closePath();
      }
    }
  },
  ...
  CanvasTinter_tintWithMultiply: [function(texture, color, canvas) {
    ...
    t1 = texture.get$baseTexture().source;
    t2 = frame.x;
    t3 = frame.y;
    t4 = frame.width;
    t5 = frame.height;
    ...
    t5 = texture.get$baseTexture().source;
    t4 = frame.x;
    t3 = frame.y;
    t2 = frame.width;
    t1 = frame.height;
  ...
  WebGLGraphics_renderGraphics: function(graphics, renderSession) {
    var gl, projection, offset, shader, webGL, t1, t2, t3, t4, i, t5, t6, webGLData, colorList, tintColor, t7;
    gl = renderSession.gl;
    ...
    webGL = graphics._webGL.$index(0, gl);
    for (t1 = J.getInterceptor$x(gl), t2 = graphics.tint, t3 = (t2 >>> 16 & 255) / 255, t4 = (t2 >>> 8 & 255) / 255, t2 = (t2 & 255) / 255, i = 0; t5 = webGL.data, i < t5.length; ++i) {
      t5 = J.get$mode$x(t5[i]);
      t6 = webGL.data;
      if (t5 === 1) {
        if (i >= t6.length)
          return H.ioore(t6, i);
        webGLData = H.interceptedTypeCheck(t6[i], "$isWebGLGraphicsData");
        renderSession.stencilManager.pushStencil$3(graphics, webGLData, renderSession);
        t1.drawElements$4(gl, 6, 4, 5123, (webGLData.indices.length - 4) * 2);
        renderSession.stencilManager.popStencil$3(graphics, webGLData, renderSession);
        $.WebGLGraphics_last = webGLData.mode;
      } else {
        if (i >= t6.length)
          return H.ioore(t6, i);
        webGLData = H.interceptedTypeCheck(t6[i], "$isWebGLGraphicsData");
        colorList = H.assertSubtype(H.assertSubtype([t3, t4, t2], "$isList", [P.num], "$asList"), "$isList", [P.num], "$asList");
        ...
        renderSession.shaderManager.setShader$1(shader);
        shader = renderSession.shaderManager.primitiveShader;
        t1.uniformMatrix3fv$3(gl, shader.PIXI$PrimitiveShader$translationMatrix, false, graphics.worldTransform.toArray$1(true));
        t5 = shader.PIXI$PrimitiveShader$projectionVector;
        t6 = projection.x;
        t7 = projection.y;
        if (typeof t7 !== "number")
          return t7.$negate();
        C.RenderingContext_methods.uniform2f$3(gl, t5, t6, -t7);
        t7 = shader.PIXI$PrimitiveShader$offsetVector;
        t6 = offset.x;
        if (typeof t6 !== "number")
          return t6.$negate();
        t5 = offset.y;
        if (typeof t5 !== "number")
          return t5.$negate();
        C.RenderingContext_methods.uniform2f$3(gl, t7, -t6, -t5);
        C.RenderingContext_methods.uniform3fv$2(gl, shader.PIXI$PrimitiveShader$tintColor, tintColor);
        C.RenderingContext_methods.uniform1f$2(gl, shader.PIXI$PrimitiveShader$alpha, graphics.worldAlpha);
        C.RenderingContext_methods.bindBuffer$2(gl, 34962, webGLData.buffer);
        C.RenderingContext_methods.vertexAttribPointer$6(gl, shader.PIXI$PrimitiveShader$aVertexPosition, 2, 5126, false, 24, 0);
        C.RenderingContext_methods.vertexAttribPointer$6(gl, shader.PIXI$PrimitiveShader$colorAttribute, 4, 5126, false, 24, 8);
        C.RenderingContext_methods.bindBuffer$2(gl, 34963, webGLData.indexBuffer);
        C.RenderingContext_methods.drawElements$4(gl, 5, webGLData.indices.length, 5123, 0);
      }
    }
  },
  WebGLGraphics_updateGraphics: function(graphics, gl) {
    var t1, webGL, i, graphicsData, webGLData, data, rectData, x, y, width, height, color, alpha, r, g, b, verts, indices, vertPos, t2, tempPoints;
    t1 = graphics._webGL;
    webGL = t1.$index(0, gl);
    if (webGL == null) {
      ...
      webGL.set$data(0, []);
      webGL.gl = gl;
      t1.$indexSet(0, gl, webGL);
    }
    graphics.dirty = false;
    if (graphics.clearDirty) {
      graphics.clearDirty = false;
      for (i = 0; t1 = webGL.data, i < t1.length; ++i) {
        graphicsData = H.interceptedTypeCheck(t1[i], "$isWebGLGraphicsData");
        graphicsData.set$points(0, []);
        graphicsData.set$indices([]);
        graphicsData.lastIndex = 0;
        C.JSArray_methods.add$1($.get$WebGLGraphics_graphicsDataPool(), graphicsData);
      }
      webGL.set$data(0, []);
      webGL.lastIndex = 0;
    }
    for (i = webGL.lastIndex, webGLData = null; t1 = graphics.graphicsData, i < t1.length; ++i) {
      data = H.interceptedTypeCheck(t1[i], "$isGraphicsData");
      if (data.type === $.Graphics_POLY) {
        if (H.boolConversionCheck(data.fill)) {
          t1 = data.points.length;
          if (t1 > 6)
            if (t1 > 10) {
        ...
        t1 = data.type;
        if (t1 === $.Graphics_RECT) {
          rectData = data.points;
          t1 = rectData.length;
          if (0 >= t1)
            return H.ioore(rectData, 0);
          x = rectData[0];
          if (1 >= t1)
            return H.ioore(rectData, 1);
          y = rectData[1];
          if (2 >= t1)
            return H.ioore(rectData, 2);
          width = rectData[2];
          if (3 >= t1)
            return H.ioore(rectData, 3);
          height = rectData[3];
          if (H.boolConversionCheck(data.fill)) {
            t1 = data.fillColor;
            color = H.assertSubtype(H.assertSubtype([(t1 >>> 16 & 255) / 255, (t1 >>> 8 & 255) / 255, (t1 & 255) / 255], "$isList", [P.num], "$asList"), "$isList", [P.num], "$asList");
            alpha = data.fillAlpha;
            if (0 >= color.length)
              return H.ioore(color, 0);
            r = H.numTypeCheck(J.$mul$ns(color[0], alpha));
            if (1 >= color.length)
              return H.ioore(color, 1);
            g = H.numTypeCheck(J.$mul$ns(color[1], alpha));
            if (2 >= color.length)
              return H.ioore(color, 2);
            b = H.numTypeCheck(J.$mul$ns(color[2], alpha));
            verts = webGLData.points;
            indices = webGLData.indices;
            vertPos = verts.length / 6;
            C.JSArray_methods.addAll$1(verts, [x, y]);
            C.JSArray_methods.addAll$1(verts, [r, g, b, alpha]);
            t1 = J.getInterceptor$ns(x);
            C.JSArray_methods.addAll$1(verts, [t1.$add(x, width), y]);
            C.JSArray_methods.addAll$1(verts, [r, g, b, alpha]);
            t2 = J.getInterceptor$ns(y);
            C.JSArray_methods.addAll$1(verts, [x, t2.$add(y, height)]);
            C.JSArray_methods.addAll$1(verts, [r, g, b, alpha]);
            C.JSArray_methods.addAll$1(verts, [t1.$add(x, width), t2.$add(y, height)]);
            C.JSArray_methods.addAll$1(verts, [r, g, b, alpha]);
            t2 = vertPos + 3;
            C.JSArray_methods.addAll$1(indices, [vertPos, vertPos, vertPos + 1, vertPos + 2, t2, t2]);
          }
          if (data.lineWidth !== 0) {
            tempPoints = data.points;
            t1 = J.getInterceptor$ns(x);
            t2 = J.getInterceptor$ns(y);
            data.set$points(0, [x, y, t1.$add(x, width), y, t1.$add(x, width), t2.$add(y, height), x, t2.$add(y, height), x, y]);
            M.WebGLGraphics_buildLine(data, webGLData);
            data.set$points(0, tempPoints);
          }
        } else if (t1 === $.Graphics_CIRC || t1 === $.Graphics_ELIP)
          M.WebGLGraphics_buildCircle(data, webGLData);
        else if (t1 === $.Graphics_RREC)
          M.WebGLGraphics_buildRoundedRectangle(data, webGLData);
      }
      ++webGL.lastIndex;
    }
    for (i = 0; t1 = webGL.data, i < t1.length; ++i) {
      webGLData = H.interceptedTypeCheck(t1[i], "$isWebGLGraphicsData");
      if (webGLData.dirty)
        webGLData.upload$0();
    }
  },
  WebGLGraphics_switchMode: function(webGL, type) {
    var t1, t2, webGLData, t3;
    t1 = webGL.data;
    t2 = t1.length;
    if (t2 === 0) {
      t1 = $.get$WebGLGraphics_graphicsDataPool();
      webGLData = t1.length > 0 ? t1.pop() : null;
      if (webGLData == null)
        webGLData = M.WebGLGraphicsData$(webGL.gl);
      webGLData.mode = type;
      J.add$1$ax(webGL.data, webGLData);
    } else {
      t3 = t2 - 1;
      if (t3 < 0)
        return H.ioore(t1, t3);
      webGLData = H.interceptedTypeCheck(t1[t3], "$isWebGLGraphicsData");
      if (webGLData.mode !== type || type === 1) {
        t1 = $.get$WebGLGraphics_graphicsDataPool();
        webGLData = t1.length > 0 ? t1.pop() : M.WebGLGraphicsData$(webGL.gl);
        webGLData.mode = type;
        J.add$1$ax(webGL.data, webGLData);
      }
    }
  ...
  WebGLGraphics_quadraticBezierCurve: function(fromX, fromY, cpX, cpY, toX, toY) {
    var points, t1, i, j, xa, ya, xb, yb;
    points = H.assertSubtype([], "$isList", [P.num], "$asList");
    t1 = new M.WebGLGraphics_quadraticBezierCurve_getPt();
    for (i = 0; i <= 20; ++i) {
      j = i / 20;
      xa = H.numTypeCheck(t1.call$3(fromX, cpX, j));
      ya = H.numTypeCheck(t1.call$3(fromY, cpY, j));
      xb = H.numTypeCheck(t1.call$3(cpX, toX, j));
      yb = H.numTypeCheck(t1.call$3(cpY, toY, j));
      C.JSArray_methods.addAll$1(points, [H.numTypeCheck(t1.call$3(xa, xb, j)), H.numTypeCheck(t1.call$3(ya, yb, j))]);
    }
    return H.assertSubtype(points, "$isList", [P.num], "$asList");
  },
  WebGLGraphics_buildRoundedRectangle: function(graphicsData, webGLData) {
    var points, t1, x, y, width, height, radius, recPoints, t2, color, alpha, r, g, b, verts, indices, vecPos, triangles, i, tempPoints;
    points = H.assertSubtype(graphicsData.points, "$isList", [P.num], "$asList");
    t1 = points.length;
    if (0 >= t1)
      return H.ioore(points, 0);
    x = H.numTypeCheck(points[0]);
    if (1 >= t1)
      return H.ioore(points, 1);
    y = H.numTypeCheck(points[1]);
    if (2 >= t1)
      return H.ioore(points, 2);
    width = H.numTypeCheck(points[2]);
    if (3 >= t1)
      return H.ioore(points, 3);
    height = H.numTypeCheck(points[3]);
    if (4 >= t1)
      return H.ioore(points, 4);
    radius = H.numTypeCheck(points[4]);
    recPoints = [];
    if (typeof y !== "number")
      return y.$add();
    C.JSArray_methods.addAll$1(recPoints, [x, C.JSNumber_methods.$add(y, radius)]);
    t1 = C.JSNumber_methods.$sub(C.JSNumber_methods.$add(y, height), radius);
    t2 = C.JSNumber_methods.$add(y, height);
    if (typeof x !== "number")
      return x.$add();
    C.JSArray_methods.addAll$1(recPoints, M.WebGLGraphics_quadraticBezierCurve(x, t1, x, t2, C.JSNumber_methods.$add(x, radius), C.JSNumber_methods.$add(y, height)));
    C.JSArray_methods.addAll$1(recPoints, M.WebGLGraphics_quadraticBezierCurve(C.JSNumber_methods.$sub(C.JSNumber_methods.$add(x, width), radius), C.JSNumber_methods.$add(y, height), C.JSNumber_methods.$add(x, width), C.JSNumber_methods.$add(y, height), C.JSNumber_methods.$add(x, width), C.JSNumber_methods.$sub(C.JSNumber_methods.$add(y, height), radius)));
    C.JSArray_methods.addAll$1(recPoints, M.WebGLGraphics_quadraticBezierCurve(C.JSNumber_methods.$add(x, width), C.JSNumber_methods.$add(y, radius), C.JSNumber_methods.$add(x, width), y, C.JSNumber_methods.$sub(C.JSNumber_methods.$add(x, width), radius), y));
    C.JSArray_methods.addAll$1(recPoints, M.WebGLGraphics_quadraticBezierCurve(C.JSNumber_methods.$add(x, radius), y, x, y, x, C.JSNumber_methods.$add(y, radius)));
    if (H.boolConversionCheck(graphicsData.fill)) {
      t1 = graphicsData.fillColor;
      color = H.assertSubtype(H.assertSubtype([(t1 >>> 16 & 255) / 255, (t1 >>> 8 & 255) / 255, (t1 & 255) / 255], "$isList", [P.num], "$asList"), "$isList", [P.num], "$asList");
      ...
      if (2 >= color.length)
        return H.ioore(color, 2);
      b = H.numTypeCheck(J.$mul$ns(color[2], alpha));
      verts = H.assertSubtype(webGLData.points, "$isList", [P.num], "$asList");
      indices = H.assertSubtype(webGLData.indices, "$isList", [P.num], "$asList");
      vecPos = verts.length / 6;
      triangles = H.assertSubtype(M.PolyK_Triangulate(recPoints), "$isList", [P.num], "$asList");
      for (i = 0; i < triangles.length; i += 3) {
        C.JSArray_methods.add$1(indices, J.$add$ns(triangles[i], vecPos));
        if (i >= triangles.length)
          return H.ioore(triangles, i);
        C.JSArray_methods.add$1(indices, J.$add$ns(triangles[i], vecPos));
        t1 = i + 1;
        if (t1 >= triangles.length)
          return H.ioore(triangles, t1);
        C.JSArray_methods.add$1(indices, J.$add$ns(triangles[t1], vecPos));
        t1 = i + 2;
        if (t1 >= triangles.length)
          return H.ioore(triangles, t1);
        C.JSArray_methods.add$1(indices, J.$add$ns(triangles[t1], vecPos));
      ...
      for (i = 0; t1 = recPoints.length, i < t1; ++i) {
        t2 = recPoints[i];
        ++i;
        if (i >= t1)
          return H.ioore(recPoints, i);
        C.JSArray_methods.addAll$1(verts, [t2, recPoints[i], r, g, b, alpha]);
      }
    }
    if (graphicsData.lineWidth !== 0) {
      tempPoints = H.assertSubtype(graphicsData.points, "$isList", [P.num], "$asList");
      graphicsData.set$points(0, recPoints);
      M.WebGLGraphics_buildLine(graphicsData, webGLData);
      graphicsData.set$points(0, tempPoints);
    }
  },
  WebGLGraphics_buildCircle: function(graphicsData, webGLData) {
    var rectData, t1, x, y, width, height, color, alpha, r, g, b, verts, indices, vecPos, t2, i, t3, t4, vecPos0, vecPos1, tempPoints, t5;
    ...
    if (H.boolConversionCheck(graphicsData.fill)) {
      ...
      indices = webGLData.indices;
      vecPos = verts.length / 6;
      C.JSArray_methods.add$1(indices, vecPos);
      for (t1 = J.getInterceptor$ns(y), t2 = J.getInterceptor$ns(x), i = 0; i < 41; ++i, vecPos = vecPos1) {
        C.JSArray_methods.addAll$1(verts, [x, y, r, g, b, alpha]);
        t3 = 0.15707963267948966 * i;
        t4 = t2.$add(x, C.JSDouble_methods.$mul(Math.sin(t3), width));
        C.JSArray_methods.addAll$1(verts, [t4, t1.$add(y, C.JSDouble_methods.$mul(Math.cos(t3), height)), r, g, b, alpha]);
        vecPos0 = vecPos + 1;
        vecPos1 = vecPos0 + 1;
        C.JSArray_methods.addAll$1(indices, [vecPos, vecPos0]);
      }
      C.JSArray_methods.add$1(indices, vecPos - 1);
    }
    if (graphicsData.lineWidth !== 0) {
      tempPoints = graphicsData.points;
      graphicsData.set$points(0, []);
      for (t1 = J.getInterceptor$ns(y), t2 = J.getInterceptor$ns(x), i = 0; i < 41; ++i) {
        t3 = graphicsData.points;
        t4 = 0.15707963267948966 * i;
        t5 = t2.$add(x, C.JSDouble_methods.$mul(Math.sin(t4), width));
        C.JSArray_methods.addAll$1(t3, [t5, t1.$add(y, C.JSDouble_methods.$mul(Math.cos(t4), height))]);
      }
      M.WebGLGraphics_buildLine(graphicsData, webGLData);
      graphicsData.set$points(0, tempPoints);
    }
  },
  WebGLGraphics_buildLine: function(graphicsData, webGLData) {
    var points, t1, i, t2, t3, firstPoint, t4, t5, lastPoint, midPointX, midPointY, verts, indices, indexCount, $length, indexStart, width, color, alpha, r, g, b, p1x, p1y, p2x, p2y, perpx, dist, perpy, px, py, perp3x, perp3y, pdist, p3x, p3y, perp2x, perp2y, a1, b1, c1, a2, b2, c2, denom, indexStart0;
    points = graphicsData.points;
    t1 = points.length;
    if (t1 === 0)
      return;
    if (C.JSInt_methods.$mod(graphicsData.lineWidth, 2) !== 0)
      for (i = 0; i < t1; ++i, t1 = t2) {
        if (i >= t1)
          return H.ioore(points, i);
        t1 = J.$add$ns(points[i], 0.5);
        t2 = points.length;
        if (i >= t2)
          return H.ioore(points, i);
        points[i] = t1;
    ...
    H.numTypeCheck(t2);
    H.numTypeCheck(t3);
    firstPoint = new M.Point(null, null);
    firstPoint.x = t2;
    firstPoint.y = t3;
    t4 = t1 - 2;
    if (t4 < 0 || t4 >= t1)
      return H.ioore(points, t4);
    t4 = points[t4];
    t5 = t1 - 1;
    if (t5 >= t1)
    ...
    H.numTypeCheck(t4);
    H.numTypeCheck(t5);
    lastPoint = new M.Point(null, null);
    lastPoint.x = t4;
    lastPoint.y = t5;
    if ((t2 == null ? t4 == null : t2 === t4) && (t3 == null ? t5 == null : t3 === t5)) {
      ...
      if (typeof t2 !== "number")
        return t2.$sub();
      t2 = C.JSNumber_methods.$sub(t2, t4);
      if (typeof t4 !== "number")
        return t4.$add();
      midPointX = t4 + t2 * 0.5;
      if (typeof t3 !== "number")
        return t3.$sub();
      t3 = C.JSNumber_methods.$sub(t3, t5);
      if (typeof t5 !== "number")
        return t5.$add();
      midPointY = t5 + t3 * 0.5;
      t3 = [midPointX, midPointY];
      H.listSuperNativeTypeCheck(t3, "$isIterable");
      H.IterableMixinWorkaround_insertAllList(points, 0, t3);
      C.JSArray_methods.addAll$1(points, [midPointX, midPointY]);
    }
    verts = webGLData.points;
    indices = webGLData.indices;
    indexCount = points.length;
    $length = C.JSInt_methods._tdivFast$1(indexCount, 2);
    indexStart = C.JSInt_methods._tdivFast$1(verts.length, 6);
    width = graphicsData.lineWidth / 2;
    t1 = graphicsData.lineColor;
    color = H.assertSubtype(H.assertSubtype([(t1 >>> 16 & 255) / 255, (t1 >>> 8 & 255) / 255, (t1 & 255) / 255], "$isList", [P.num], "$asList"), "$isList", [P.num], "$asList");
    ...
    if (0 >= t1)
      return H.ioore(points, 0);
    p1x = H.numTypeCheck(points[0]);
    if (1 >= t1)
      return H.ioore(points, 1);
    p1y = H.numTypeCheck(points[1]);
    if (2 >= t1)
      return H.ioore(points, 2);
    p2x = H.numTypeCheck(points[2]);
    if (3 >= t1)
      return H.ioore(points, 3);
    p2y = H.numTypeCheck(points[3]);
    if (typeof p1y !== "number")
      return p1y.$sub();
    perpx = -C.JSNumber_methods.$sub(p1y, p2y);
    if (typeof p1x !== "number")
      return p1x.$sub();
    t1 = C.JSNumber_methods.$sub(p1x, p2x);
    dist = Math.sqrt(perpx * perpx + t1 * t1);
    perpx = perpx / dist * width;
    perpy = t1 / dist * width;
    C.JSArray_methods.addAll$1(verts, [p1x - perpx, p1y - perpy, r, g, b, alpha]);
    C.JSArray_methods.addAll$1(verts, [p1x + perpx, p1y + perpy, r, g, b, alpha]);
    for (t1 = $length - 1, i = 1, px = null, py = null, perp3x = null, perp3y = null, pdist = null; t2 = points.length, i < t1;) {
      t3 = (i - 1) * 2;
      if (t3 < 0 || t3 >= t2)
        return H.ioore(points, t3);
      p1x = H.numTypeCheck(points[t3]);
      ++t3;
      if (t3 >= t2)
        return H.ioore(points, t3);
      p1y = H.numTypeCheck(points[t3]);
      t3 = i * 2;
      if (t3 >= t2)
        return H.ioore(points, t3);
      p2x = H.numTypeCheck(points[t3]);
      ++t3;
      if (t3 >= t2)
        return H.ioore(points, t3);
      p2y = H.numTypeCheck(points[t3]);
      ++i;
      t3 = i * 2;
      if (t3 >= t2)
        return H.ioore(points, t3);
      p3x = H.numTypeCheck(points[t3]);
      ++t3;
      if (t3 >= t2)
        return H.ioore(points, t3);
      p3y = H.numTypeCheck(points[t3]);
      if (typeof p1y !== "number")
        return p1y.$sub();
      perpx = -C.JSNumber_methods.$sub(p1y, p2y);
      if (typeof p1x !== "number")
        return p1x.$sub();
      t3 = C.JSNumber_methods.$sub(p1x, p2x);
      dist = Math.sqrt(perpx * perpx + t3 * t3);
      perpx = perpx / dist * width;
      perpy = t3 / dist * width;
      if (typeof p2y !== "number")
        return p2y.$sub();
      perp2x = -C.JSNumber_methods.$sub(p2y, p3y);
      if (typeof p2x !== "number")
        return p2x.$sub();
      t2 = C.JSNumber_methods.$sub(p2x, p3x);
      dist = Math.sqrt(perp2x * perp2x + t2 * t2);
      perp2x = perp2x / dist * width;
      perp2y = t2 / dist * width;
      t2 = -perpy;
      t3 = t2 + p1y;
      t2 += p2y;
      a1 = t3 - t2;
      ...
      t3 = -perp2y;
      t5 = t3 + p2y;
      a2 = C.JSNumber_methods.$add(t3, p3y) - t5;
      t2 = -perp2x;
      t4 = t2 + p2x;
      b2 = t4 - C.JSNumber_methods.$add(t2, p3x);
      c2 = C.JSNumber_methods.$add(t2, p3x) * t5 - t4 * C.JSNumber_methods.$add(t3, p3y);
      denom = a1 * b2 - a2 * b1;
      if ((denom < 0 ? -denom : denom) < 0.1) {
        C.JSArray_methods.addAll$1(verts, [p2x - perpx, p2y - perpy, r, g, b, alpha]);
        C.JSArray_methods.addAll$1(verts, [p2x + perpx, p2y + perpy, r, g, b, alpha]);
        continue;
      }
      ...
      if (pdist > 19600) {
        ...
        perp3y = perp3y / dist * width;
        t2 = p2x - perp3x;
        t3 = p2y - perp3y;
        C.JSArray_methods.addAll$1(verts, [t2, t3]);
        C.JSArray_methods.addAll$1(verts, [r, g, b, alpha]);
        C.JSArray_methods.addAll$1(verts, [p2x + perp3x, p2y + perp3y]);
        C.JSArray_methods.addAll$1(verts, [r, g, b, alpha]);
        C.JSArray_methods.addAll$1(verts, [t2, t3]);
        C.JSArray_methods.addAll$1(verts, [r, g, b, alpha]);
        ++indexCount;
      } else {
        C.JSArray_methods.addAll$1(verts, [px, py]);
        C.JSArray_methods.addAll$1(verts, [r, g, b, alpha]);
        C.JSArray_methods.addAll$1(verts, [p2x - t2, p2y - t3]);
        C.JSArray_methods.addAll$1(verts, [r, g, b, alpha]);
      }
    }
    t3 = ($length - 2) * 2;
    ...
    p2x = H.numTypeCheck(points[t1]);
    ++t1;
    if (t1 >= t2)
      return H.ioore(points, t1);
    p2y = H.numTypeCheck(points[t1]);
    if (typeof p1y !== "number")
      return p1y.$sub();
    perpx = -C.JSNumber_methods.$sub(p1y, p2y);
    if (typeof p1x !== "number")
    ...
    if (typeof p2y !== "number")
      return p2y.$sub();
    C.JSArray_methods.addAll$1(verts, [p2x - perpx, p2y - perpy]);
    C.JSArray_methods.addAll$1(verts, [r, g, b, alpha]);
    C.JSArray_methods.addAll$1(verts, [p2x + perpx, p2y + perpy]);
    C.JSArray_methods.addAll$1(verts, [r, g, b, alpha]);
    C.JSArray_methods.add$1(indices, indexStart);
    for (i = 0; i < indexCount; ++i, indexStart = indexStart0) {
      indexStart0 = indexStart + 1;
      C.JSArray_methods.add$1(indices, indexStart);
    }
    C.JSArray_methods.add$1(indices, indexStart - 1);
  },
  WebGLGraphics_buildComplexPoly: function(graphicsData, webGLData) {
    var points, indices, t1, minX, maxX, minY, maxY, i, x, t2, y, $length;
    points = H.assertSubtype(P.List_List$from(graphicsData.points, true, null), "$isList", [P.num], "$asList");
    if (points.length < 6)
      return;
    indices = H.assertSubtype(webGLData.indices, "$isList", [P.num], "$asList");
    webGLData.set$points(0, points);
    webGLData.alpha = graphicsData.fillAlpha;
    t1 = graphicsData.fillColor;
    webGLData.set$color(0, H.assertSubtype([(t1 >>> 16 & 255) / 255, (t1 >>> 8 & 255) / 255, (t1 & 255) / 255], "$isList", [P.num], "$asList"));
    for (t1 = points.length, minX = 1 / 0, maxX = -1 / 0, minY = 1 / 0, maxY = -1 / 0, i = 0; i < t1; i += 2) {
      x = H.numTypeCheck(points[i]);
      t2 = i + 1;
      if (t2 >= t1)
        return H.ioore(points, t2);
      y = H.numTypeCheck(points[t2]);
      if (typeof x !== "number")
        return x.$lt();
      if (x < minX)
        minX = x;
  ...
  WebGLGraphics_buildPoly: function(graphicsData, webGLData) {
    var points, t1, verts, indices, $length, color, alpha, r, g, b, triangles, vertPos, i, t2, t3;
    points = graphicsData.points;
    t1 = points.length;
    if (t1 < 6)
      return;
    ...
    vertPos = verts.length / 6;
    for (i = 0; i < triangles.length; i += 3) {
      C.JSArray_methods.add$1(indices, J.$add$ns(triangles[i], vertPos));
      if (i >= triangles.length)
        return H.ioore(triangles, i);
      C.JSArray_methods.add$1(indices, J.$add$ns(triangles[i], vertPos));
      t1 = i + 1;
      if (t1 >= triangles.length)
        return H.ioore(triangles, t1);
      C.JSArray_methods.add$1(indices, J.$add$ns(triangles[t1], vertPos));
      t1 = i + 2;
      if (t1 >= triangles.length)
        return H.ioore(triangles, t1);
      C.JSArray_methods.add$1(indices, J.$add$ns(triangles[t1], vertPos));
    ...
    for (i = 0; i < $length; ++i) {
      ...
      if (t1 >= t2)
        return H.ioore(points, t1);
      C.JSArray_methods.addAll$1(verts, [t3, points[t1], r, g, b, alpha]);
    }
  },
  ...
  createWebGLTexture: function(texture, gl) {
    if (texture._hasLoaded) {
      ...
      C.RenderingContext_methods.texParameteri$3(gl, 3553, 10240, texture.scaleMode === C.scaleModes_1 ? 9729 : 9728);
      C.RenderingContext_methods.texParameteri$3(gl, 3553, 10241, texture.scaleMode === C.scaleModes_1 ? 9729 : 9728);
  ...
  PolyK_Triangulate: function(p) {
    var n, tgs, avl, i, al, sign, t1, t2, i0, i1, i10, t3, i2, ax, ay, bx, by, cx, cy, t4, t5, j, earFound, vi, t6, t7, t8, v0x, v0y, v1x, v1y, v2x, v2y, dot00, dot01, dot02, dot11, dot12, invDenom, u, v;
    n = p.length >>> 1;
    if (n < 3)
      return H.assertSubtype([], "$isList", [P.num], "$asList");
    tgs = H.assertSubtype([], "$isList", [P.num], "$asList");
    avl = H.assertSubtype([], "$isList", [P.num], "$asList");
    for (i = 0; i < n; ++i)
      C.JSArray_methods.add$1(avl, i);
    for (al = n, sign = true; t1 = avl.length, al > 3;) {
      ...
      H.numTypeCheck(cx);
      H.numTypeCheck(cy);
      t1 = J.getInterceptor$n(cx);
      t3 = J.getInterceptor$n(bx);
      t4 = J.getInterceptor$n(cy);
      if (J.$sub$n(ay, by) * t1.$sub(cx, bx) + t3.$sub(bx, ax) * t4.$sub(cy, by) >= 0 === sign)
        for (t5 = J.getInterceptor$n(by), j = 0; earFound = true, j < al; ++j) {
          if (j >= avl.length)
          ...
          invDenom = C.JSInt_methods.$div(1, J.$sub$n(t6.$mul(dot00, dot11), t8.$mul(dot01, dot01)));
      ...
      if (earFound) {
        ...
        if (sign) {
          ...
          window;
          H.voidTypeCheck(typeof console != "undefined" ? console.log("PIXI Warning: shape too complex to fill") : null);
          return H.assertSubtype([], "$isList", [P.num], "$asList");
        }
        al = n;
        sign = false;
    ...
    return H.assertSubtype(tgs, "$isList", [P.num], "$asList");
  },
  ...
  DisplayObject: {
    "^": "Object;rotation<,visible<,hitArea<,parent,interactiveChildren,mousemove<,worldTransform<",
    set$rotation: function(rotation) {
      this.rotation = H.numTypeCheck(rotation);
    },
    ...
    set$worldTransform: function(worldTransform) {
      this.worldTransform = H.interceptedTypeCheck(worldTransform, "$isMatrix");
    },
    ...
    set$mask: function(_, value) {
      var t1 = this._mask;
      if (t1 != null)
        t1.PIXI$Graphics$isMask = false;
      this._mask = value;
      if (value != null)
        value.PIXI$Graphics$isMask = true;
    },
    ...
    updateTransform$0: function() {
      ...
      worldTransform.tx = C.JSNumber_methods.$add(b00 * a02 + b01 * a12, parentTransform.tx);
      worldTransform.c = H.doubleTypeCheck(b10 * a00 + b11 * a10);
      worldTransform.d = H.doubleTypeCheck(b10 * a01 + b11 * a11);
      worldTransform.ty = C.JSNumber_methods.$add(b10 * a02 + b11 * a12, parentTransform.ty);
  ...
  DisplayObjectContainer: {
    ...
    getBounds$1: function(matrix) {
      ...
      for (j = t1.length, minX = 1 / 0, minY = 1 / 0, maxX = -1 / 0, maxY = -1 / 0, childBounds = null, childMaxX = null, childMaxY = null, childVisible = false, i = 0; i < j; ++i) {
        if (i >= t1.length)
          return H.ioore(t1, i);
        if (!H.interceptedTypeCheck(t1[i], "$isDisplayInterface").get$visible())
          continue;
        if (i >= t1.length)
          return H.ioore(t1, i);
    ...
    _renderWebGL$1: function(renderSession) {
      ...
      if (!t1 || false) {
        if (!t1) {
          ...
          renderSession.maskManager.pushMask$2(this._mask, renderSession);
        ...
        t1 = this._mask;
        if (t1 != null)
          renderSession.maskManager.popMask$2(t1, renderSession);
        renderSession.spriteBatch.dirty = true;
      } else
        for (t1 = this.children, j = t1.length, i = 0; i < j; ++i) {
          if (i >= t1.length)
    ...
    _renderCanvas$1: function(renderSession) {
      ...
      t1 = this._mask;
      if (t1 != null)
        renderSession.maskManager.pushMask$2(t1, renderSession.context);
      for (t1 = this.children, j = t1.length, i = 0; i < j; ++i) {
        if (i >= t1.length)
          return H.ioore(t1, i);
      ...
      if (this._mask != null)
        renderSession.maskManager.popMask$1(renderSession.context);
    },
  ...
  Sprite: {
    ...
    _setupTexture$0: function() {
      if (this.texture.get$baseTexture()._hasLoaded)
        ...
        this.texture.addEventListener$2(0, "update", this.get$onTextureUpdate());
    },
    ...
    }, "call$1", "get$onTextureUpdate", 2, 0, 59, 3],
    getBounds$1: function(matrix) {
      var width, height, t1, t2, w0, w1, h0, h1, worldTransform, a, b, c, d, tx, ty, x1, t3, t4, y1, t5, x2, y2, x3, y3, x4, y4, minX, minY, maxX, maxY, bounds;
      ...
      if (typeof t1 !== "number")
        return t1.$negate();
      h1 = height * -t1;
      worldTransform = matrix == null ? this.worldTransform : matrix;
      a = worldTransform.a;
      b = worldTransform.c;
      c = worldTransform.b;
      d = worldTransform.d;
      ...
      t1 = a * w1;
      t2 = c * h1;
      x1 = C.JSNumber_methods.$add(t1 + t2, tx);
      t3 = d * h1;
      t4 = b * w1;
      y1 = C.JSNumber_methods.$add(t3 + t4, ty);
      t5 = a * w0;
      x2 = C.JSNumber_methods.$add(t5 + t2, tx);
      t2 = b * w0;
      y2 = C.JSNumber_methods.$add(t3 + t2, ty);
      t3 = c * h0;
      x3 = C.JSNumber_methods.$add(t5 + t3, tx);
      t5 = d * h0;
      y3 = C.JSNumber_methods.$add(t5 + t2, ty);
      x4 = C.JSNumber_methods.$add(t1 + t3, tx);
      y4 = C.JSNumber_methods.$add(t5 + t4, ty);
      minX = x1 < 1 / 0 ? x1 : 1 / 0;
      if (x2 < minX)
        minX = x2;
      if (x3 < minX)
    ...
    _renderCanvas$1: function(renderSession) {
      ...
      if (t1 != null)
        renderSession.maskManager.pushMask$2(t1, renderSession.context);
      if (H.boolConversionCheck(this.texture.get$valid())) {
        ...
        if (t7 == null)
          t7 = 0;
        t2 = t2.ty;
        J.setTransform$6$x(t1, t3, t4, t5, t6, t7, t2 == null ? 0 : t2);
        t1 = renderSession.scaleMode;
        t2 = this.texture.get$baseTexture().scaleMode;
        if (t1 == null ? t2 != null : t1 !== t2) {
          t1 = this.texture.get$baseTexture().scaleMode;
          renderSession.scaleMode = t1;
          renderSession.context.imageSmoothingEnabled = t1 === C.scaleModes_1;
        }
        t1 = this.texture;
        t1.trim;
        t2 = this.anchor.x;
        t1 = t1.get$frame().width;
        if (typeof t1 !== "number")
          return t1.$negate();
        if (typeof t2 !== "number")
          return t2.$mul();
        ...
        if (t1 !== 16777215) {
          ...
          t1 = renderSession.context;
          t2 = this.texture.get$baseTexture().source;
          t3 = this.texture.crop;
          t4 = t3.x;
          t5 = t3.y;
          t6 = t3.width;
          t3 = t3.height;
          J.drawImageScaledFromSource$9$x(t1, t2, t4, t5, t6, t3, dx, dy, t6, t3);
        }
      }
      for (t1 = this.children, j = t1.length, i = 0; i < j; ++i) {
        if (i >= t1.length)
  ...
  Stage: {
    ...
    set$worldTransform: function(worldTransform) {
      this.PIXI$Stage$worldTransform = H.interceptedTypeCheck(worldTransform, "$isMatrix");
    },
    updateTransform$0: function() {
      var t1, j, i;
      this.worldAlpha = 1;
  ...
  InteractionManager: {
    ...
    }, "call$1", "get$onMouseMove", 2, 0, 60, 4],
    ...
    }, "call$1", "get$onMouseDown", 2, 0, 61, 4],
    onMouseOut$1: [function(_, $event) {
      ...
      t1.x = -10000;
      t1.y = -10000;
    }, "call$1", "get$onMouseOut", 2, 0, 61, 4],
    ...
    hitTest$2: function(item, interactionData) {
      ...
      t1 = -a10;
      id = 1 / (a00 * a11 + a01 * t1);
      t2 = C.JSNumber_methods.$mul(a11 * id, global.x);
      t3 = C.JSNumber_methods.$mul(-a01 * id, global.y);
      if (typeof a12 !== "number")
        return a12.$mul();
      if (typeof a02 !== "number")
        return a02.$mul();
      x = t2 + t3 + (a12 * a01 - a02 * a11) * id;
  ...
  GraphicsData: {
    "^": "Object;points>,fillAlpha<,fillColor<,fill>,lineWidth>,lineAlpha<,lineColor<,type>",
    set$points: function(_, points) {
      this.points = H.assertSubtype(points, "$isList", [P.num], "$asList");
    },
    $isGraphicsData: true
  },
  Graphics: {
    "^": "DisplayObjectContainer;fillAlpha<,fillColor<,filling,lineWidth>,lineAlpha<,lineColor<,graphicsData,tint,blendMode,currentPath,_webGL,PIXI$Graphics$isMask,bounds,boundsPadding,clearDirty,children,_width,_height,position,scale,pivot,rotation,alpha,visible,hitArea,renderable,parent,__iParent,interactiveChildren,__hit,__isOver,__mouseIsDown,__isDown,dirty,click,mousemove,mousedown,mouseout,mouseover,mouseup,mouseupoutside,touchmove,touchstart,touchend,tap,touchendoutside,__touchData,stage,buttonMode,worldAlpha,_interactive,defaultCursor,worldTransform,color,dynamic,_sr,_cr,filterArea,_bounds,_currentBounds,_mask,isMask,_cacheAsBitmap,_cachedSprite,_cacheIsDirty,_filterBlock,_filters,rotationCache",
    set$graphicsData: function(graphicsData) {
      this.graphicsData = H.assertSubtype(graphicsData, "$isList", [M.GraphicsData], "$asList");
    },
    moveTo$2: function(_, x, y) {
      var t1;
      if (this.currentPath.points.length === 0) {
        t1 = this.graphicsData;
        if (t1.length > 0)
          t1.pop();
      }
      t1 = $.Graphics_POLY;
      t1 = new M.GraphicsData(H.assertSubtype([], "$isList", [P.num], "$asList"), 1, 0, null, 1, 1, 0, t1);
      ...
      t1.set$points(0, []);
      t1.type = $.Graphics_POLY;
      this.currentPath = t1;
      C.JSArray_methods.addAll$1(t1.points, [x, y]);
      C.JSArray_methods.add$1(this.graphicsData, this.currentPath);
      return this;
    },
    lineTo$2: function(_, x, y) {
      C.JSArray_methods.addAll$1(this.currentPath.points, [x, y]);
      this.dirty = true;
      return this;
    },
    _renderWebGL$1: function(renderSession) {
      var bounds, t1, canvasBuffer, texture, t2, t3, t4, t5, t6, t7, blendModeWebGL, i;
      if (!this.visible || this.alpha === 0 || this.PIXI$Graphics$isMask)
        return;
      if (this._cacheAsBitmap) {
        if (this.dirty) {
          ...
          if (t1 == null) {
            ...
            t7 = new M.Sprite(t1, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t2, t3, t4, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t5, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t6), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t7, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
            t7.texture = texture;
            t7._setupTexture$0();
            this._cachedSprite = t7;
            t7.buffer = canvasBuffer;
            t7.worldTransform = this.worldTransform;
          } else
            t1.buffer.resize$2(0, bounds.width, bounds.height);
          this._cachedSprite.anchor.x = -C.JSNumber_methods.$div(bounds.x, bounds.width);
          this._cachedSprite.anchor.y = -C.JSNumber_methods.$div(bounds.y, bounds.height);
          J.translate$2$x(this._cachedSprite.buffer.context, -bounds.x, -bounds.y);
          M.CanvasGraphics_renderGraphics(this, this._cachedSprite.buffer.context);
          t1 = this._cachedSprite;
          t1.alpha = this.alpha;
          M.updateWebGLTexture(t1.texture.get$baseTexture(), renderSession.gl);
          this.dirty = false;
        }
        t1 = this._cachedSprite;
        t1.alpha = this.alpha;
        ...
        renderSession.spriteBatch.flush$0(0);
        renderSession.blendModeManager.setBlendMode$1(this.blendMode);
        t1 = this._mask;
        if (t1 != null)
          renderSession.maskManager.pushMask$2(t1, renderSession);
        t1 = this.blendMode;
        t2 = renderSession.blendModeManager;
        if (t1 !== t2.currentBlendMode) {
          t2.currentBlendMode = t1;
          blendModeWebGL = $.blendModesWebGL.$index(0, t1);
          t1 = J.getInterceptor$asx(blendModeWebGL);
          J.blendFunc$2$x(renderSession.spriteBatch.gl, t1.$index(blendModeWebGL, 0), t1.$index(blendModeWebGL, 1));
        }
        ...
        if (t1 != null)
          renderSession.maskManager.popMask$2(t1, renderSession);
        renderSession.drawCount = renderSession.drawCount + 1;
        renderSession.spriteBatch.dirty = true;
      }
    },
    _renderCanvas$1: function(renderSession) {
      var context, transform, t1, j, i;
      if (!this.visible || this.alpha === 0 || this.PIXI$Graphics$isMask)
        return;
      ...
      if (t1 != null)
        renderSession.maskManager.pushMask$2(t1, renderSession.context);
      J.setTransform$6$x(context, transform.a, transform.c, transform.b, transform.d, transform.tx, transform.ty);
    ...
    getBounds$1: function(matrix) {
      var t1, w0, t2, w1, h0, h1, a, b, c, d, tx, ty, x1, t3, t4, y1, t5, x2, y2, x3, y3, x4, y4, minX, minY, maxX, maxY, bounds;
      if (matrix == null)
    ...
    updateBounds$0: function() {
      var minX, maxX, minY, maxY, x, y, w, h, i, t1, data, type, lineWidth, points, t2, j, padding, t3, t4;
      for (minX = 1 / 0, maxX = -1 / 0, minY = 1 / 0, maxY = -1 / 0, x = null, y = null, w = null, h = null, i = 0; t1 = this.graphicsData, i < t1.length; ++i) {
        data = t1[i];
        t1 = J.getInterceptor$x(data);
        type = t1.get$type(data);
        lineWidth = t1.get$lineWidth(data);
        points = t1.get$points(data);
        if (type === $.Graphics_RECT) {
          t1 = J.getInterceptor$asx(points);
          t2 = J.getInterceptor$n(lineWidth);
          x = J.$sub$n(t1.$index(points, 0), t2.$div(lineWidth, 2));
          y = J.$sub$n(t1.$index(points, 1), t2.$div(lineWidth, 2));
          w = J.$add$ns(t1.$index(points, 2), lineWidth);
          h = J.$add$ns(t1.$index(points, 3), lineWidth);
          t1 = J.getInterceptor$n(x);
          if (t1.$lt(x, minX))
            minX = x;
          if (J.$gt$n(t1.$add(x, w), maxX))
            maxX = t1.$add(x, w);
          t1 = J.getInterceptor$n(y);
          if (t1.$lt(y, minY))
            minY = x;
          if (J.$gt$n(t1.$add(y, h), maxY))
            maxY = t1.$add(y, h);
        } else if (type === $.Graphics_CIRC || type === $.Graphics_ELIP) {
          t1 = J.getInterceptor$asx(points);
          x = t1.$index(points, 0);
          y = t1.$index(points, 1);
          t2 = J.getInterceptor$n(lineWidth);
          w = J.$add$ns(t1.$index(points, 2), t2.$div(lineWidth, 2));
          h = J.$add$ns(t1.$index(points, 3), t2.$div(lineWidth, 2));
          t1 = J.getInterceptor$n(x);
          if (J.$lt$n(t1.$sub(x, w), minX))
            minX = t1.$sub(x, w);
          if (J.$gt$n(t1.$add(x, w), maxX))
            maxX = t1.$add(x, w);
          t1 = J.getInterceptor$n(y);
          if (J.$lt$n(t1.$sub(y, h), minY))
            minY = t1.$sub(y, h);
          if (J.$gt$n(t1.$add(y, h), maxY))
            maxY = t1.$add(y, h);
        } else
          for (t1 = J.getInterceptor$asx(points), j = 0; j < t1.get$length(points); j += 2) {
            x = t1.$index(points, j);
            y = t1.$index(points, j + 1);
            t2 = J.getInterceptor$n(x);
            if (J.$lt$n(t2.$sub(x, lineWidth), minX))
              minX = t2.$sub(x, lineWidth);
            if (J.$gt$n(t2.$add(x, lineWidth), maxX))
              maxX = t2.$add(x, lineWidth);
            t2 = J.getInterceptor$n(y);
            if (J.$lt$n(t2.$sub(y, lineWidth), minY))
              minY = t2.$sub(y, lineWidth);
            if (J.$gt$n(t2.$add(y, lineWidth), maxY))
              maxY = t2.$add(y, lineWidth);
          }
      }
      padding = this.boundsPadding;
      t1 = J.$sub$n(minX, padding);
      t2 = J.$sub$n(minY, padding);
      t3 = padding * 2;
      t4 = J.$add$ns(J.$sub$n(maxX, minX), t3);
      t3 = J.$add$ns(J.$sub$n(maxY, minY), t3);
      this.bounds = new M.Rectangle(H.numTypeCheck(t1), H.numTypeCheck(t2), H.numTypeCheck(t4), H.numTypeCheck(t3));
    },
    Graphics$0: function() {
    ...
    $isGraphics: true,
    static: {"^": "Graphics_POLY,Graphics_RECT,Graphics_CIRC,Graphics_ELIP,Graphics_RREC"}
  },
  CanvasRenderer: {
    ...
    renderDisplayObject$3: function(displayObject, context, buffer) {
      ...
      t1.context = context == null ? this.context : context;
      displayObject._renderCanvas$1(t1);
    },
  ...
  CanvasBuffer: {
    ...
    resize$2: function(_, width, height) {
      var t1 = this.canvas;
      t1.width = H.intTypeCheck(width);
      this.width = width;
      t1.height = H.intTypeCheck(height);
      this.height = height;
    },
  ...
  CanvasMaskManager: {
    ...
    pushMask$2: function(maskData, context) {
      ...
      t1.setTransform$6(context, transform.a, transform.c, transform.b, transform.d, transform.tx, transform.ty);
  ...
  WebGLGraphicsData: {
    "^": "Object;gl,color,points>,indices<,lastIndex,buffer,indexBuffer,mode>,alpha,dirty,glPoints,glIndicies,data",
    set$color: function(_, color) {
      this.color = H.assertSubtype(color, "$isList", [P.num], "$asList");
    },
    set$points: function(_, points) {
      this.points = H.assertSubtype(points, "$isList", [P.num], "$asList");
    },
    set$indices: function(indices) {
      this.indices = H.assertSubtype(indices, "$isList", [P.num], "$asList");
    },
    set$data: function(_, data) {
      this.data = H.assertSubtype(data, "$isList", [M.WebGLGraphicsData], "$asList");
    },
    upload$0: function() {
      var gl, t1, t2, t3, t4, t5;
      gl = this.gl;
      t1 = this.points;
      t2 = new M.WebGLGraphicsData_upload_closure();
      t3 = H.getDynamicRuntimeType();
      H.buildFunctionType(t3, [H.convertRtiToRuntimeType(t1.$builtinTypeInfo && t1.$builtinTypeInfo[0])])._assertCheck$1(t2);
      t4 = H.buildFunctionType(t3, [t3]);
      ...
      t2 = H.setRuntimeTypeInfo(new H.MappedListIterable(H.listSuperNativeTypeCheck(t1, "$isIterable"), t5._assertCheck$1(t2)), [null, null]).toList$0(0);
      H.assertSubtype(t2, "$isList", [P.$double], "$asList");
      H.assertSubtype(t2, "$isList", [P.$double], "$asList");
      this.glPoints = new Float32Array(H._ensureNativeList(t2));
      J.getInterceptor$x(gl).bindBuffer$2(gl, 34962, this.buffer);
      C.RenderingContext_methods.bufferData$3(gl, 34962, this.glPoints, 35044);
      t2 = this.indices;
      t1 = new M.WebGLGraphicsData_upload_closure0();
      H.buildFunctionType(t3, [H.convertRtiToRuntimeType(t2.$builtinTypeInfo && t2.$builtinTypeInfo[0])])._assertCheck$1(t1);
      t4._assertCheck$1(t1);
      H.listSuperNativeTypeCheck(t2, "$isIterable");
      t5._assertCheck$1(t1);
      t1 = H.setRuntimeTypeInfo(new H.MappedListIterable(H.listSuperNativeTypeCheck(t2, "$isIterable"), t5._assertCheck$1(t1)), [null, null]).toList$0(0);
      H.assertSubtype(t1, "$isList", [P.$int], "$asList");
      H.assertSubtype(t1, "$isList", [P.$int], "$asList");
      this.glIndicies = new Uint16Array(H._ensureNativeList(t1));
      C.RenderingContext_methods.bindBuffer$2(gl, 34963, this.indexBuffer);
      C.RenderingContext_methods.bufferData$3(gl, 34963, this.glIndicies, 35044);
      this.dirty = false;
    },
    WebGLGraphicsData$1: function(gl) {
      this.set$color(0, [0, 0, 0]);
      this.set$points(0, []);
      this.set$indices([]);
      this.lastIndex = 0;
    ...
    $isWebGLGraphicsData: true,
    static: {WebGLGraphicsData$: function(gl) {
        var t1 = new M.WebGLGraphicsData(gl, H.assertSubtype(null, "$isList", [P.num], "$asList"), H.assertSubtype(null, "$isList", [P.num], "$asList"), H.assertSubtype(null, "$isList", [P.num], "$asList"), null, null, null, null, null, null, null, null, H.assertSubtype(null, "$isList", [M.WebGLGraphicsData], "$asList"));
  ...
  WebGLGraphicsData_upload_closure0: {
    "^": "Closure:63;",
    call$1: [function(s) {
      return J.toInt$0$n(H.numTypeCheck(s));
    }, "call$1", null, 2, 0, null, 62, "call"],
    $isFunction: true
  },
  WebGLGraphics_quadraticBezierCurve_getPt: {
    ...
    call$3: function(n1, n2, perc) {
      ...
      if (typeof n2 !== "number")
        return n2.$sub();
      t1 = C.JSNumber_methods.$sub(n2, n1);
      if (typeof n1 !== "number")
        return n1.$add();
      return n1 + t1 * perc;
    },
  ...
  WebGLMaskManager: {
    ...
    pushMask$2: function(maskData, renderSession) {
      var gl, t1, t2;
      H.interceptedTypeCheck(renderSession, "$isRenderSession");
      gl = renderSession.gl;
      if (maskData.dirty)
        M.WebGLGraphics_updateGraphics(maskData, gl);
      t1 = maskData._webGL;
      if (t1.$index(0, gl).data.length === 0)
        return;
      t2 = renderSession.stencilManager;
      t1 = t1.$index(0, gl).data;
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t2.pushStencil$3(maskData, t1[0], renderSession);
    },
    popMask$2: function(maskData, renderSession) {
      var gl, t1, t2;
      H.interceptedTypeCheck(maskData, "$isGraphics");
      gl = this.gl;
      t1 = maskData._webGL;
      if (t1.$index(0, gl).data.length === 0)
        return;
      ...
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t2.popStencil$3(maskData, t1[0], renderSession);
    },
    popMask$1: function(maskData) {
  ...
  WebGLSpriteBatch: {
    ...
    render$1: function(sprite) {
      var texture, uvs, alpha, tint, verticies, t1, aX, aY, t2, w0, w1, h0, h1, index, worldTransform, a, b, c, d, tx, ty, index0, t3, t4, t5, t6;
      texture = sprite.texture;
      ...
      if (typeof t1 !== "number")
        return t1.$mul();
      w0 = t1 * t2;
      t2 = texture.get$frame().width;
      if (typeof aX !== "number")
        return aX.$negate();
      if (typeof t2 !== "number")
        return t2.$mul();
      w1 = t2 * -aX;
      t2 = texture.get$frame().height;
      ...
      t1 = a * w1;
      t2 = c * h1;
      t3 = C.JSNumber_methods.$add(t1 + t2, tx);
      t4 = verticies.length;
      if (index >= t4)
      ...
      t3 = d * h1;
      t5 = b * w1;
      t6 = C.JSNumber_methods.$add(t3 + t5, ty);
      if (index0 >= t4)
      ...
      index0 = index + 1;
      t6 = a * w0;
      t2 = C.JSNumber_methods.$add(t6 + t2, tx);
      if (index >= t4)
        return H.ioore(verticies, index);
      verticies[index] = t2;
      index = index0 + 1;
      t2 = b * w0;
      t3 = C.JSNumber_methods.$add(t3 + t2, ty);
      if (index0 >= t4)
        return H.ioore(verticies, index0);
      verticies[index0] = t3;
      index0 = index + 1;
      ...
      index0 = index + 1;
      t3 = c * h0;
      t6 = C.JSNumber_methods.$add(t6 + t3, tx);
      if (index >= t4)
        return H.ioore(verticies, index);
      verticies[index] = t6;
      index = index0 + 1;
      t6 = d * h0;
      t2 = C.JSNumber_methods.$add(t6 + t2, ty);
      if (index0 >= t4)
        return H.ioore(verticies, index0);
      verticies[index0] = t2;
      index0 = index + 1;
      ...
      verticies[index0] = tint;
      index0 = index + 1;
      t3 = C.JSNumber_methods.$add(t1 + t3, tx);
      if (index >= t4)
        return H.ioore(verticies, index);
      verticies[index] = t3;
      index = index0 + 1;
      t5 = C.JSNumber_methods.$add(t6 + t5, ty);
      if (index0 >= t4)
        return H.ioore(verticies, index0);
      verticies[index0] = t5;
      index0 = index + 1;
      ...
      t4 = sprite.texture;
      if (t2 <= t3)
        J.add$1$ax(t1, t4.get$baseTexture());
      else {
        t2 = t4.get$baseTexture();
        if (t3 >= t1.length)
          return H.ioore(t1, t3);
        t1[t3] = t2;
      }
  ...
  WebGLStencilManager: {
    ...
    pushStencil$3: function(graphics, webGLData, renderSession) {
      var gl, level, t1;
      H.interceptedTypeCheck(webGLData, "$isWebGLGraphicsData");
      gl = this.gl;
      this.bindGraphics$3(graphics, webGLData, renderSession);
      if (this.stencilStack.length === 0) {
        J.getInterceptor$x(gl).enable$1(gl, 2960);
        C.RenderingContext_methods.clear$1(gl, 1024);
        this.reverse = true;
        this.count = 0;
      }
      C.JSArray_methods.add$1(this.stencilStack, webGLData);
      level = this.count;
      J.getInterceptor$x(gl).colorMask$4(gl, false, false, false, false);
      C.RenderingContext_methods.stencilFunc$3(gl, 519, 0, 255);
      C.RenderingContext_methods.stencilOp$3(gl, 7680, 7680, 5386);
      if (webGLData.mode === 1) {
        C.RenderingContext_methods.drawElements$4(gl, 6, webGLData.indices.length - 4, 5123, 0);
        if (H.boolConversionCheck(this.reverse)) {
          C.RenderingContext_methods.stencilFunc$3(gl, 514, C.JSInt_methods.$sub(255, level), 255);
          C.RenderingContext_methods.stencilOp$3(gl, 7680, 7680, 7683);
        } else {
          C.RenderingContext_methods.stencilFunc$3(gl, 514, level, 255);
          C.RenderingContext_methods.stencilOp$3(gl, 7680, 7680, 7682);
        }
        C.RenderingContext_methods.drawElements$4(gl, 6, 4, 5123, (webGLData.indices.length - 4) * 2);
        if (H.boolConversionCheck(this.reverse)) {
          if (typeof level !== "number")
            return level.$add();
          C.RenderingContext_methods.stencilFunc$3(gl, 514, 255 - (level + 1), 255);
        } else {
          if (typeof level !== "number")
            return level.$add();
          C.RenderingContext_methods.stencilFunc$3(gl, 514, level + 1, 255);
        }
        this.reverse = !H.boolConversionCheck(this.reverse);
      } else {
        if (!H.boolConversionCheck(this.reverse)) {
          C.RenderingContext_methods.stencilFunc$3(gl, 514, C.JSInt_methods.$sub(255, level), 255);
          C.RenderingContext_methods.stencilOp$3(gl, 7680, 7680, 7683);
      ...
      C.RenderingContext_methods.colorMask$4(gl, true, true, true, true);
      C.RenderingContext_methods.stencilOp$3(gl, 7680, 7680, 7680);
      t1 = this.count;
      if (typeof t1 !== "number")
        return t1.$add();
      this.count = t1 + 1;
    ...
    bindGraphics$3: function(graphics, webGLData, renderSession) {
      var projection, offset, t1, shader, t2, t3, t4;
      H.interceptedTypeCheck(webGLData, "$isWebGLGraphicsData");
      ...
      if (webGLData.mode === 1) {
        ...
        shader = t1.complexPrimativeShader;
        t1.setShader$1(shader);
        J.uniformMatrix3fv$3$x(this.gl, shader.translationMatrix, false, graphics.worldTransform.toArray$1(true));
        t1 = this.gl;
        t2 = shader.projectionVector;
        t3 = projection.x;
        t4 = projection.y;
        if (typeof t4 !== "number")
          return t4.$negate();
        J.uniform2f$3$x(t1, t2, t3, -t4);
        t4 = this.gl;
        t3 = shader.offsetVector;
        t2 = offset.x;
        if (typeof t2 !== "number")
          return t2.$negate();
        t1 = offset.y;
        if (typeof t1 !== "number")
          return t1.$negate();
        J.uniform2f$3$x(t4, t3, -t2, -t1);
        t1 = this.gl;
        t2 = shader.tintColor;
        t3 = M.hex2rgb(graphics.tint);
        H.assertSubtype(t3, "$isList", [P.$double], "$asList");
        H.assertSubtype(t3, "$isList", [P.$double], "$asList");
        J.uniform3fv$2$x(t1, t2, new Float32Array(H._ensureNativeList(t3)));
        t3 = this.gl;
        t2 = shader.color;
        t1 = webGLData.color;
        H.assertSubtype(t1, "$isList", [P.$double], "$asList");
        H.assertSubtype(t1, "$isList", [P.$double], "$asList");
        J.uniform3fv$2$x(t3, t2, new Float32Array(H._ensureNativeList(t1)));
        J.uniform1f$2$x(this.gl, shader.alpha, graphics.worldAlpha * webGLData.alpha);
        J.bindBuffer$2$x(this.gl, 34962, webGLData.buffer);
        J.vertexAttribPointer$6$x(this.gl, shader.aVertexPosition, 2, 5126, false, 8, 0);
        J.bindBuffer$2$x(this.gl, 34963, webGLData.indexBuffer);
      } else {
        t1 = renderSession.shaderManager;
        shader = t1.primitiveShader;
        t1.setShader$1(shader);
        J.uniformMatrix3fv$3$x(this.gl, shader.PIXI$PrimitiveShader$translationMatrix, false, graphics.worldTransform.toArray$1(true));
        t1 = this.gl;
        t2 = shader.PIXI$PrimitiveShader$projectionVector;
        t3 = projection.x;
        t4 = projection.y;
        if (typeof t4 !== "number")
          return t4.$negate();
        J.uniform2f$3$x(t1, t2, t3, -t4);
        t4 = this.gl;
        t3 = shader.PIXI$PrimitiveShader$offsetVector;
        t2 = offset.x;
        if (typeof t2 !== "number")
          return t2.$negate();
        t1 = offset.y;
        ...
        J.uniform2f$3$x(t4, t3, -t2, -t1);
        t1 = this.gl;
        t2 = shader.PIXI$PrimitiveShader$tintColor;
        t3 = M.hex2rgb(graphics.tint);
        H.assertSubtype(t3, "$isList", [P.$double], "$asList");
        H.assertSubtype(t3, "$isList", [P.$double], "$asList");
        J.uniform3fv$2$x(t1, t2, new Float32Array(H._ensureNativeList(t3)));
        J.uniform1f$2$x(this.gl, shader.PIXI$PrimitiveShader$alpha, graphics.worldAlpha);
        J.bindBuffer$2$x(this.gl, 34962, webGLData.buffer);
        J.vertexAttribPointer$6$x(this.gl, shader.PIXI$PrimitiveShader$aVertexPosition, 2, 5126, false, 24, 0);
        J.vertexAttribPointer$6$x(this.gl, shader.PIXI$PrimitiveShader$colorAttribute, 4, 5126, false, 24, 8);
        J.bindBuffer$2$x(this.gl, 34963, webGLData.indexBuffer);
      }
    },
    popStencil$3: function(graphics, webGLData, renderSession) {
      ...
      if (this.stencilStack.length === 0)
        ...
        if (J.get$mode$x(webGLData) === 1) {
          t1 = !H.boolConversionCheck(this.reverse);
          this.reverse = t1;
          if (t1) {
            C.RenderingContext_methods.stencilFunc$3(gl, 514, 255 - (level + 1), 255);
            C.RenderingContext_methods.stencilOp$3(gl, 7680, 7680, 7682);
          ...
          C.RenderingContext_methods.drawElements$4(gl, 6, 4, 5123, (webGLData.get$indices().length - 4) * 2);
          C.RenderingContext_methods.stencilFunc$3(gl, 519, 0, 255);
          C.RenderingContext_methods.stencilOp$3(gl, 7680, 7680, 5386);
          C.RenderingContext_methods.drawElements$4(gl, 6, webGLData.get$indices().length - 4, 5123, 0);
          if (!H.boolConversionCheck(this.reverse))
          ...
          C.RenderingContext_methods.drawElements$4(gl, 5, webGLData.get$indices().length, C.RenderingContext_methods.get$UNSIGNED_SHORT(gl), 0);
          if (!H.boolConversionCheck(this.reverse))
            C.RenderingContext_methods.stencilFunc$3(gl, 514, 255 - level, 255);
          else
            C.RenderingContext_methods.stencilFunc$3(gl, 514, level, 255);
  ...
  WebGLRenderer: {
    ...
    renderDisplayObject$3: function(displayObject, projection, buffer) {
      var t1, t2, t3;
      H.interceptedTypeCheck(projection, "$isPoint");
      ...
      t1.offset = this.offset;
      t2 = this.spriteBatch;
      t2.renderSession = t1;
      t3 = t1.shaderManager.defaultShader;
      t2.shader = t3;
      t2.dirty = true;
      t2 = this.filterManager;
      t2.renderSession = t1;
      t2.defaultShader = t3;
      t3 = projection.x;
      if (typeof t3 !== "number")
        return t3.$mul();
      t2.width = C.JSNumber_methods.toInt$0(t3 * 2);
      t3 = projection.y;
      if (typeof t3 !== "number")
        return t3.$negate();
      t2.height = C.JSNumber_methods.toInt$0(-t3 * 2);
      t2.buffer = buffer;
  ...
  Text: {
    ...
    updateText$0: function() {
      ...
      if (result == null) {
        ...
        if (0 >= t3.length)
          return H.ioore(t3, 0);
        body = H.interceptedTypeCheck(t3[0], "$isBodyElement");
        dummy = H.interceptedTypeCheck(C.HtmlDocument_methods._createElement$2(document, "div", null), "$isDivElement");
        dummy.textContent = "M";
        t3 = J.getInterceptor$x(dummy);
        t3.setAttribute$2(dummy, "style", t2 + ";position:absolute;top:0;left:0");
        J.append$1$x(body, dummy);
      ...
      if (t4) {
        ...
        for (i = 0; i < lines.length; ++i) {
          ...
          if (t2 === "right") {
            if (i >= t1)
              return H.ioore(lineWidths, i);
            linePositionX0 = linePositionX + C.JSNumber_methods.$sub(maxLineWidth, lineWidths[i]);
          } else if (t2 === "center") {
            if (i >= t1)
              return H.ioore(lineWidths, i);
      ...
      for (i = 0; i < lines.length; ++i) {
        ...
        if (t2 === "right") {
          if (i >= t1)
            return H.ioore(lineWidths, i);
          linePositionX += C.JSNumber_methods.$sub(maxLineWidth, lineWidths[i]);
        } else if (t2 === "center") {
          if (i >= t1)
            return H.ioore(lineWidths, i);
        ...
        t2.toString;
        H.stringTypeCheck(t3);
        t2.fillText(t3, linePositionX, linePositionY);
      }
      this.texture.get$baseTexture().width = this.canvas.width;
      this.texture.get$baseTexture().height = this.canvas.height;
      t1 = this.texture;
      t2 = t1.crop;
      t1 = t1.get$frame();
      t3 = this.canvas.width;
      t1.width = t3;
      t2.width = t3;
      t3 = this.texture;
      t2 = t3.crop;
      ...
      t3.height = t4;
      t2.height = t4;
      this.PIXI$Sprite$_width = t1.width;
      this.PIXI$Sprite$_height = t1.height;
    ...
    Text$2: function(text, style) {
      ...
      this.canvas = t1;
      this.context = H.interceptedTypeCheck(J.getContext$1$x(t1, "2d"), "$isCanvasRenderingContext2D");
      this.texture = M.Texture$(M.BaseTexture_fromCanvas(this.canvas, null), null);
    ...
    static: {"^": "Text_splitReg,Text_heightCache"}
  },
  BaseTexture: {
    ...
    static: {BaseTexture$: function(source, scaleMode) {
        ...
        return t3;
      }, BaseTexture_fromCanvas: function(canvas, scaleMode) {
        var t1, t2, baseTexture;
        canvas.toString;
        t1 = H.assertSubtype(new W._ElementAttributeMap(canvas), "$isMap", [P.String, P.String], "$asMap");
        H.assertSubtype(t1, "$isMap", [P.String, P.String], "$asMap");
        if (J.getAttribute$1$x(canvas, "data-" + H.assertSubtype(new W._DataAttributeMap(H.assertSubtype(t1, "$isMap", [P.String, P.String], "$asMap")), "$isMap", [P.String, P.String], "$asMap")._toHyphenedName$1("_pixiId")) == null) {
          t1 = H.assertSubtype(new W._ElementAttributeMap(canvas), "$isMap", [P.String, P.String], "$asMap");
          H.assertSubtype(t1, "$isMap", [P.String, P.String], "$asMap");
          t1 = H.assertSubtype(new W._DataAttributeMap(H.assertSubtype(t1, "$isMap", [P.String, P.String], "$asMap")), "$isMap", [P.String, P.String], "$asMap");
          t2 = $.TextureCacheIdGenerator;
          $.TextureCacheIdGenerator = t2 + 1;
          t2 = "canvas_" + t2;
          J.setAttribute$2$x(canvas, "data-" + t1._toHyphenedName$1("_pixiId"), t2);
        }
        t1 = $.get$BaseTextureCache();
        t2 = H.assertSubtype(new W._ElementAttributeMap(canvas), "$isMap", [P.String, P.String], "$asMap");
        H.assertSubtype(t2, "$isMap", [P.String, P.String], "$asMap");
        baseTexture = t1.$index(0, J.getAttribute$1$x(canvas, "data-" + H.assertSubtype(new W._DataAttributeMap(H.assertSubtype(t2, "$isMap", [P.String, P.String], "$asMap")), "$isMap", [P.String, P.String], "$asMap")._toHyphenedName$1("_pixiId")));
        if (baseTexture == null) {
          baseTexture = M.BaseTexture$(canvas, scaleMode);
          t1 = $.get$BaseTextureCache();
          t2 = H.assertSubtype(new W._ElementAttributeMap(canvas), "$isMap", [P.String, P.String], "$asMap");
          H.assertSubtype(t2, "$isMap", [P.String, P.String], "$asMap");
          t1.$indexSet(0, J.getAttribute$1$x(canvas, "data-" + H.assertSubtype(new W._DataAttributeMap(H.assertSubtype(t2, "$isMap", [P.String, P.String], "$asMap")), "$isMap", [P.String, P.String], "$asMap")._toHyphenedName$1("_pixiId")), baseTexture);
        }
        return baseTexture;
      }}
  },
  ...
  Texture: {
    ...
    set$frame: function(frame) {
      this.frame = H.interceptedTypeCheck(frame, "$isRectangle");
    },
    set$valid: function(valid) {
      this.valid = H.boolTypeCheck(valid);
    },
    set$baseTexture: function(baseTexture) {
      this.baseTexture = H.interceptedTypeCheck(baseTexture, "$isBaseTexture");
    },
    set$width: function(_, width) {
    ...
    onBaseTextureLoaded$0: [function() {
      var baseTexture = this.get$baseTexture();
      baseTexture.removeEventListener$2(0, "loaded", this.get$onBaseTextureLoaded());
      if (this.noFrame)
        this.set$frame(new M.Rectangle(0, 0, baseTexture.width, baseTexture.height));
    ...
    setFrame$1: function(frame) {
      ...
      t1.x = frame.x;
      t1.y = frame.y;
      t1.width = frame.width;
      t1.height = frame.height;
      t1 = C.JSNumber_methods.$gt(C.JSNumber_methods.$add(frame.x, frame.width), this.get$baseTexture().width) || C.JSNumber_methods.$gt(C.JSNumber_methods.$add(frame.y, frame.height), this.get$baseTexture().height);
      if (t1)
      ...
      if (frame != null) {
        ...
        if (t1 != null)
          if (t1 !== 0) {
            t1 = frame.height;
            t1 = t1 != null && t1 !== 0 && this.get$baseTexture().source != null && this.get$baseTexture()._hasLoaded;
          } else
            t1 = false;
        else
          t1 = false;
    ...
    Texture$2: function(baseTexture, frame) {
      ...
      if (this.get$frame() == null) {
        this.noFrame = true;
        this.set$frame(new M.Rectangle(0, 0, 1, 1));
      }
    ...
    static: {"^": "Texture_frameUpdates", Texture$: function(baseTexture, frame) {
        ...
        if (texture == null) {
          ...
          if (C.JSString_methods.indexOf$1(imageUrl, "data:") === -1)
            crossorigin = true;
          if (baseTexture == null) {
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|CanvasGradient|CanvasPattern|DOMError|FileError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGRect|TextMetrics|WebGLRenderbuffer"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["_js_helper", "dart:_js_helper", , H, {
  ...
  ReflectionInfo_sortedIndex_closure: {
    "^": "Closure:68;box_0,this_1,positions_2",
...
["dart._internal", "dart:_internal", , H, {
  ...
  IterableMixinWorkaround_insertAllList: function(list, index, iterable) {
    ...
    for (t1 = H.getTypeArgumentByIndex(iterable, 0), H.listSuperNativeTypeCheck(iterable, "$isIterable"), t1 = H.assertSubtype(H.setRuntimeTypeInfo(new H.ListIterator(H.listSuperNativeTypeCheck(iterable, "$isIterable"), 2, 0, H.assertSubtypeOfRuntimeType(null, t1)), [t1]), "$isIterator", [H.getTypeArgumentByIndex(iterable, 0)], "$asIterator"); t1.moveNext$0(); index = index0) {
      index0 = index + 1;
      C.JSArray_methods.$indexSet(list, index, H.assertSubtypeOfRuntimeType(t1._current, H.getTypeArgumentByIndex(t1, 0)));
    }
  },
...
["dart.async", "dart:async", , P, {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 80, 20, 21],
...
["dart.dom.html", "dart:html", , W, {
  ...
  CanvasRenderingContext2D: {
    "^": "CanvasRenderingContext;lineWidth=",
    ...
    _arc$6: function(receiver, x, y, radius, startAngle, endAngle, anticlockwise) {
    ...
    bezierCurveTo$6: function(receiver, cp1x, cp1y, cp2x, cp2y, x, y) {
      return receiver.bezierCurveTo(H.numTypeCheck(cp1x), H.numTypeCheck(cp1y), H.numTypeCheck(cp2x), H.numTypeCheck(cp2y), H.numTypeCheck(x), H.numTypeCheck(y));
    },
    ...
    strokeText$4: function(receiver, text, x, y, maxWidth) {
      return receiver.strokeText(H.stringTypeCheck(text), x, y, maxWidth);
    },
    ...
    }, "fill$0", "call$1", "call$0", "get$fill", 0, 2, 36, 37],
  ...
  Window: {
    ...
    }, "call$1", "get$requestAnimationFrame", 2, 0, 38],
...
["dart.dom.svg", "dart:svg", , P, {
  ...
  GraphicsElement: {
    "^": "SvgElement;",
    "%": "SVGAElement|SVGAltGlyphElement|SVGClipPathElement|SVGDefsElement|SVGForeignObjectElement|SVGGElement|SVGImageElement|SVGSVGElement|SVGSwitchElement|SVGTSpanElement|SVGTextContentElement|SVGTextElement|SVGTextPathElement|SVGTextPositioningElement|SVGUseElement;SVGGraphicsElement"
  },
  PointList: {
    "^": "Interceptor;",
    $isPointList: true,
...
["dart.dom.web_gl", "dart:web_gl", , P, {
  ...
  RenderingContext: {
    ...
    lineWidth$1: [function(receiver, width) {
      return receiver.lineWidth(H.numTypeCheck(width));
    }, "call$1", "get$lineWidth", 2, 0, 39, 40],
    ...
    }, "call$2", "get$uniform1f", 4, 0, 41, 42, 43],
    ...
    }, "call$2", "get$uniform1i", 4, 0, 44, 42, 43],
    ...
    }, "call$3", "get$uniform2f", 6, 0, 45, 42, 43, 46],
    ...
    }, "call$2", "get$uniform2fv", 4, 0, 47, 42, 48],
    ...
    }, "call$3", "get$uniform2i", 6, 0, 49, 42, 43, 46],
    ...
    }, "call$4", "get$uniform3f", 8, 0, 50, 42, 43, 46, 51],
    ...
    }, "call$2", "get$uniform3fv", 4, 0, 47, 42, 48],
    ...
    }, "call$4", "get$uniform3i", 8, 0, 52, 42, 43, 46, 51],
    ...
    }, "call$5", "get$uniform4f", 10, 0, 53, 42, 43, 46, 51, 54],
    ...
    }, "call$2", "get$uniform4fv", 4, 0, 47, 42, 48],
    ...
    }, "call$5", "get$uniform4i", 10, 0, 55, 42, 43, 46, 51, 54],
    ...
    }, "call$3", "get$uniformMatrix3fv", 6, 0, null, 42, 56, 57],
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, stage, texture, bg, container, bgFront, light2, light1, panda, renderer, t11, thing, help;
    t1 = {};
    ...
    stage.set$interactive(true);
    texture = M.Texture_fromImage("BGrotate.jpg", null, null);
    ...
    bg = new M.Sprite(t8, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t7, t6, t5, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t4, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t2), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t3, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    bg.texture = texture;
    bg._setupTexture$0();
    t8.x = 0.5;
    t8.y = 0.5;
    stage.addChildAt$2(bg, t10.length);
    t8 = new M.Point(null, null);
    t8.x = 0;
    t8.y = 0;
    t3 = new M.Point(null, null);
    ...
    t7 = H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList");
    container = new M.DisplayObjectContainer(t7, null, null, t8, t3, t2, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t4, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t5), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t6, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    texture = M.Texture_fromImage("SceneRotate.jpg", null, null);
    t6 = new M.Point(null, null);
    t6.x = 0;
    t6.y = 0;
    t5 = new M.Point(null, null);
    ...
    bgFront = new M.Sprite(t6, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t5, t4, t2, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t3, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t8), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t9, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    bgFront.texture = texture;
    bgFront._setupTexture$0();
    t6.x = 0.5;
    t6.y = 0.5;
    container.addChildAt$2(bgFront, t7.length);
    texture = M.Texture_fromImage("LightRotate2.png", null, null);
    t6 = new M.Point(null, null);
    t6.x = 0;
    t6.y = 0;
    ...
    t5 = H.assertSubtype([], "$isList", [M.AbstractFilter], "$asList");
    light2 = new M.Sprite(t6, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t9, t8, t3, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t2, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t4), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t5, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    light2.texture = texture;
    light2._setupTexture$0();
    t6.x = 0.5;
    t6.y = 0.5;
    container.addChildAt$2(light2, t7.length);
    texture = M.Texture_fromImage("LightRotate1.png", null, null);
    t6 = new M.Point(null, null);
    t6.x = 0;
    t6.y = 0;
    t5 = new M.Point(null, null);
    ...
    t8 = new Float32Array(9);
    t9 = H.assertSubtype([], "$isList", [M.AbstractFilter], "$asList");
    light1 = new M.Sprite(t6, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t5, t4, t2, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t3, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t8), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t9, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    light1.texture = texture;
    light1._setupTexture$0();
    t6.x = 0.5;
    t6.y = 0.5;
    container.addChildAt$2(light1, t7.length);
    texture = M.Texture_fromImage("panda.png", null, null);
    t6 = new M.Point(null, null);
    t6.x = 0;
    t6.y = 0;
    t9 = new M.Point(null, null);
    ...
    t4 = new Float32Array(9);
    t5 = H.assertSubtype([], "$isList", [M.AbstractFilter], "$asList");
    panda = new M.Sprite(t6, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t9, t8, t3, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t2, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t4), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t5, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    panda.texture = texture;
    panda._setupTexture$0();
    t6.x = 0.5;
    t6.y = 0.5;
    container.addChildAt$2(panda, t7.length);
    stage.addChildAt$2(container, t10.length);
    renderer = M.autoDetectRenderer(800, 600, null, false, false);
    t7 = $.Graphics_POLY;
    t6 = H.assertSubtype([], "$isList", [P.num], "$asList");
    t5 = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
    t4 = new M.Point(null, null);
    t4.x = 0;
    t4.y = 0;
    ...
    thing = new M.Graphics(1, 0, false, 1, 1, 0, H.assertSubtype([], "$isList", [M.GraphicsData], "$asList"), 16777215, null, new M.GraphicsData(t6, 1, 0, null, 1, 1, 0, t7), H.assertSubtype(t5, "$isMap", [P.RenderingContext, M.WebGLGraphicsData], "$asMap"), false, null, 10, false, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t4, t2, t3, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t8, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t9), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t11, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    thing.Graphics$0();
    stage.addChildAt$2(thing, t10.length);
    t4.x = 310;
    t4.y = 190;
    if (thing.currentPath.points.length === 0) {
      t2 = thing.graphicsData;
      if (t2.length > 0)
        t2.pop();
    }
    thing.lineWidth = 0;
    ...
    thing.lineAlpha = 1;
    t2 = $.Graphics_POLY;
    t2 = new M.GraphicsData(H.assertSubtype([], "$isList", [P.num], "$asList"), 1, 0, null, 1, 1, 0, t2);
    t2.lineWidth = 0;
    t2.lineColor = 0;
    t2.lineAlpha = 1;
    t2.fillColor = thing.fillColor;
    t2.fillAlpha = thing.fillAlpha;
    t2.fill = thing.filling;
    t2.set$points(0, []);
    t2.type = $.Graphics_POLY;
    thing.currentPath = t2;
    C.JSArray_methods.add$1(thing.graphicsData, t2);
    container.set$mask(0, thing);
    t1.count_0 = 0;
    t2 = new F.main_closure(container, thing);
    stage.tap = t2;
    stage.click = t2;
    J.append$1$x(document.body, renderer.view);
    renderer.view.className = "rendererView";
    t2 = new F.main_resize(bg, container, renderer, thing);
    ...
    t4 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(t2), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)]);
    t4._tryResume$0();
    ...
    t8 = new Float32Array(9);
    t9 = H.assertSubtype([], "$isList", [M.AbstractFilter], "$asList");
    help = new M.Text(null, null, null, null, null, null, t3, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t4, t5, t6, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t7, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t8), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t9, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    help.renderable = true;
    help.Text$2("Click to turn masking on / off.", t2);
    t4.y = 350;
    t4.x = 10;
    stage.addChildAt$2(help, t10.length);
    $.get$requestAnimFrame().call$1(new F.main_animate(t1, stage, bg, bgFront, light2, light1, panda, renderer, thing));
  }, "call$0", "main$closure", 0, 0, 35],
  main_closure: {
    "^": "Closure:32;container_1,thing_2",
    call$1: function(e) {
      var t1;
      P.print("cool");
      t1 = this.container_1;
      if (t1._mask == null)
        t1.set$mask(0, this.thing_2);
      else {
        P.print("cool");
        t1.set$mask(0, null);
      }
  ...
  main_resize: {
    "^": "Closure:86;bg_3,container_4,renderer_5,thing_6",
    call$1: [function(e) {
      var t1, t2;
      this.renderer_5.resize$2(0, window.innerWidth, window.innerHeight);
      t1 = this.bg_3.position;
  ...
  main_animate: {
    "^": "Closure:32;box_0,stage_7,bg_8,bgFront_9,light2_10,light1_11,panda_12,renderer_13,thing_14",
    call$1: [function(dt) {
      var t1, t2, t3, t4;
      t1 = this.bg_8;
      t1.set$rotation(t1.get$rotation() + 0.01);
      t1 = this.bgFront_9;
      t1.set$rotation(t1.get$rotation() - 0.01);
      t1 = this.light1_11;
      t1.set$rotation(t1.get$rotation() + 0.02);
      t1 = this.light2_10;
      t1.set$rotation(t1.get$rotation() + 0.01);
      t1 = this.panda_12.scale;
      t2 = this.box_0;
      t3 = t2.count_0;
      t1.x = 1 + Math.sin(t3) * 0.04;
      t3 = t2.count_0;
      t1.y = 1 + Math.cos(t3) * 0.04;
      t2.count_0 += 0.1;
      t1 = this.thing_14;
      t1.lineWidth = 0;
      t1.filling = false;
      ...
      t1.bounds = null;
      t1.filling = true;
      t1.fillColor = 9160191;
      t1.fillAlpha = 0.4;
      t3 = t2.count_0;
      t3 = Math.sin(t3);
      t4 = t2.count_0;
      t1.moveTo$2(0, -120 + t3 * 20, -100 + Math.cos(t4) * 20);
      t3 = t2.count_0;
      t3 = Math.cos(t3);
      t4 = t2.count_0;
      t1.lineTo$2(0, 120 + t3 * 20, -100 + Math.sin(t4) * 20);
      t3 = t2.count_0;
      t3 = Math.sin(t3);
      t4 = t2.count_0;
      t1.lineTo$2(0, 120 + t3 * 20, 100 + Math.cos(t4) * 20);
      t3 = t2.count_0;
      t3 = Math.cos(t3);
      t4 = t2.count_0;
      t1.lineTo$2(0, -120 + t3 * 20, 100 + Math.sin(t4) * 20);
      ...
      t4 = t2.count_0;
      t1.lineTo$2(0, -120 + t3 * 20, -100 + Math.cos(t4) * 20);
      t1.rotation = t2.count_0 * 0.1;
      this.renderer_13.render$1(this.stage_7);
...
M.DisplayObjectContainer.$isDisplayObjectContainer = true;
M.DisplayObjectContainer.$isDisplayInterface = true;
M.DisplayObjectContainer.$isObject = true;
M.Point.$isPoint = true;
M.Point.$isObject = true;
...
Isolate.$lazy($, "graphicsDataPool", "WebGLGraphics_graphicsDataPool", "get$WebGLGraphics_graphicsDataPool", function() {
  return H.assertSubtype([], "$isList", [M.WebGLGraphicsData], "$asList");
});
...
Isolate.$lazy($, "heightCache", "Text_heightCache", "get$Text_heightCache", function() {
  return H.assertSubtype(P.LinkedHashMap_LinkedHashMap$_empty(null, null), "$isMap", [P.String, P.$int], "$asMap");
});
...
function dart_precompiled($collectedClasses) {
  ...
  function DisplayObject(rotation, visible, hitArea, parent, interactiveChildren, mousemove, worldTransform) {
  ...
  function GraphicsData(points, fillAlpha, fillColor, fill, lineWidth, lineAlpha, lineColor, type) {
    this.points = points;
  ...
  GraphicsData.builtin$cls = "GraphicsData";
  if (!"name" in GraphicsData)
    GraphicsData.name = "GraphicsData";
  $desc = $collectedClasses.GraphicsData;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GraphicsData.prototype = $desc;
  GraphicsData.prototype.get$points = function(receiver) {
    return this.points;
  };
  GraphicsData.prototype.get$fillAlpha = function() {
    return this.fillAlpha;
  };
  GraphicsData.prototype.get$fillColor = function() {
    return this.fillColor;
  };
  GraphicsData.prototype.get$fill = function(receiver) {
    return this.fill;
  };
  GraphicsData.prototype.get$lineWidth = function(receiver) {
    return this.lineWidth;
  };
  GraphicsData.prototype.get$lineAlpha = function() {
    return this.lineAlpha;
  };
  GraphicsData.prototype.get$lineColor = function() {
    return this.lineColor;
  };
  GraphicsData.prototype.get$type = function(receiver) {
    return this.type;
  };
  function Graphics(fillAlpha, fillColor, filling, lineWidth, lineAlpha, lineColor, graphicsData, tint, blendMode, currentPath, _webGL, PIXI$Graphics$isMask, bounds, boundsPadding, clearDirty, children, _width, _height, position, scale, pivot, rotation, alpha, visible, hitArea, renderable, parent, __iParent, interactiveChildren, __hit, __isOver, __mouseIsDown, __isDown, dirty, click, mousemove, mousedown, mouseout, mouseover, mouseup, mouseupoutside, touchmove, touchstart, touchend, tap, touchendoutside, __touchData, stage, buttonMode, worldAlpha, _interactive, defaultCursor, worldTransform, color, dynamic, _sr, _cr, filterArea, _bounds, _currentBounds, _mask, isMask, _cacheAsBitmap, _cachedSprite, _cacheIsDirty, _filterBlock, _filters, rotationCache) {
    this.fillAlpha = fillAlpha;
    this.fillColor = fillColor;
    ...
    this._webGL = _webGL;
    this.PIXI$Graphics$isMask = PIXI$Graphics$isMask;
    this.bounds = bounds;
  ...
  Graphics.prototype.get$fillAlpha = function() {
    return this.fillAlpha;
  };
  Graphics.prototype.get$fillColor = function() {
    return this.fillColor;
  };
  Graphics.prototype.get$lineWidth = function(receiver) {
    return this.lineWidth;
  };
  Graphics.prototype.get$lineAlpha = function() {
    return this.lineAlpha;
  };
  Graphics.prototype.get$lineColor = function() {
    return this.lineColor;
  };
  ...
  function WebGLGraphicsData(gl, color, points, indices, lastIndex, buffer, indexBuffer, mode, alpha, dirty, glPoints, glIndicies, data) {
    this.gl = gl;
    this.color = color;
    this.points = points;
    ...
    this.glIndicies = glIndicies;
    this.data = data;
  }
  WebGLGraphicsData.builtin$cls = "WebGLGraphicsData";
  if (!"name" in WebGLGraphicsData)
    WebGLGraphicsData.name = "WebGLGraphicsData";
  $desc = $collectedClasses.WebGLGraphicsData;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebGLGraphicsData.prototype = $desc;
  WebGLGraphicsData.prototype.get$points = function(receiver) {
    return this.points;
  };
  WebGLGraphicsData.prototype.get$indices = function() {
    return this.indices;
  };
  WebGLGraphicsData.prototype.get$mode = function(receiver) {
    return this.mode;
  };
  function WebGLGraphicsData_upload_closure() {
  }
  WebGLGraphicsData_upload_closure.builtin$cls = "WebGLGraphicsData_upload_closure";
  if (!"name" in WebGLGraphicsData_upload_closure)
    WebGLGraphicsData_upload_closure.name = "WebGLGraphicsData_upload_closure";
  $desc = $collectedClasses.WebGLGraphicsData_upload_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebGLGraphicsData_upload_closure.prototype = $desc;
  function WebGLGraphicsData_upload_closure0() {
  }
  WebGLGraphicsData_upload_closure0.builtin$cls = "WebGLGraphicsData_upload_closure0";
  if (!"name" in WebGLGraphicsData_upload_closure0)
    WebGLGraphicsData_upload_closure0.name = "WebGLGraphicsData_upload_closure0";
  $desc = $collectedClasses.WebGLGraphicsData_upload_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebGLGraphicsData_upload_closure0.prototype = $desc;
  function WebGLGraphics_quadraticBezierCurve_getPt() {
  }
  WebGLGraphics_quadraticBezierCurve_getPt.builtin$cls = "WebGLGraphics_quadraticBezierCurve_getPt";
  if (!"name" in WebGLGraphics_quadraticBezierCurve_getPt)
    WebGLGraphics_quadraticBezierCurve_getPt.name = "WebGLGraphics_quadraticBezierCurve_getPt";
  $desc = $collectedClasses.WebGLGraphics_quadraticBezierCurve_getPt;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WebGLGraphics_quadraticBezierCurve_getPt.prototype = $desc;
  ...
  WebGLSpriteBatch.prototype.get$indices = function() {
    return this.indices;
  };
  ...
  TextStyle.prototype.get$fill = function(receiver) {
    return this.fill;
  };
  ...
  function main_closure(container_1, thing_2) {
  ...
  function main_resize(bg_3, container_4, renderer_5, thing_6) {
    this.bg_3 = bg_3;
    this.container_4 = container_4;
    this.renderer_5 = renderer_5;
    this.thing_6 = thing_6;
  }
  ...
  function main_animate(box_0, stage_7, bg_8, bgFront_9, light2_10, light1_11, panda_12, renderer_13, thing_14) {
    this.box_0 = box_0;
    this.stage_7 = stage_7;
    this.bg_8 = bg_8;
    this.bgFront_9 = bgFront_9;
    this.light2_10 = light2_10;
    this.light1_11 = light1_11;
    this.panda_12 = panda_12;
    this.renderer_13 = renderer_13;
    this.thing_14 = thing_14;
  }
