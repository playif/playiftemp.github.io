...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, t2, t3, t4, t5, t6, t7, t8, t9, stage, renderer, texture, baseTexture, crossorigin, image, i;
    ...
    t8 = H.getVoidRuntimeType();
    t9 = H.buildFunctionType(t8, [H.buildInterfaceType(M.InteractionData)]);
    stage = new M.Stage(null, false, new M.Rectangle(0, 0, 100000, 100000), 0, H.assertSubtype([], "$isList", [P.num], "$asList"), null, new M.Matrix(1, 0, 0, 1, 0, 0, t1), null, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), false, null, null, t2, t3, t4, 0, 1, true, null, false, false, null, false, false, false, false, false, t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), H.assertSubtype(t5, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t6), 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, null, false, new M.FilterBlock(true, true, null, null, null, t7, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
    stage.Stage$2(9946478, true);
    renderer = M.autoDetectRenderer(window.innerWidth, window.innerHeight, null, false, false);
    renderer.view.className = "rendererView";
    t7 = new F.main_resize(renderer);
    ...
    H.buildFunctionType(t8, [t6.$tv_T()])._assertCheck$1(t7);
    H.buildFunctionType(t8)._assertCheck$1(null);
    t8 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t6._target, t6._eventType, W._wrapZone(t7), t6._useCapture), [H.getTypeArgumentByIndex(t6, 0)]);
    t8._tryResume$0();
    H.assertSubtype(t8, "$isStreamSubscription", [H.getTypeArgumentByIndex(t6, 0)], "$asStreamSubscription");
    t7.call$0();
    ...
    t1 = new F.main_createBunny(stage, texture);
    for (i = 0; i < 10; ++i)
      t1.call$2(C.C__JSRandom.nextInt$1(window.innerWidth), C.C__JSRandom.nextInt$1(window.innerHeight));
    $.get$requestAnimFrame().call$1(new F.main_animate(stage, renderer));
  }, "call$0", "main$closure", 0, 0, 35],
  Bunny: {
    "^": "Sprite;data,dragging,anchor,texture,updateFrame,PIXI$Sprite$_width,PIXI$Sprite$_height,_uvs,tintedTexture,buffer,tint,cachedTint,blendMode,children,interactiveChildren,_width,_height,position,scale,pivot,rotation,alpha,visible,hitArea,buttonMode,renderable,_parent,__hit,__isOver,__mouseIsDown,__isDown,_dirty,click,mousemove,mousedown,mouseout,mouseover,mouseup,mouseupoutside,touchmove,touchstart,touchend,tap,touchendoutside,__touchData,_stage,_worldAlpha,_interactive,defaultCursor,_worldTransform,_sr,_cr,filterArea,_bounds,_currentBounds,_mask,_cacheAsBitmap,_cachedSprite,_cacheIsDirty,_filterBlock,_filters,_rotationCache",
    $isBunny: true
  },
  main_resize: {
    "^": "Closure:75;renderer_0",
    call$1: [function(e) {
      this.renderer_0.resize$2(0, window.innerWidth, window.innerHeight);
    }, function() {
  ...
  main_createBunny: {
    "^": "Closure:60;stage_1,texture_2",
    call$2: function(x, y) {
      var t1, t2, t3, t4, t5, t6, t7, t8, bunny;
      t1 = new M.Point(null, null);
      t1.x = 0;
      t1.y = 0;
      t2 = new M.Point(null, null);
  ...
  main_createBunny_closure1: {
    "^": "Closure:76;bunny_5",
    call$1: function(data) {
      var t1, t2, t3, worldTransform, a00, a01, a02, a10, a11, a12, id, t4, newPosition;
      t1 = this.bunny_5;
      if (t1.dragging) {
        t2 = t1.data;
        t3 = t1._parent;
        t2.toString;
        worldTransform = t3.get$_worldTransform();
        a00 = worldTransform.a;
        a01 = worldTransform.b;
        a02 = worldTransform.tx;
        a10 = worldTransform.c;
        ...
        id = 1 / (a00 * a11 + a01 * t3);
        t2 = t2.global;
        t4 = C.JSNumber_methods.$mul(a11 * id, t2.x) + C.JSNumber_methods.$mul(-a01 * id, t2.y) + (a12 * a01 - a02 * a11) * id;
        t2 = C.JSNumber_methods.$mul(a00 * id, t2.y) + C.JSNumber_methods.$mul(t3 * id, t2.x) + (-a12 * a00 + a02 * a10) * id;
        newPosition = new M.Point(null, null);
        newPosition.x = t4;
        newPosition.y = t2;
        t1 = t1.position;
        t1.x = t4;
  ...
  main_animate: {
    "^": "Closure:32;stage_6,renderer_7",
    call$1: [function(dt) {
      $.get$requestAnimFrame().call$1(this);
      this.renderer_7.render$1(this.stage_6);
...
{func: "dynamic__InteractionData", args: [M.InteractionData]},
"dt",
];
$ = null;
...
function dart_precompiled($collectedClasses) {
  ...
  function Bunny(data, dragging, anchor, texture, updateFrame, PIXI$Sprite$_width, PIXI$Sprite$_height, _uvs, tintedTexture, buffer, tint, cachedTint, blendMode, children, interactiveChildren, _width, _height, position, scale, pivot, rotation, alpha, visible, hitArea, buttonMode, renderable, _parent, __hit, __isOver, __mouseIsDown, __isDown, _dirty, click, mousemove, mousedown, mouseout, mouseover, mouseup, mouseupoutside, touchmove, touchstart, touchend, tap, touchendoutside, __touchData, _stage, _worldAlpha, _interactive, defaultCursor, _worldTransform, _sr, _cr, filterArea, _bounds, _currentBounds, _mask, _cacheAsBitmap, _cachedSprite, _cacheIsDirty, _filterBlock, _filters, _rotationCache) {
    this.data = data;
  ...
  Bunny.builtin$cls = "Bunny";
  if (!"name" in Bunny)
    Bunny.name = "Bunny";
  $desc = $collectedClasses.Bunny;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Bunny.prototype = $desc;
  function main_resize(renderer_0) {
  ...
  function main_createBunny(stage_1, texture_2) {
    this.stage_1 = stage_1;
    this.texture_2 = texture_2;
  }
  main_createBunny.builtin$cls = "main_createBunny";
  if (!"name" in main_createBunny)
    main_createBunny.name = "main_createBunny";
  $desc = $collectedClasses.main_createBunny;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_createBunny.prototype = $desc;
  function main_createBunny_closure(bunny_3) {
    this.bunny_3 = bunny_3;
  }
  main_createBunny_closure.builtin$cls = "main_createBunny_closure";
  if (!"name" in main_createBunny_closure)
    main_createBunny_closure.name = "main_createBunny_closure";
  $desc = $collectedClasses.main_createBunny_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_createBunny_closure.prototype = $desc;
  function main_createBunny_closure0(bunny_4) {
    this.bunny_4 = bunny_4;
  }
  main_createBunny_closure0.builtin$cls = "main_createBunny_closure0";
  if (!"name" in main_createBunny_closure0)
    main_createBunny_closure0.name = "main_createBunny_closure0";
  $desc = $collectedClasses.main_createBunny_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_createBunny_closure0.prototype = $desc;
  function main_createBunny_closure1(bunny_5) {
    this.bunny_5 = bunny_5;
  }
  main_createBunny_closure1.builtin$cls = "main_createBunny_closure1";
  if (!"name" in main_createBunny_closure1)
    main_createBunny_closure1.name = "main_createBunny_closure1";
  $desc = $collectedClasses.main_createBunny_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_createBunny_closure1.prototype = $desc;
  function main_animate(stage_6, renderer_7) {
    this.stage_6 = stage_6;
    this.renderer_7 = renderer_7;
  }
