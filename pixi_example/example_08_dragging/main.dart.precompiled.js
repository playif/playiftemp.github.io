...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, t2, t3, t4, t5, t6, t7, stage, renderer, texture, baseTexture, crossorigin, image, i;
  ...
  main_createBunny: {
    ...
    call$2: function(x, y) {
      var t1, t2, t3, t4, t5, t6, t7, bunny;
      t1 = new M.Point(null, null);
      t1.x = 0;
      t1.y = 0;
      t2 = new M.Point(null, null);
  ...
  main_createBunny_closure1: {
    ...
    call$1: function(data) {
      ...
      if (t1.dragging) {
        ...
        t3 = t1.parent;
        t2.toString;
        worldTransform = t3.get$worldTransform();
        a00 = worldTransform.a;
        a01 = worldTransform.b;
        a02 = worldTransform.tx;
        a10 = worldTransform.c;
