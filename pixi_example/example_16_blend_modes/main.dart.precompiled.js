...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, renderer, t2, t3, t4, t5, t6, t7, t8, t9, t10, stage, pondFloorTexture, pondFloorSprite, dudeArray, i, texture, dude;
    t1 = {};
    renderer = M.autoDetectRenderer(630, 410, null, false, false);
    t2 = renderer.view;
    ...
    pondFloorTexture = M.Texture_fromImage("BGrotate.jpg", null, null);
    ...
    for (i = 0; i < 20; ++i) {
      ...
      t4.y = t2;
      t4.x = t2;
      t3.x = C.C__JSRandom.nextDouble$0() * 630;
      t3.y = C.C__JSRandom.nextDouble$0() * 410;
      stage.addChildAt$2(dude, t10.length);
      dude.blendMode = C.BlendModes_3;
      dude.direction = C.C__JSRandom.nextDouble$0() * 3.141592653589793 * 2;
      dude.turningSpeed = C.C__JSRandom.nextDouble$0() - 0.8;
      dude.speed = 2 + C.C__JSRandom.nextDouble$0() * 2;
      C.JSArray_methods.add$1(dudeArray, dude);
    }
    t1.tick_0 = 0;
    $.get$requestAnimFrame().call$1(new F.main_animate(t1, renderer, stage, dudeArray, new M.Rectangle(-100, -100, 830, 610)));
  ...
  main_animate: {
    "^": "Closure:32;box_0,renderer_1,stage_2,dudeArray_3,dudeBounds_4",
    call$1: [function(dt) {
      var t1, t2, i, dude, t3, t4, t5;
      for (t1 = this.dudeArray_3, t2 = this.dudeBounds_4, i = 0; i < t1.length; ++i) {
        dude = t1[i];
        t3 = dude.direction;
        t4 = dude.turningSpeed;
        if (typeof t4 !== "number")
          return t4.$mul();
        if (typeof t3 !== "number")
          return t3.$add();
        ...
        t3 = dude.position;
        t5 = t3.x;
        t4 = C.JSDouble_methods.$mul(Math.sin(t4), dude.speed);
        if (typeof t5 !== "number")
          return t5.$add();
        t3.x = t5 + t4;
        t4 = t3.y;
        ...
        t5 = C.JSDouble_methods.$mul(Math.cos(t5), dude.speed);
        if (typeof t4 !== "number")
          return t4.$add();
        t3.y = t4 + t5;
        t5 = dude.direction;
        if (typeof t5 !== "number")
          return t5.$negate();
        dude.rotation = -t5 - 1.5707963267948966;
        t4 = t3.x;
        t5 = t2.x;
        if (typeof t4 !== "number")
          return t4.$lt();
        if (t4 < t5)
          t3.x = C.JSNumber_methods.$add(t4, t2.width);
        else if (t4 > C.JSNumber_methods.$add(t5, t2.width)) {
          t4 = t3.x;
          t5 = t2.width;
          if (typeof t4 !== "number")
            return t4.$sub();
          t3.x = C.JSNumber_methods.$sub(t4, t5);
        }
        t4 = t3.y;
        t5 = t2.y;
        if (typeof t4 !== "number")
          return t4.$lt();
        if (t4 < t5)
          t3.y = C.JSNumber_methods.$add(t4, t2.height);
        else if (t4 > C.JSNumber_methods.$add(t5, t2.height)) {
          t4 = t3.y;
          t5 = t2.height;
          if (typeof t4 !== "number")
            return t4.$sub();
          t3.y = C.JSNumber_methods.$sub(t4, t5);
        }
      }
      this.box_0.tick_0 += 0.1;
      this.renderer_1.render$1(this.stage_2);
...
function dart_precompiled($collectedClasses) {
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Dude.prototype = $desc;
  function main_animate(box_0, renderer_1, stage_2, dudeArray_3, dudeBounds_4) {
    this.box_0 = box_0;
    this.renderer_1 = renderer_1;
    this.stage_2 = stage_2;
    this.dudeArray_3 = dudeArray_3;
    this.dudeBounds_4 = dudeBounds_4;
  }
