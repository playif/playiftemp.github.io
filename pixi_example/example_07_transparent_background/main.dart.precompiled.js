...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, stage, renderer, texture, baseTexture, crossorigin, image, bunny;
    ...
    renderer = M.autoDetectRenderer(window.innerWidth, window.innerHeight, null, true, true);
    ...
    t1.x = 200;
    t1.y = 150;
    stage.addChildAt$2(bunny, t9.length);
    $.get$requestAnimFrame().call$1(new F.main_animate(stage, renderer, bunny));
  }, "call$0", "main$closure", 0, 0, 35],
  main_animate: {
    "^": "Closure:32;stage_0,renderer_1,bunny_2",
    call$1: [function(dt) {
      var t1;
      $.get$requestAnimFrame().call$1(this);
      t1 = this.bunny_2;
      t1.set$rotation(t1.get$rotation() + 0.1);
