...
["PIXI", "../../lib/pixi.dart", , M, {
  ...
  TilingSprite: {
    ...
    generateTilingTexture$1: function(forcePowerOfTwo) {
      var texture, t1, frame, targetWidth, t2, isFrame, targetHeight, newTextureRequired, canvasBuffer, t3, baseTexture, sor, t4;
      ...
      if (!forcePowerOfTwo)
        ...
        t1 = frame.width;
        if (t1 == null ? targetWidth == null : t1 === targetWidth) {
          t1 = frame.height;
          t1 = t1 == null ? targetHeight != null : t1 !== targetHeight;
        } else
          t1 = true;
        newTextureRequired = t1 && true;
      }
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, stage, renderer, texture, baseTexture, crossorigin, image, t11, t12, tilingSprite;
    t1 = {};
    ...
    texture = H.interceptedTypeCheck($.get$TextureCache().$index(0, "p2.jpeg"), "$isTexture");
    if (texture == null) {
    ...
    tilingSprite = new M.TilingSprite(null, null, null, null, null, null, false, t4, t5, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t6, t7, t8, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t9, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t11), [], true, 0, 1, null, new M.Rectangle(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t12, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
...
function dart_precompiled($collectedClasses) {
  ...
  function Sprite(PIXI$Sprite$_width, PIXI$Sprite$_height) {
  ...
  Sprite.prototype.get$_width = function() {
    return this.PIXI$Sprite$_width;
  };
  Sprite.prototype.get$_height = function() {
    return this.PIXI$Sprite$_height;
  };
  ...
  function TilingSprite(PIXI$TilingSprite$_width, PIXI$TilingSprite$_height, tileScale, tilePosition, __tilePattern, tilingTexture, refreshTexture, tileScaleOffset, anchor, texture, updateFrame, textureChange, PIXI$Sprite$_width, PIXI$Sprite$_height, _uvs, tintedTexture, buffer, tint, cachedTint, blendMode, children, _width, _height, position, scale, pivot, rotation, alpha, visible, hitArea, renderable, parent, __iParent, interactiveChildren, __hit, __isOver, __mouseIsDown, __isDown, dirty, click, mousemove, mousedown, mouseout, mouseover, mouseup, mouseupoutside, touchmove, touchstart, touchend, tap, touchendoutside, __touchData, stage, buttonMode, worldAlpha, _interactive, defaultCursor, worldTransform, color, dynamic, _sr, _cr, filterArea, _bounds, _currentBounds, _mask, isMask, _cacheAsBitmap, _cachedSprite, _cacheIsDirty, _filterBlock, _filters, rotationCache) {
    this.PIXI$TilingSprite$_width = PIXI$TilingSprite$_width;
    this.PIXI$TilingSprite$_height = PIXI$TilingSprite$_height;
    this.tileScale = tileScale;
    this.tilePosition = tilePosition;
    this.__tilePattern = __tilePattern;
    this.tilingTexture = tilingTexture;
    this.refreshTexture = refreshTexture;
    this.tileScaleOffset = tileScaleOffset;
    this.anchor = anchor;
  ...
  TilingSprite.builtin$cls = "TilingSprite";
  if (!"name" in TilingSprite)
    TilingSprite.name = "TilingSprite";
  $desc = $collectedClasses.TilingSprite;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TilingSprite.prototype = $desc;
  TilingSprite.prototype.get$_width = function() {
    return this.PIXI$TilingSprite$_width;
  };
  TilingSprite.prototype.get$_height = function() {
  ...
  function main_animate(box_0, stage_1, renderer_2, tilingSprite_3) {
    this.box_0 = box_0;
    this.stage_1 = stage_1;
    this.renderer_2 = renderer_2;
    this.tilingSprite_3 = tilingSprite_3;
  }
