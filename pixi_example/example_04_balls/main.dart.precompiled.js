...
["PIXI", "../../lib/pixi.dart", , M, {
  ...
  Sprite: {
    ...
    }, "call$1", "get$_onTextureUpdate", 2, 0, 57, 3],
    _renderWebGL$1: function(renderSession) {
      var t1, j, i;
      if (!this.visible || this.alpha <= 0)
        return;
  ...
  InteractionManager: {
    ...
    }, "call$1", "get$onMouseMove", 2, 0, 58, 4],
    ...
    }, "call$1", "get$onMouseDown", 2, 0, 59, 4],
    onMouseOut$1: [function(_, $event) {
      ...
      t1.x = -10000;
      t1.y = -10000;
    }, "call$1", "get$onMouseOut", 2, 0, 59, 4],
  ...
  WebGLRenderer: {
    ...
    }, "call$1", "get$handleContextLost", 2, 0, 36, 4],
    ...
    }, "call$1", "get$handleContextRestored", 2, 0, 36, 4],
  ...
  Texture: {
    ...
    onBaseTextureLoaded$0: [function() {
      ...
      if (this.noFrame)
        this.frame = new M.Rectangle0(0, 0, baseTexture.width, baseTexture.height);
    ...
    Texture$2: function(baseTexture, frame) {
      ...
      if (baseTexture._hasLoaded) {
        if (this.noFrame) {
          t1 = new M.Rectangle0(0, 0, baseTexture.width, baseTexture.height);
          this.frame = t1;
        }
        this.setFrame$1(t1);
      } else
...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  IsolateNatives__startNonWorker_closure: {
    "^": "Closure:39;box_0,functionName_1,isSpawnUri_2,startPaused_3,replyPort_4",
    call$0: function() {
      var t1 = this.box_0;
...
["_js_helper", "dart:_js_helper", , H, {
  ...
  ReflectionInfo_sortedIndex_closure: {
    "^": "Closure:62;box_0,this_1,positions_2",
...
["dart.async", "dart:async", , P, {
  ...
  _BaseZone_bindCallback_closure: {
    "^": "Closure:39;this_0,registered_1",
    call$0: [function() {
  ...
  _BaseZone_bindCallback_closure0: {
    "^": "Closure:39;this_2,registered_3",
    call$0: [function() {
  ...
  _rootHandleUncaughtError__closure: {
    "^": "Closure:39;error_2,stackTrace_3",
    call$0: function() {
      var t1, trace;
      t1 = this.error_2;
...
["dart.dom.html", "dart:html", , W, {
  ...
  _Html5NodeValidator: {
    ...
    static: {"^": "_Html5NodeValidator__allowedElements,_Html5NodeValidator__standardAttributes,_Html5NodeValidator__uriAttributes,_Html5NodeValidator__attributeValidators", _Html5NodeValidator$: function(uriPolicy) {
        ...
        return true;
      }, "call$4", "_Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 28, 29, 30, 17, 31], _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
        var t1, t2, t3, t4, t5;
        H.interceptedTypeCheck(element, "$isElement");
        H.stringTypeCheck(attributeName);
        H.stringTypeCheck(value);
        ...
        if (!t1)
          ...
          t1 = true;
        return t1;
      }, "call$4", "_Html5NodeValidator__uriAttributeValidator$closure", 8, 0, 28, 29, 30, 17, 31]}
  },
  ImmutableListMixin: {
    "^": "Object;",
    get$iterator: function(receiver) {
  ...
  _ValidatingTreeSanitizer: {
    ...
    sanitizeNode$1: function(node) {
      var attrs, t1, isAttr, keys, i, $name, t2, t3;
        ...
        case 1:
          ...
          for (i = attrs.get$keys().length - 1; i >= 0; --i) {
            ...
            if (!t2.allowsAttribute$3(node, t3, t1.getAttribute$1(node, $name))) {
              window;
              t2 = "Removing disallowed attribute <" + H.S(node.tagName) + " " + H.S($name) + "=\"" + H.S(t1.getAttribute$1(node, $name)) + "\">";
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1, stars, t2, t3, t4;
    t1 = {};
    t1.w_0 = 800;
    t1.h_1 = 600;
    t1.sx_2 = 1 + C.C__JSRandom.nextDouble$0() / 20;
    t1.sy_3 = 1 + C.C__JSRandom.nextDouble$0() / 20;
    t1.slideX_4 = t1.w_0 / 2;
    t1.slideY_5 = t1.h_1 / 2;
    stars = [];
    t1.renderer_6 = null;
    t1.stage_7 = null;
    t2 = new F.main_resize(t1);
    ...
    t4._tryResume$0();
    H.assertSubtype(t4, "$isStreamSubscription", [H.getTypeArgumentByIndex(t3, 0)], "$asStreamSubscription");
    new F.main_start(t1, C.C__JSRandom, 100, stars, t2, new F.main_update(t1, 100, stars)).call$0();
  }, "call$0", "main$closure", 0, 0, 39],
  main_newWave: {
    "^": "Closure:36;box_0,random_1",
    call$1: function(e) {
      var t1, t2;
      t1 = this.random_1;
      t2 = this.box_0;
      t2.sx_2 = 1 + t1.nextDouble$0() / 20;
      t2.sy_3 = 1 + t1.nextDouble$0() / 20;
      J.set$innerHtml$x(C.HtmlDocument_methods.getElementById$1(document, "sx"), "SX: " + H.S(t2.sx_2) + "<br />SY: " + H.S(t2.sy_3));
    },
    $isFunction: true
  },
  main_resize: {
  ...
  main_update: {
    "^": "Closure:80;box_0,starCount_2,stars_3",
    call$1: [function(dt) {
      var t1, t2, t3, t4, i;
      for (t1 = this.starCount_2, t2 = this.stars_3, t3 = J.getInterceptor$asx(t2), t4 = this.box_0, i = 0; i < t1; ++i) {
        J.set$x$x(J.get$position$x(J.$index$asx(t3.$index(t2, i), "sprite")), J.$add$ns(J.$index$asx(t3.$index(t2, i), "x"), t4.slideX_4));
        J.set$y$x(J.get$position$x(J.$index$asx(t3.$index(t2, i), "sprite")), J.$add$ns(J.$index$asx(t3.$index(t2, i), "y"), t4.slideY_5));
        J.$indexSet$ax(t3.$index(t2, i), "x", J.$mul$ns(J.$index$asx(t3.$index(t2, i), "x"), t4.sx_2));
        J.$indexSet$ax(t3.$index(t2, i), "y", J.$mul$ns(J.$index$asx(t3.$index(t2, i), "y"), t4.sy_3));
        if (J.$gt$n(J.$index$asx(t3.$index(t2, i), "x"), t4.w_0))
          J.$indexSet$ax(t3.$index(t2, i), "x", J.$sub$n(J.$index$asx(t3.$index(t2, i), "x"), t4.w_0));
        else if (J.$lt$n(J.$index$asx(t3.$index(t2, i), "x"), -t4.w_0))
          J.$indexSet$ax(t3.$index(t2, i), "x", J.$add$ns(J.$index$asx(t3.$index(t2, i), "x"), t4.w_0));
        if (J.$gt$n(J.$index$asx(t3.$index(t2, i), "y"), t4.h_1))
          J.$indexSet$ax(t3.$index(t2, i), "y", J.$sub$n(J.$index$asx(t3.$index(t2, i), "y"), t4.h_1));
        else if (J.$lt$n(J.$index$asx(t3.$index(t2, i), "y"), -t4.h_1))
          J.$indexSet$ax(t3.$index(t2, i), "y", J.$add$ns(J.$index$asx(t3.$index(t2, i), "y"), t4.h_1));
      }
      t4.renderer_6.render$1(t4.stage_7);
      $.get$requestAnimFrame().call$1(this);
    }, function() {
      return this.call$1(null);
    }, "call$0", "call$1", null, null, 0, 2, null, 19, 81, "call"],
    $isFunction: true
  },
  main_start: {
    "^": "Closure:39;box_0,random_4,starCount_5,stars_6,resize_7,update_8",
    call$0: function() {
      var texture, baseTexture, crossorigin, image, t1, t2, t3, t4, t5, t6, t7, t8, t9, stage, i, t10, t11, t12, t13, tempBall;
      texture = H.interceptedTypeCheck($.get$TextureCache().$index(0, "assets/bubble_32x32.png"), "$isTexture");
      if (texture == null) {
        baseTexture = $.get$BaseTextureCache().$index(0, "assets/bubble_32x32.png");
        crossorigin = C.JSString_methods.indexOf$1("assets/bubble_32x32.png", "data:") === -1 ? true : null;
        if (baseTexture == null) {
          image = W.ImageElement_ImageElement(null, null, null);
          if (H.boolConversionCheck(crossorigin))
            image.crossOrigin = "";
          image.src = "assets/bubble_32x32.png";
          baseTexture = M.BaseTexture$(image, null);
          baseTexture.imageUrl = "assets/bubble_32x32.png";
          $.get$BaseTextureCache().$indexSet(0, "assets/bubble_32x32.png", baseTexture);
        }
        texture = M.Texture$(baseTexture, null);
        $.get$TextureCache().$indexSet(0, "assets/bubble_32x32.png", texture);
      }
      t1 = this.box_0;
      t1.renderer_6 = M.autoDetectRenderer(t1.w_0, t1.h_1, null, false, false);
      ...
      stage = new M.Stage(null, false, new M.Rectangle0(0, 0, 100000, 100000), 0, H.assertSubtype([], "$isList", [P.num], "$asList"), null, new M.Matrix(1, 0, 0, 1, 0, 0, t2), null, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), false, null, null, t3, t4, t5, 0, 1, true, null, false, false, null, false, false, false, false, false, t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), H.assertSubtype(t6, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t7), 0, 1, null, new M.Rectangle0(0, 0, 1, 1), null, null, false, null, false, new M.FilterBlock(true, true, null, null, null, t8, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
      stage.Stage$2(0, true);
      t1.stage_7 = stage;
      J.append$1$x(document.body, t1.renderer_6.view);
      J.set$position$x(t1.renderer_6.view.style, "absolute");
      J.set$display$x(t1.renderer_6.view.style, "block");
      t1.renderer_6.view.className = "rendererView";
      for (t2 = this.starCount_5, t3 = this.random_4, t4 = this.stars_6, t5 = J.getInterceptor$ax(t4), i = 0; i < t2; ++i) {
        ...
        tempBall = new M.Sprite(t6, null, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), false, null, null, t7, t8, t10, 0, 1, true, null, false, false, null, false, false, false, false, false, t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), t9._assertCheck$1(null), H.assertSubtype(t11, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t12), 0, 1, null, new M.Rectangle0(0, 0, 1, 1), null, null, false, null, false, new M.FilterBlock(true, true, null, null, null, t13, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
        tempBall.texture = texture;
        if (texture.baseTexture._hasLoaded)
          tempBall._onTextureUpdate$1(null);
        else
          texture.addEventListener$2(0, "update", tempBall.get$_onTextureUpdate());
        tempBall.position.x = t3.nextInt$1(t1.w_0) - t1.slideX_4;
        tempBall.position.y = t3.nextInt$1(t1.h_1) - t1.slideY_5;
        t6.x = 0.5;
        t6.y = 0.5;
        t6 = tempBall.position;
        t5.add$1(t4, P.LinkedHashMap_LinkedHashMap$_literal(["sprite", tempBall, "x", t6.x, "y", t6.y], null, null));
        t6 = t1.stage_7;
        t6.addChildAt$2(tempBall, t6.children.length);
      }
      this.resize_7.call$0();
      $.get$requestAnimFrame().call$1(this.update_8);
    },
    $isFunction: true
  }
},
...
function dart_precompiled($collectedClasses) {
  ...
  function main_newWave(box_0, random_1) {
    this.box_0 = box_0;
    this.random_1 = random_1;
  }
  main_newWave.builtin$cls = "main_newWave";
  if (!"name" in main_newWave)
    main_newWave.name = "main_newWave";
  $desc = $collectedClasses.main_newWave;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_newWave.prototype = $desc;
  ...
  function main_update(box_0, starCount_2, stars_3) {
    this.box_0 = box_0;
    this.starCount_2 = starCount_2;
  ...
  function main_start(box_0, random_4, starCount_5, stars_6, resize_7, update_8) {
    this.box_0 = box_0;
    this.random_4 = random_4;
    this.starCount_5 = starCount_5;
    this.stars_6 = stars_6;
    this.resize_7 = resize_7;
    this.update_8 = update_8;
  }
