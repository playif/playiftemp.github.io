...
["PIXI", "../../lib/pixi.dart", , M, {
  ...
  Sprite: {
    ...
    }, "call$1", "get$onTextureUpdate", 2, 0, 57, 3],
    _renderWebGL$1: function(renderSession) {
      var t1, j, i;
      if (!this.visible || this.alpha <= 0)
        return;
...
["", "main.dart", , F, {
  ...
  main_start: {
    ...
    call$0: function() {
      var texture, baseTexture, crossorigin, image, t1, t2, t3, t4, t5, t6, t7, t8, stage, i, t9, t10, t11, t12, tempBall;
      ...
      stage = new M.Stage(null, false, new M.Rectangle0(0, 0, 100000, 100000), 0, H.assertSubtype([], "$isList", [P.num], "$asList"), null, new M.Matrix(1, 0, 0, 1, 0, 0, t2), null, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t3, t4, t5, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t6, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t7), [], true, 0, 1, null, new M.Rectangle0(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t8, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
      ...
      for (t2 = this.starCount_5, t3 = this.random_4, t4 = this.stars_6, t5 = J.getInterceptor$ax(t4), i = 0; i < t2; ++i) {
        ...
        tempBall = new M.Sprite(t6, null, false, false, 0, 0, null, null, null, 16777215, null, C.BlendModes_0, H.assertSubtype([], "$isList", [M.DisplayInterface], "$asList"), null, null, t7, t8, t9, 0, 1, true, null, false, null, null, false, false, false, false, false, false, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(t10, "$isMap", [P.$int, M.InteractionData], "$asMap"), null, false, 1, false, "pointer", new M.Matrix(1, 0, 0, 1, 0, 0, t11), [], true, 0, 1, null, new M.Rectangle0(0, 0, 1, 1), null, null, false, false, null, false, new M.FilterBlock(true, true, null, null, null, t12, null), H.assertSubtype(null, "$isList", [M.AbstractFilter], "$asList"), 0);
        tempBall.texture = texture;
        if (texture.baseTexture._hasLoaded)
          tempBall.onTextureUpdate$1(null);
        else
          texture.addEventListener$2(0, "update", tempBall.get$onTextureUpdate());
